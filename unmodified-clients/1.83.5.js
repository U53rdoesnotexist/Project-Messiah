...
function bm() {
    ...
    this.c7 = function(n, l) {
        return !bw.bx() || n < cA || l < cB - cC.c1 -
            g * bw.bz(13).height - 2 * cA || l > cB - cC.c1 - 2 * cA ? !1 : n < cA + g * bw.bz(13).width ? (cD.cE(0), !0) : n < 2 * cA + g * bw.bz(13).width ? !1 : n < 2 * cA + 2 * g * bw.bz(13).width ? (cD.cE(1), !0) : !1
    };
    this.cF = function() {
...
function cv(g) {
    var k = ci[0];
    if (1 === cg) return k;
    var n = as(cz[g] + d0[g], 2),
        l = as(d2[g] + d3[g], 2),
        x = d5(n - as(cz[k] + d0[k], 2)) + d5(l - as(d2[k] + d3[k], 2));
    for (g = cg - 1; 1 <= g; g--) {
        var t = d5(n - as(cz[ci[g]] + d0[ci[g]], 2)) + d5(l - as(d2[ci[g]] + d3[ci[g]], 2));
        t < x && (x = t, k = ci[g])
    }
    return k
}
...
function dO(g, k, n) {
    3 <= n && 2142 < c4.dU() && (k === b8 || ax[k] < as(ax[g], 20)) && dG.dH(g - cq, 25)
}

function dI(g, k, n, l) {
    if (0 !== dW.dX[g] && !(5 === n && ax[g] < l || 4 === n && ax[g] < as(l, 2)))
...
function de() {
    ...
    this.bp = function() {
        ...
        for (z = dq - 1; 0 <= z; z--) 2 >= this.cN[z] ? (l[z] = 5, x[z] = t[z] = 1040, 0 === this.cN[z] ? (k[z] = 1E3, n[z] = 1E3) : 1 === this.cN[z] ? (k[z] = 1E3, n[z] = 920, x[z] = t[z] = 1100) : (k[z] = 1E3, n[z] = 870)) : 4 >= this.cN[z] ? (l[z] = 1 + ce.cf(20), t[z] = 250 + ce.cf(1501), x[z] = 500 + ce.cf(501), 3 === this.cN[z] ? (k[z] = 600 + ce.cf(101), n[z] = 300 + ce.cf(401)) : (k[z] = 300 + ce.cf(201), n[z] = 100 + ce.cf(201))) : (x[z] = 1E3, t[z] = 1E3, l[z] =
            35 + ce.cf(16), k[z] = 400 + ce.cf(101), n[z] = 50 + ce.cf(101)), g[z] = 1 + as(x[z] * ce.random(), 10 * ce.value(100))
    };
    this.dw = function() {
        var z, y;
        var A = e2.e3;
    ...
    function g() {
        ...
        a: {
            for (var y = 40; 1 <= y; y--) {
                ...
                t = d3[z] + as(ce.random() * (d2[z] - d3[z] + 1), ce.value(100));
                var A = k(b5.f1(x, t));
                if (1 !== A) break a
            }
            A = 1
    ...
    function n(y, A) {
        for (var B, C, E, F, G, N, I, D = y; D < y + 50 * A; D += A)
            if (B = d0[z] - D, B = 1 > B ? 1 : B, C = d3[z] - D, C = 1 >
                C ? 1 : C, E = cz[z] + D, E = E >= aZ - 1 ? aZ - 2 : E, F = d2[z] + D, F = F >= aa - 1 ? aa - 2 : F, I = as(2 * ce.random() * (E - B + F - C), ce.value(100)), G = E - B, N = F - C, I <= G ? (x = B + I, t = C) : I <= G + N ? (x = E, t = C + I - G) : I <= 2 * G + N ? (x = B + I - G - N, t = F) : (x = B, t = C + I - 2 * G - N), B = k(b5.f1(x, t)), 1 !== B) return B;
        return 1
    }
    var l, x, t, z;
...
function hA() {
    function g() {
        ...
        a: {
            for (I = 0; 8 > I; I++)
                if (t = as(y * ce.random(), ce.value(100)), z = as(A * ce.random(), ce.value(100)), k()) {
                    I = !0;
                    break a
                } I = !1
        }
    ...
    this.bp = function() {
        ...
        if (dr.ds && dr.dt.hH)
            for (G = 0; G < b8; G++) {
                ...
                for (G = 0; G < b8; G++) 1 !== fF[G] && (G < hM && g() ? (D = C + t * B + as(B, 2), I = E + z * B + as(B, 2), n(), l(D - 2, I - 2)) : n());
        b0.b1[7] = bU[aw];
        b0.b1[8] = ax[aw]
    };
    ...
    this.fj = function(g) {
        ...
        if (!k) {
            if (8 === dv) {
                ...
                ij.iA(g)
            } else dA ? (g = eT.ik(), k = dW.dX[aw] === g, 9 === dv ? n = k ? em[0] : 512 : (g = dW.il(dW.im[g]), n = g[0], 512 !== n && e9.io(g[1])), e9.ip(k)) : (n = em[0], k = n === aw, e9.iq(n));
            dx || ir.is(it(), n);
            eW.show(k, !1);
            e9.iy(!0);
            eM.eb(!0);
...
function jy() {
    ...
    this.c7 = function(B, C) {
        var E = k(B, C);
        return this.lu ? 0 === E ? (jb(), 2) : 1 === E ? (this.m0(), 2) : 2 === E ? (this.fr(aw) && (dx ? eG.fp(aw) : ir.m3(), this.m0()), 2) : 3 === E && 2 <= b0.m4 ? (hv.m0(), c4.c5 = !0, 2) : hv.lC ||
...
function ng() {
    ...
    this.nw = function(g, k, n) {
        ...
        23 === k ? x.drawImage(hu.l3[2], 0, 0) : 36 === k ? x.drawImage(hu.l3[0], 0, 0) : 49 === k ? x.drawImage(hu.l3[1], 0, 0) : x.drawImage(n, this.c1 * g % (g === k ? this.nh * this.c1 : 4E3), g === k ? as(g, this.nh) * this.c1 : 0, this.c1, this.c1, 0, 0, this.c1, this.c1);
        this.l5[k] = l
    };
    this.ny = function() {
        this.l5[this.a6 -
    ...
    this.show = function(g, k) {
        ...
        this.nt = c4.gc;
        var n = Math.floor(gE / this.nn);
        n = 3 > n ? 3 : n > this.no ? this.no : n;
        n = this.ld > n ? n : this.ld;
        var l = 1 + as(this.ld - 1, n),
        ...
        this.f9 = t + x;
        this.fA = z + l;
        for (x = 0; x < this.ld; x++) this.np[x] = Math.floor(t + x % n * this.nn), this.nq[x] = Math.floor(z + as(x, n) * this.nn);
        return !0
    };
...
function pL(g, k) {
    if (0 === fZ) aJ.c7(g, k);
        ...
        var n = fq.c7(g, k);
        2 === n || eM.c7(g, k) || (gj.c7(g, k) ? c4.c5 = !0 : eR.pP(g, k) ? (gj.gk = !1, eR.pQ(g, k) && (c4.c5 = !0)) : e9.c7(g, k) || eS.c7(g, k) || 0 === n && hu.lD(g, k))
    }
}
...
function k1() {
    ...
    this.eb = function() {
        for (var C = t.length - 1; 0 <= C; C--) t[C].pm && (t[C].pm = !1, g(C))
    };
    this.gJ = function(C) {
    ...
    this.c7 = function(C, E) {
        ...
        for (F = t.length -
            ...
            var K = t[F].lq.width;
            if (E >= D - N && E <= D + A + N) {
                if (C >= I - G && C <= I + A + G) return t[F].ps || (t[F].pm = !0, t[F].ps = !0, 0 === t[F].id ? dx ? eG.fN(aw, t[F].cM) : ir.q6(t[F].cM === b8 ? aw : t[F].cM) : dx ? eG.fP(aw, t[F].id) : ir.q7(t[F].id)), !0;
                if (0 === t[F].id && C >= I + K - A - G && C <= I + K + G) return dx ? fL(aw, t[F].cM, eR.lT()) : ir.lU(eR.lT(), t[F].cM === b8 ? aw : t[F].cM), !0
            }
        }
        return !1
    };
    this.dF = function() {
        if (2 !== fZ && 0 !== fF[aw] && !j8 && hu.lE(aw)) {
            ...
            for (--C; 0 <= C; C--) E = ae.am(aw, C), t[C].cN !== E && (t[C].cN = E, t[C].pr = E > t[C].pr ? E : t[C].pr, t[C].pm = !0)
        }
    };
    this.cG = function() {
...
function k3() {
    ...
    this.qs = function() {
        t = q && r < .8 * s ? this.cw + 3 * m5 : Math.floor((gE - x) / 2);
...
function k6() {
    ...
    this.cG = function() {
        0 === fF[aw] || fc || 2 === fT[aw] || cH.drawImage(t, this.fJ, n)
    }
}
...
function k7() {
    function g() {
        ...
        sK[aw] >= V && n(sK[aw] - V, oR);
        0 !== sK[aw] && 0 === V && n(0, oQ); - 1 !== X && n(X, ly);
        B.fillStyle = oH;
        B.fillRect(0, N, sG, 1);
        ...
        2 === O && (k(aw), B.textAlign = mh, l(y - 1, sK[aw], aw), B.textAlign = oj, x(y - 1, aw));
    ...
    this.lv = function(S) {
        q ? (sG = Math.floor(.335 * bq), qS = Math.floor(y * sG / 8)) : (sG = Math.floor(.27 * bq), qS = Math.floor(y * sG / 10));
        sG = Math.floor(.97 * sG);
    ...
    this.eb = function(S) {
        W && (S || 14 >= sm && 0 === c4.dU() % 6 || 14 < sm) && (W = !1, g())
    };
    this.dF = function() {
        for (var S = E - 1; 0 <= S; S--)
            if (0 === fF[em[S]]) {
        ...
        a: {
            S = W;W = !0;
            for (O = T = sK[aw] >= y - 1 ? y - 2 : y - 1; 0 <= O; O--)
                if (P[O] !== em[O] || U[O] !== bU[em[O]]) break a;
            if (T !== y - 2 || P[y] === sK[aw] && U[y] === bU[aw]) W = S
        }
    ...
    this.lm = function(S, O) {
        ...
        if (ba) {
            ...
            V += ca - T;
            V = t5(0, V, b8 - y);
            V !== Y && (ca = T, T = t5(-1, T, y), X = T = T !== y && z(S, O) ? T : -1, g(), c4.c5 = !0);
            return !0
        }
        T = t5(-1, T, y);
        T = T === y || !z(S, O) || ox ? -1 : T;
    ...
    this.pV = function(S, O) {
        ...
        if (350 > c4.gc - na && pa === T && (T = t5(-1, T, y), T = T !== y && z(S, O) ? T : -1, -1 !== T)) {
            var Y = em[T + V];
            T === y - 1 && sK[aw] >= V + y - 1 && (Y = aw);
    ...
    this.pb = function(S, O,
        T) {
        return ba ? !1 : z(S, O) ? (S = t(O), S = t5(-1, S, y), S = S === y || ox ? -1 : S, 0 < T ? V < b8 - y && (V++, X = S, g(), c4.c5 = !0) : 0 < V && (V--, X = S, g(), c4.c5 = !0), !0) : !1
    };
    this.cG = function() {
...
function k8() {
    ...
    function k(P) {
        return 3 > P ? K[P].toString() : 3 === P ? eB.nG(K[P] / 100, 2) : 4 === P ? eB.nG(K[P] / 100, 2) : 5 === P ? eB.nG(K[P] / 100, 2) : 7 > P ? eP.gJ(K[P]) : eB.sF(K[7])
    }
...
function k9() {
    ...
    this.lv = function() {
        if (g) {
            ...
            n = ql(n, mc(r - 2 * m5, 10));
            n = ql(n, Math.floor(3.57 * mc(s - 2 * m5, 3)));
            l = Math.floor(.28 * n);
            A = document.createElement("canvas");
            A.width = n;
            A.height = l;
    ...
    this.show = function(C, E) {
        g || (k = C ? 1 : 2, g = !0, this.lv(), hu.ln(), eR.qh(), B = c4.gc, -1 === this.tb &&
    ...
    if (!(0 === fF[g] || 0 > n || 1E3 < n || 2 === fT[g])) {
        ...
        if (dA && k < b8 && !ch(g, k)) da(g, k, l);
            ...
            if (!(l <= at) && ae.dD(g)) {
                var t = b4[g].length;
                k === b8 ? cX(g) : cS(g, k);
                if (0 !== t || 0 !== b4[g].length) dA && (d7[g] = 1), g === aw && (b0.b1[0] += 500 <= n ? n - 12 : n, b0.b1[1]++, b0.b1[12] += x, b0.b1[13] += l), cP(t, g), ae.cQ(g, l, k), ax[g] -= l + x, au.cR(g, !1)
            }
        }
    }
}
...
function da(g, k, n) {
    if (!(!dA || 0 === fF[g] || 0 === fF[k] || 0 > n || n > ax[g] || g === k || ch(g, k) || g < cq && k < cq && 7 > dv && 1071 > c4.dU())) {
        ...
        n -= n >= as(ax[g], 2) ? l : 0;
        var x = bU[k] * j7 - ax[k];
        0 >= x || (n = n > x ? x : n, g === aw && (e9.n8(n, k), b0.b1[12] += l, b0.b1[16] += n), k === aw && (e9.nA(n, g), b0.b1[10] += n), ax[g] -= n + l, ax[k] += n)
    }
}
...
function ty() {
    ...
    this.bv = function() {
        c4.gc -
            12E4 >= n[this.tz] && (n[this.tz] = c4.gc, this.uE = [0, 0], eD.ri(0, 1 + this.tz) && ir.uF(0, this.tz))
    };
    this.lv = function() {
        var l;
        this.c1 = this.uG(q ? .85 : .66, .75, r, s);
        ...
        if (this.mC && this.mC[l]) {
            ...
            if (0 === l) {
                for (y = 0; y < this.mC[l][0].length; y++)
                    if (x === this.mC[l][0][y].name && t > .99 * this.mC[l][0][y].value && t < 1.01 * this.mC[l][0][y].value) {
                        this.mC[l][0][y].value =
                            z;
                        A = !0;
                        break
    ...
    this.c7 = function(l, x) {
        ...
        this.uE[this.tz] = l < this.c1 / 2 ? -t : t;
        if (n[this.tz] + 50 > c4.gc) return !0;
        n[this.tz] = c4.gc;
        eD.ri(0, 1 + this.tz) && ir.uF(0, this.tz);
        return !0
    };
    this.cG = function() {
        if (this.lC) {
    ...
    this.uW = function(l) {
        ...
        x -= x % 2;
        var t = mc(2, Math.floor(.01 * this.c1));
        t -= t % 2;
        l = Math.floor(.82 * l);
        cH.fillRect(x,
            l, x, t);
    ...
    this.uV = function(l) {
        cH.font = this.mC[this.tz][4];
        for (var x, t = this.mC[this.tz][1] - 1; 0 <= t; t--) cH.textAlign = oj, x = Math.floor(this.u9 * this.cw + l + t * ((1 - 2 * this.u9) * this.cw - l) / 9), cH.fillText(this.mC[this.tz][0][t].value.toFixed(this.mC[this.tz][3]), Math.floor(this.u8 * this.c1), x), cH.fillText(t + 1 + this.mC[this.tz][6] + ".", Math.floor(this.u6 * this.c1), x), cH.textAlign = mh, cH.fillText(this.mC[this.tz][0][t].name,
...
function uX() {
    ...
    this.bp = function(G, N) {
        if (13 <= d) N ? E = G : E === G && e.saveString(200, G);
            ...
            (cC.mC[1].ih.lC || cC.mC[2].ih.lC) && cC.uh();
            je.th();
            E = G;
...
function uy() {
    ...
    this.v7 = function() {
        for (var k = "", n, l = 0; 3 > l; l++) n = as(this.colors[0][l], 4), 10 > n && (k += "0"), k += n.toString();
        a8(k)
    };
    this.lm = function(k) {
...
function kB() {
    function g() {
        return 0 === D ? 0 : 1 + (D - 1 + K) % (eD.vM - 1)
    }

    function k() {
        D++;
        I = c4.gc;
        eD.ri(g(), 4) && (J = !0, ir.vN(g()))
    }

    function n() {
        0 === D ? jj.vS(3249) : (D === eD.vM - 1 && (D = -1), k())
    }
    ...
    this.dF = function() {
        6 === aJ.pY() &&
            (J ? c4.gc > I + 2E4 && jj.vS(3250) : c4.gc > I + 2E4 && n(), x += .07 * t * (16 > x ? 5 + x : 84 < x ? 105 - x : 17), 100 < x ? (x = 100, t = -1) : 0 > x && (x = 0, t = 1), E = "rgba(0," + Math.floor(190 - 1.9 * x) + "," + Math.floor(120 - 1.2 * x) + "," + (.4 + .004 * x) + ")", F = "rgba(0," + Math.floor(1.9 * x) + "," + Math.floor(1.2 * x) + "," + (.8 - .004 * x) + ")", c4.c5 = !0)
    };
    this.cG = function() {
...
function kC() {
    ...
    this.vg = function() {
        return nU.lF() || cC.uh() ? !0 : cD.lC ? (cD.lC = !1, !0) : !1
    };
    this.aK =
        function() {
            c4.c5 = !0;
    ...
    this.c7 = function(k, n) {
        if (!vc.c7(k, n) && vf && !(nU.c7(k, n) || 6 === g && ji.c7(k, n) || 2 === g && dy.c7(k, n) || jt.c7(k, n) || cD.c7(k, n) || vk.c7(k, n, !0) || cC.c7(k, n, !0))) {
            jg.c7(k, n);
            if (0 === g) je.c7(k, n);
...
function vq() {
    ...
    this.cG = function() {
        ...
        for (var n = Math.floor(this.c1 /
                this.nh), l = (n - 2 * this.bB * n) / a5.c1, x = a5.nl - 1; 0 <= x; x--) cH.setTransform(1, 0, 0, 1, Math.floor(g + x % this.nh * n), Math.floor(k + as(x, this.nh) * n)), a5.a7[x] && (cH.fillStyle = oM, cH.fillRect(0, 0, n, n)), cH.setTransform(l, 0, 0, l, Math.floor(g + x % this.nh * n + this.bB * n), Math.floor(k + as(x, this.nh) * n + this.bB * n)), cH.drawImage(a5.l5[x], 0, 0);
        cH.setTransform(1, 0, 0, 1, 0, 0);
        cH.imageSmoothingEnabled = !1
    }
}
...
function kD() {
    function g() {
        var t = aJ.pY();
        0 === t ? je.th() : 6 === t ? eD.vU(n) : 7 === t ? (jr.th(), eD.close(eD.vv, 3240)) : 8 === t && (jb(), je.th());
        aJ.setState(3);
        jh.rq();
        jh.uo[2].nY = k(n);
        c4.c5 = !0
...
function kh() {
    ...
    this.eZ = function() {
        0 < l && c4.gc > n && (l--, n += 4500, 0 === c4.wD && 0 === c4.wE && (0 === l && eD.jc < eD.wF && (eD.jc += eD.wG), eD.ri(eD.jc, 5)))
    };
    this.wH = function() {
        10 === aJ.pY() &&
            (k++, 2 <= k && (jp.wI(g), g = null))
    }
}
...
function ke() {
    ...
    function x(P, U) {
        ...
        for (X = 0; X < y[1]; X++) {
            var ba = A;
            for (W = 0; W < y[0]; W++) {
                if (P > ba && P < ba + t && U > na && U < na + t) return ir.xC(F[V].wx), N = F[V].wx !== N ? F[V].wx : -1, c4.c5 = !0;
                V++;
...
function kF() {
    ...
    this.c7 = function(g, k) {
        var n = jh.pP(g, k, 5, 2);
        5 === n ? aC() : 6 === n && (je.bp(), jh.lm(g, k, !1), c4.c5 = !0)
    }
}
...
function kG() {
    ...
    this.c7 = function(n, l) {
        ...
        } else if (this.dz[t].mt === z) return this.dz[t].mt = 1, !0;
        this.dz[t].mt += y;
        1 > this.dz[t].mt ? this.dz[t].mt = 1 : this.dz[t].mt > z && (this.dz[t].mt = z);
        return !0
    };
    this.xM = function() {
    ...
    this.pP = function(n, l) {
        ...
        return 8 > this.dz.length ? (A = k[1] + z + cA + this.dz.length * (y + cA), l < A || l > A + y || n > k[0] + y ? -1 : 27) : -1
    };
    this.cG = function() {
        var n;
        cH.lineWidth = 2;
        ...
        if (!dr.ds) {
            ...
            if (8 > this.dz.length) {
                ...
                n = k[0];
                cH.fillStyle = cK;
                l = mc(2, Math.floor(.5 * t));
                l -= l % 2;
                x = mc(2, Math.floor(.1 * t));
                x -= x % 2;
                t = Math.floor((t - l) / 2);
    ...
    this.xV = function(n) {
        return 0 === n && 1 === this.dz[n].mt ? "You" : dG.dl[this.dz[n].bD]
    };
    this.xW = function(n) {
        return 1 === this.dz[n].mt ? "1 Player" : this.dz[n].mt + " Players"
    }
}
...
function p3() {
    ...
    this.pP =
        function(g, k) {
            ...
            for (var n = this.b3 - 1; 0 <= n; n--)
                if (g >= this.mC[n].fJ && k >= this.mC[n].fK && g < this.mC[n].fJ + this.c1 && k < this.mC[n].fK + this.c1) return n;
            return -1
        };
    this.xZ = function() {
        for (var g = 2; 1 <= g; g--)
    ...
    this.c7 = function(g, k, n) {
        ...
        g = this.pP(g, k);
        if (n) {
            if (0 === g) return this.mC[g].m1 = !this.mC[g].m1, q = this.mC[g].m1, jq.xa(), a1(this.mC[0].m1, !1), !0;
            if (1 <= g && 3 > g) return this.mC[g].ih.bp(), je.th(), c4.c5 = !0
        }
        return !1
    };
    this.lm = function(g, k) {
    ...
    this.v8 = function() {
        for (var g = 2; 1 <= g; g--)
            if (this.mC[g].ih.lC) return this.mC[g].ih.v8(), !0;
        return !1
    };
    this.cG = function() {
        if (bw.bx()) {
            ...
            for (var g = this.b3 - 1; 0 <= g; g--) cH.fillStyle =
                this.mC[g].m1 ? mZ : hy, cH.fillRect(this.mC[g].fJ, this.mC[g].fK, this.c1, this.c1), 0 === g ? this.xb(g, bw.bz(15)) : 1 === g ? this.xc() : 2 === g && this.xd(), cH.setTransform(1, 0, 0, 1, 0, 0), cH.lineWidth = ow, cH.strokeStyle = cK, cH.strokeRect(this.mC[g].fJ, this.mC[g].fK, this.c1, this.c1);
            cH.imageSmoothingEnabled = !1
        }
    };
    this.xb = function(g, k) {
        ...
        cH.setTransform(l, 0, 0, l, this.mC[g].fJ + n, this.mC[g].fK + (this.c1 - l * k.height) / 2);
        cH.drawImage(k, 0, 0)
    };
    this.xc = function() {
        var g = .06 * this.c1,
...
function kH() {
    ...
    function n() {
        ...
        k();
        5 <= d ? jj.vS(3232) : (jj.vS(3265), vc.lC = !0,
            vc.bs = -1);
        return !0
    }

    function l() {
        if (void 0 !== x && m.iN(x)) return jk.w3(0, !0), !0;
        jk.w3(0, !1);
        return !1
    }
    var x;
    ...
    this.vh = function() {
        n() || g() || (a9(10), void 0 !== x && m.iN(x) && 40 === x.charCodeAt(0) && 41 === x.charCodeAt(2) ? ji.vK((Math.abs(x.charCodeAt(1)) + 5) % eD.vM) : ji.vK(jt.xn - 1), l() ? bw.bx() ? (this.th(), w(x), dr.pU(), ji.bp()) : jj.vS(3228) : jj.vS(4214))
    };
    this.xr = function() {
        return !cC.xZ() && !cD.lC && !nU.lC
    };
    this.cG = function() {
        if (this.xr()) {
            cH.imageSmoothingEnabled = !0;
...
function kI() {
    function g(t, z, y, A) {
        ...
        n[t].onload = function() {
            ...
            k--;
            bw.bx() && (uO.bv(), hu.l1(), a5.bp(), vk.uk([n[8], n[16], n[7], n[9], n[10]], [!b, 0 === d, !0, !0, !0]), c4.c5 = !0, n[7] = x, n[8] = x, n[9] = x, n[10] = x)
        };
        n[t].src = A
    }
    var k, n, l, x;
...
function kJ() {
    ...
    this.bp = function(D) {
        ...
        I[3] = -I[1];
        if (dA)
            for (var K, J = b8 - 1; 0 <= J; J--) K = dW.im[dW.dX[J]], D = as((x[K][3] + 1) * ce.random(), ce.value(100)), t[J] = l[K][0] + D * x[K][0], z[J] = l[K][1] + D * x[K][1], y[J] = l[K][2] + D * x[K][2];
        else if (dr.ds && dr.dt.yP)
            for (D = dr.dt.yP, K = hM - 1; 0 <= K; K--) t[K] = 4 * D[K][0], z[K] = 4 * D[K][1], y[K] = 4 * D[K][2];
        else {
            for (K =
                b8 - 1; K >= cq; K--) t[K] = 4 * as(64 * ce.random(), ce.value(100)), z[K] = 4 * as(64 * ce.random(), ce.value(100)), y[K] = 4 * as(64 * ce.random(), ce.value(100));
            for (K = cq - 1; 0 <= K; K--) t[K] = 4 * D[K].xS[0], z[K] = 4 * D[K].xS[1], y[K] = 4 * D[K].xS[2]
        }
        for (D = b8 - 1; 0 <= D; D--) K = as(t[D] + z[D] + y[D], 3), t[D] += yY(K - t[D], 2), z[D] += yY(K - z[D], 2), y[D] += yY(K - y[D], 2), t[D] -= t[D] % 4, z[D] -= z[D] % 4, y[D] -= y[D] % 4;
        for (D = b8 - 1; 0 <= D; D--) t[D] += as(D, 128), z[D] += as(D % 128, 32), y[D] += as(D % 32, 8), A[D] = D % 8;
        this.yV();
...
function kj() {
    ...
    this.dF = function() {
        if (0 !== k)
            if (0 === fF[aw] || ae.z2(aw) === ae.af(aw)) k = 0;
            else {
                var l;
                for (l = k - 2; 0 <= l; l -= 2) {
                    var x = n[l];
                    if (x < b8 && 0 === fF[x]) g(l);
                        ...
                        var t = n[l + 1];
                        if (x >= b8 && lf(aw) || x < b8 && lk(aw, x)) dx ? fL(aw, x, t) : ir.lU(t, x === b8 ? aw : x), g(l)
                    }
                }
            }
    };
...
function z5(g) {
    hu.lE(g) && iw++;
    var k = ae.zA(g);
    0 === k.length ? g === aw && zB() : (zC(g, k), zD(g, k))
}

function zB() {
    b0.b1[17] += ax[aw] + ae.zE(aw);
    eW.show(!1, !1);
    eB.tI()
}
...
function kq() {
    ...
    this.xQ = function() {
        this.dt.yP &&
            this.dt.za && (this.dt.yP[0] = cC.mC[2].ih.v6());
        jG(this.dt.zb, 0, this.zc(), this.dt.jJ, !1)
    };
    this.zc = function() {
        return [{
            name: this.dt.zd ? je.xR() : this.dt.ze[0],
            xS: [0, 0, 0],
            xT: 0
        }]
    };
...
function kM() {
    ...
    this.a09 = function() {
        t = 512;
        x = new Uint16Array(t);
        for (var z = 0; z < t; z++) x[z] = 100 + bl(as(25600 * z, t - 4), 9)
    };
    this.sF = function() {
        return l
    };
    this.dF = function() {
        if (0 >= --n) {
            ...
            for (z = dY - 1; 0 <= z; z--) {
                var A = as(ay.tU(dZ[z]) * ax[dZ[z]], 1E4);
                ax[dZ[z]] += 1 > A ? 1 : A;
                ay.az(dZ[z])
            }
            b0.b1[9] += ax[aw] - y;
...
function kN() {
    ...
    function k() {
        ...
        for (var O = gC / g7, T = gD / g7, Y = (gE + gC) / g7, Z = (cB + gD) / g7, la, ma, ia, fa, qa, ua = 0 !== fF[aw] && hu.lE(aw), za = dY - 1; 0 <= za; za--)
    ...
    this.ml = function(O) {
        var T = O + 2 * b8,
            Y = ca[T];
        return 0 < Y ? (e9.n7(50, O), ca[T] = 0, 255 === Y) : !1
    };
    this.li = function(O) {
...
function ki() {
    ...
    this.bp = function() {
        ...
        var x = ce.a1N(0);
        ce.jN(0);
        for (l = 1; l < this.wF; l++) this.a1c[l] = m.iZ() + ".territorial.io";
        ce.jN(x);
        k = Array(this.vM);
        n = Array(this.vM);
    ...
    this.n0 = function() {
        return this.vv < this.wF ? this.vv : this.vv - this.wG
    };
    this.dF = function() {
        for (var l =
                this.vM - 1; 0 <= l; l--) this.vI(l) && c4.gc > n[l].gc + 15E3 && ir.a1i(l, n[l].a1h)
    };
    this.ri = function(l, x) {
        if (!n[l].a1g) return this.a1k(l, x), !1;
    ...
    this.a1p = function(l, x) {
        0 === x ? jg.rk() : 3 > x ? ir.uF(l, x - 1) : 3 === x ? ir.xP(l) : 4 === x ? ji.rk(l) : 5 === x ? l === this.jc && ir.a1q() : 6 === x ? ir.a1r(l) : 7 === x && ir.xp(l)
    };
    this.vI = function(l) {
        return n[l].a1g &&
            k[l].vI()
...
var p5, cH, a1y, a1z, r, s, pI, bq, gE, cB, pM, a20, b, c, e, d, q, a21 = !1,
    a22, a23, i, gy, sm, h8, a5, b0, hv, vc, c4, dW, eT, cD, fi, vk, nU, uO, a24, a25, a26 = 0,
    a27 = "",
    a28 = !1;
...
function a2F(g) {
    a21 || (a21 = !0, g.message ? (a26 = g.lineno, a27 = g.message, eD.ri(0, 6) && ir.a1r(0), g = "[A_ERROR " + a26 + "][" + a27 + "]", a2N(g)) : (g = "[B_ERROR " + g.type + "][" + (g.srcElement || g.target) + "]", console.log(g)))
}
...
function a2C(g) {
    400 > c4.gc || (8 !== aJ.pY() && aJ.uh(g) ? c4.c5 = !0 : "Escape" === g.key ? aJ.aK() : "ArrowLeft" === g.key ? gn.a2Q(3) : "ArrowUp" === g.key ? gn.a2Q(0) : "ArrowRight" === g.key ? gn.a2Q(1) : "ArrowDown" === g.key ? gn.a2Q(2) : "h" === g.key && 1 <= fZ && (gi = !gi, c4.c5 = !0))
}

function a2B() {
    a20 = window.location.hostname;
    a23 = 0 <= a20.toLowerCase().indexOf("territorial.io")
}
...
function kP() {
    ...
    this.a2S = function() {
        ...
        this.e3 = 0;
        this.e4 = [0, 0, 0, 0, 0, 0];
        cq <= k[0] ? (this.e3 = n[0] - cq, this.e4[1] = n[1] - as(n[1] * cq, k[0]), this.e4[0] = 512 - this.e4[1] - n[0]) : cq <= k[1] ? (this.e3 = n[0] - k[0] - as((n[0] - k[0]) * (cq - k[0]), k[1] - k[0]), this.e4[0] = 512 - this.e3 - cq) : cq <= k[2] ? (this.e4[0] = 512 - k[1] - as((512 - k[1]) * (cq - k[1]), k[2] - k[1]), this.e4[1] = 512 - cq - this.e4[0]) : cq <= k[3] ? (this.e4[1] = 512 - k[2] - as((512 - k[2]) * (cq - k[2]), k[3] - k[2]),
...
function a2G() {
    ...
    function k(l, x) {
        0 < x && (x7[l] += x, x7[l + 1] += x, x7[l + 2] += x)
    }

    function n(l) {
        return x7[l + 2] > x7[l] && x7[l + 2] > x7[l + 1]
    }
    this.rd = -1;
    this.a2k = this.aA = 0;
    this.a2l = 8;
    ...
    this.a2z = function(l, x, t) {
        k(l, Math.floor(this.a2p[t] + this.qv[t] * this.a2q[x] / 1E4) - x7[l])
    };
...
function a36(g, k, n, l, x) {
    ...
    for (z = aZ - 1; 0 <= z; z--)
        for (y = aa - 1; 0 <= y; y--) {
            ...
            for (t = 1; t < C; t++)
                if (I < n[t]) {
                    D = l[t - 1] + yY((I - n[t - 1]) * F[t], E[t]);
                    K = x[t - 1] + yY((I - n[t - 1]) * G[t],
                        E[t]);
                    break
                } a3K(aZ * y + z, D, K, N)
        }
        ...
        for (z = aZ * aa - 1; 0 <= z; z--)
            for (y = B; 0 <= y; y--)
                if (A[z] >= n[y]) {
                    var N = A[z] -
                        n[y];
                    x7[4 * z] = l[y] + yY(E[y] * N, C[y]);
                    x7[4 * z + 1] = x[y] + yY(F[y] * N, C[y]);
                    x7[4 * z + 2] = t[y] + yY(G[y] * N, C[y]);
                    x7[4 * z + 3] = 255;
                    break
...
function a2b(g) {
    ...
    for (var x = k.length, t = !0, z = 0, y = 4; y < x; y++)
        if (t) {
            for (; 0 < k[y]--;) x7[z] = l[0], x7[z + 1] = l[1], x7[z + 2] = l[2], x7[z + 3] = 255, z += 4;
            t = !1
        } else {
            for (; 0 < k[y]--;) x7[z] = n[0], x7[z + 1] = n[1], x7[z + 2] = n[2], x7[z + 3] = 255, z += 4;
            t = !0
...
function kS() {
    ...
    this.jT = function(J) {
        ...
        for (J = 0; J < t; J++)
            if (!N[J])
                for (L = 0; L < z; L++) I[L] || (H = x[L * t + J - 1] + x[(L - 1) * t + J], M = 2, N[J + 1] && (M++, H += x[L * t + J + 1]), I[L + 1] && (M++, H += x[(L + 1) * t + J]), x[L * t + J] = as(H, M))
    };
    this.a2x = function() {
        return x
    };
...
function a4C(g, k) {
    for (var n = as(g + 1, 2), l = 0; l < k; l++) n = as(n + as(g, n), 2);
    return n
}

function bl(g, k) {
    return 1 > g ? 0 : a4C(g, k)
}

function a4D(g, k, n, l, x, t, z, y) {
    return !(g + n <= x || k + l <= t || g >= x + z || k >= t + y)
}

function a4E(g, k, n, l, x, t, z, y) {
...
function kk() {
    ...
    this.bp =
        function() {
            ...
            if (b) this.a1L = c.freeSpawn, this.a4F = c.unlimitedTime, this.a0g = !1;
            else if (5 <= d) this.a1L = 1 === e.loadNumber(25), this.a4F = 1 === e.loadNumber(26), this.a0g = !1;
            else {
                var y = f.g(6);
                this.a1L = 1 === (y & 1);
                this.a4F = 2 === (y & 2);
    ...
    this.cG = function() {
        ...
        if (!(7 <= aJ.pY())) {
            ...
            if (t) {
                var B = z.length;
                for (y = 1; y < B; y++) l(A.f9, A.f8 + y * A.nP - 2 * y, A.i5, A.nP, z[y].fB, z[y].n4,
                    z[y].cm, x === y, z[y].name, y === B - 1 ? .32 : .45)
            }
        }
    }
}
...
function kV() {
    ...
    this.bp = function() {
        k = Array(101);
        for (var n = k.length - 1; 0 <= n; n--) k[n] = as(32768 * n, 100);
        this.jN(0)
    };
...
function kc() {
    ...
    function k() {
        t = 0;
        z += 700 > z ? 200 : 0;
        bw.bx() && (l() || x) && (x = !1, p2(), uO.bp(), jh.bp(), jk.lv(), vk.bp(), ji.lv(), jg.lv(), jf.lv(), vc.lv(), cD.lv(), a5.bp(), 1 <= fZ ? (eM.lv(!1), eO.lv(), eB.lv(), gj.lv(), eR.lv(), e9.lv(), fq.lv(), eS.lv(), eP.lv(), c2.lv(), hu.l1(), hv.lv(), eA.lv(), eW.lv(), eT.lv(), gj.rI()) : (0 === aJ.pY() ? jk.cE(0, !0) : 2 === aJ.pY() ? dy.lv() : 3 === aJ.pY() && jj.lv(), aJ.vg(), aJ.vl()), c4.c5 = !0)
    }
    ...
    function l() {
        ...
        jt.a0g ? (pM = window.devicePixelRatio) || (pM = 1) : pM = 1;
...
function kW() {
    ...
    this.dF = function(G, N, I, D, K) {
        ...
        if (G && (k(), G = as(l, 128), G = 1 > G ? 1 : G, l -= G, n === aw && (b0.b1[15] += G), l <= at ? (n === aw && (b0.b1[15] += l), g(!1), G = !1) : (ae.bT(n, E, l), G = !0), G))
            if (G = b5.f1(z, y), x = Math.abs(A - z) >= Math.abs(B - y) ? G + aV[A > z ? 1 : 3] : G + aV[B > y ? 2 : 0], z = b5.gF(x), y = b5.cF(x),
                ...
                if (b5.bG(x)) G = b8;
                    ...
                    if (!ch(n, G)) {
                        N = bU[G] * j7 - ax[G];
                        0 >= N || (N = l > N ? N : l, l -= N, n === aw && (e9.n8(N, G), b0.b1[16] += N), G === aw && (e9.nA(N, n), b0.b1[10] += N), ax[G] += N);
                        g(!0);
                        break a
                    }
                }
                n === aw && (b0.b1[13] += l);eK.av(n, F);ae.b2(n, E);b4[n].push(t);ae.cQ(n, l, G);au.cR(n, !0)
            }
    };
...
function kX() {
    ...
    this.hr = function() {
        var x = n ? 0 : -g;
        a4E(x, x, aZ - 2 * x, aa - 2 * x, gy.a59, gy.a5A, gy.a5B, gy.a5C) || (cH.fillStyle = l, cH.fillRect(0, 0, gE, cB))
    };
    this.cG = function() {
        n || (a4D(0, -g, aZ, g, gy.a59, gy.a5A, gy.a5B, gy.a5C) && cH.drawImage(k[0], gy.a5D, gy.a5E - g), a4D(aZ, -g, g, aa + 2 * g, gy.a59, gy.a5A, gy.a5B, gy.a5C) && cH.drawImage(k[1], gy.a5D + aZ, gy.a5E - g), a4D(0, aa, aZ, g, gy.a59, gy.a5A, gy.a5B, gy.a5C) && cH.drawImage(k[2], gy.a5D, gy.a5E + aa), a4D(-g, -g, g,
...
function a1o() {
    ...
    this.bp = function(F, G) {
        ...
        var N = p0[0];
        N = z < eD.wF ? N + (eD.a1c[z] + p0[1 + a25]) : N + (eD.a1c[0] + "/i" + (1 + a25) + (z - eD.wG) + "/");
        E = new WebSocket(N);
        E.onopen = k;
        E.onmessage = n;
        E.onclose =
...
function a2I() {
    ...
    this.a5U = function() {
        0 !== fF[aw] && (this.a5P[this.m4] = bU[aw], this.s6[this.m4] = ax[aw], this.tT[this.m4] = ay.tU(aw), this.a5V(this.m4), this.m4++, this.m4 === this.cV && this.a5W(), this.dV = this.a5Q - 1, hv.bv())
    };
    this.a5W = function() {
        this.a5S();
        this.a5V(0);
...
function a2J() {
    ...
    this.lv = function() {
        ...
        this.a5X = Math.floor(this.c1 * (q ? .028 : .02));
    ...
    this.m9 = function(g, k, n) {
        ...
        cH.fill();
        g = this.a5Z * c4.tV();
        g = 0 === fF[aw] ? Math.floor(g * eW.tb) : Math.floor(g * c4.dU());
        cH.fillStyle = cK;
        cH.fillText(1 === n ? eB.nG(t / 100, 2) : eP.gJ(Math.floor(t)), -this.i4, this.xJ - k * Math.pow(t, n));
        cH.textAlign = cJ;
        cH.fillText(eB.sF(g), l * this.uT / (b0.m4 - 1), this.xJ + this.a5X - (q ? 2 : 0));
        cH.textAlign = oj;
...
function bV() {
    for (var g, k, n = aQ - 1; 0 <= n; n--) g = as(aS[n], 4) % aZ, k = as(aS[n], 4 * aZ), d0[aM] = d0[aM] > g ? g : d0[aM], d3[aM] = d3[aM] > k ? k : d3[aM], cz[aM] = cz[aM] < g ? g : cz[aM], d2[aM] = d2[aM] < k ? k : d2[aM]
}
...
function a6V() {
    ...
    this.dF = function() {
        jq.dF();
        fc ? ec() : 0 === this.bs ? c4.gc >= this.gc && (this.gc += this.a5Q * Math.floor(1 + (c4.gc - this.gc) / this.a5Q), 2 === fZ || fq.lu ? e8() : (eE(), this.wE++, h8.tv()), this.bs++) : (fq.lu ? ec() : (c4.c5 = !0, ea()), this.bs = 0);
        eU();
        c4.c5 && (c4.c5 = !1, hp())
    }
}
...
function a6X() {
    ...
    this.tW = function(k) {
        ...
        g = (g + 1) % 8;
        eB.tW(this.wD);
        this.wD === jF ? (fd.dF(), this.wE = this.bs = this.wD = 0, this.gc = c4.gc) : (this.wD++, eA.j4(), eA.eb(), h8.tv())
    };
    this.dF = function() {
        jq.dF();
        fc ? (c4.c5 =
            eB.tW(-1) || c4.c5, ec()) : 0 === this.bs ? c4.gc >= this.gc && (this.gc += this.a5Q * Math.floor(1 + (c4.gc - this.gc) / this.a5Q), 2 === fZ ? e8() : this.a6d(), this.bs++) : (c4.c5 = !0, ea(), this.bs = 0);
        eU();
        c4.c5 && (c4.c5 = !1, hp())
    };
    this.a6d = function() {
...
function kl() {
    function g(k, n) {
        8 !== aJ.pY() || 0 !== n && n !== dv || dx || e9.my(k)
    }
    this.gW = 0;
    this.a6g = !0;
    this.dF = function() {
        c4.gc > this.gW && (this.gW = c4.gc + 2500, this.a6h())
    };
    this.a6h = function() {
        var k = new Date;
        var n = k.getUTCSeconds();
        this.a6g ? 55 > n || -1 !== c4.a6R || (this.a6g = !1, n = k.getUTCMinutes(), 4 === n % 5 ? (k = k.getUTCHours(), 59 === n && 15 <= k && 21 >= k ? g("Upcoming Game of the Day", 0) : 14 === n % 30 ? g("Upcoming Alliance Contest", 0) : 29 === n % 30 ? g("Upcoming Battle Royale Contest", 0) : g("Upcoming One-vs-One Game", 8)) : 2 === n % 5 && g("Upcoming Zombie Game",
            9)) : 55 > n && (this.a6g = !0)
    }
}
...
function kY() {
    ...
    function k(z) {
        n = pM * z.touches[0].clientX;
        l = pM * z.touches[0].clientY;
        x = pM * z.touches[1].clientX;
        t = pM * z.touches[1].clientY
    }
    var n, l, x, t;
    this.pN = function(z) {
...
function kZ() {
    ...
    function k(x, t) {
        for (var z = 0, y, A, B = l; B < l + t; B++) y = as(B, 8), A = 7 - B % 8, z |= (x[y] >> A & 1) << l + t - B - 1;
        l += t;
        return z
    }
    var n, l;
    this.a5O = function(x, t) {
        ...
        if (0 === n) eD.a1t(x, 3205);
                    ...
                    if (0 === k(t, 1)) {
                        ...
                        if (8 !== aJ.pY())
                            if (3 > n) eD.a1t(x,
                                ...
                                0 === y ? cD.uH(0, C, 10, 1, .36, .55, A) : cD.uH(1, C, 100, 2, .47, .5, A)
                            }
                    }
            else if (1 === z)
                if (x !== eD.vv) eD.close(x, 3239);
            ...
            else 1 === z && (z = aJ.pY(), 8 !== z ? 10 === z && eD.a1t(x, 3243) : x !== eD.jc ? eD.a1t(x, 3244) : 0 === k(t, 1) ? c4.a6Q.a6b(t) : (z = k(t, 2), 0 === z ? 3 !== n ? eD.a1t(eD.jc, 3230) : (z = k(t, 9), y = k(t, 7), 0 !== fF[z] && 0 !== fF[aw] && (y %= a5.a6, e9.mp(z, aw, y), eA.n2(z, 1, y))) : 1 === z ? 2 !== n ? eD.a1t(eD.jc, 3235) : (z = k(t, 9), 0 !== fF[z] && 0 !== fF[aw] && eQ.a1W(0, [z], !0) && e9.lY(z, 1)) : 3 !== n ? eD.a1t(eD.jc, 3236) : (z = k(t, 9), y = k(t, 9), 0 !== fF[z] && 0 !== fF[y] && 0 !== fF[aw] && eQ.a1W(1, [z], !0) && (eA.n2(z, 3, 96), eA.n2(y, 4, 96), e9.n5(z, y)))))
        }
    };
    this.wI = function(x) {
        l = 1;
...
function kf() {
    ...
    this.lv = function() {
        var k = as(zV + zV % 2, 2);
        k = s - k * cA;
        this.xK[2] = q ? Math.floor(.75 * pI) : Math.floor(.5 * pI);
        this.xK[3] = Math.floor(1.2 * this.xK[2]);
        this.xK[3] > k && (this.xK[3] = k, this.xK[2] = Math.floor(k / 1.2));
        this.xK[0] = Math.floor((r - this.xK[2]) /
            2);
        this.xK[1] = Math.floor((s - this.xK[3]) / 2)
    };
    this.lm = function(k, n) {
...
function kb() {
    ...
    function n(t) {
        return as(t, 8) + (0 < t % 8 ? 1 : 0)
    }

    function l(t, z, y) {
        for (var A, B, C = x; C < x + z; C++) A = as(C, 8), B = 7 - C % 8, t[A] |= (y >> z - (C - x + 1) & 1) << B;
        x += z
    }
    var x;
    this.rl = function() {
    ...
    this.uF = function(t, z) {
        ...
        l(y, 14, a1z);
        l(y, 1, z);
        l(y, 16, Math.abs(4096 + cD.position[z] + cD.uE[z]) % 65536);
        eD.send(t, y)
    };
    this.a1r = function(t) {
    ...
    this.xp = function(t) {
        ...
        if (!(je.xf + 7E3 > c4.gc)) {
            ...
            l(y, 3, 2);
            g(y);
            var A = mc(je.xe.length - 20, 0);
            for (z = je.xe.length - 1; z >= A; z--) l(y, 4, Math.abs(je.xe.charCodeAt(z) - 48) % 10);
            eD.send(t, y)
        }
    };
    this.a1i = function(t, z) {
    ...
    this.lQ = function(t, z) {
        var y, A = t.length,
            B = new Uint8Array(n(15 + 9 * A));
        x = 0;
        l(B, 1, 1);
        l(B, 3, 6);
        l(B, 2, 2);
        l(B, 9, z);
        for (y = 0; y < A; y++) l(B, 9, t[y]);
        eD.send(eD.jc, B)
    };
    this.qg = function(t) {
        var z = new Uint8Array(1);
