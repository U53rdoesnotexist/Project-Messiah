...
function jz() {
    ...
    this.click = function(L, P) {
        ...
        if (Math.abs(L - B) > I || Math.abs(P - C) > I || (new Date).getTime() > E + 425) return !1;
        I = Math.floor((L + gC) / g7);
        var O = Math.floor((P + gD) / g7);
        if (1 > I || 1 > O || I >= aZ - 1 || O >= aa - 1) return !1;
        var R = O * aZ * 4 + 4 * I;
        if (!b5.b6(R)) return !1;
        if (2 === ec) return 1 <= a5.lf && (G = b5.bF(R), this.lG(G)) ? (G === aw && this.lH(), y[4] = !0, this.lg(L, P)) : !1;
        F = b5.f2(I, O);
        if (fc) return y[0] = !0, this.lg(L, P);
        y[1] = f0.co(aw, F);
        if (b5.bG(R)) return G = b8, lh(aw) ? y[0] = !0 : li(aw, G) && (y[8] = !0), this.lg(L, P);
        G = b5.bF(R);
        if (G === aw) {
            this.lH();
            if (0 === a5.lf) return !1;
        ...
        I[6] = O;
        y[4] = 1 <= a5.lf && this.lG(G);
        if (ch(G, aw)) {
            y[5] = this.lG(G) && !eA.lk(G) && eQ.lQ(0, [G], !1);
            I = y;
            O = G;
            if (0 === K.length) O = !1;
...
function k0() {
    function g() {
        ...
        B.fillStyle = lz;
        B.fillRect(0, 0, l, l);
        0 === x && (B.fillStyle = m0, B.fillRect(0, 0, l, l));
        B.fillStyle = cK;
        B.fillRect(0, 0, l, 1);
        B.fillRect(0, 0, 1, l);
    ...
    function k(B, C) {
        ...
        if (B <= 4 * l + m7) {
            if (C >= eR.fL) return 0;
            if (C >= eR.fL - l - A * m7) return 2;
            if (C >= eR.fL - 2 * (l + A * m7)) return 3
        } else if (B <= 7 * l + m7 && C >= eR.fL - l - A * m7) return 1;
        return -1
    }
    ...
    function t(B, C) {
        ...
        x === B + 1 && C === cK && (cH.fillStyle = m0, cH.fillRect(0, 0, 4 * l, l));
        cH.fillStyle = C;
    ...
    this.m2 = function() {
        (this.lw = !this.lw) ? (gl = !1, dx && 1 === ec && !fc && (eM.eb(!0), setTimeout(function() {
            hB.j2()
    ...
    this.c7 = function(B, C) {
        var E = k(B, C);
        return this.lw ? 0 === E ? (je(), 2) : 1 === E ? (this.m2(), 2) : 2 === E ? (this.fr(aw) && (dx ? eG.fp(aw) : iu.m5(), this.m2()), 2) : 3 === E && 2 <= b0.m6 ? (hy.m2(), c4.c5 = !0,
            2) : hy.lE ? 1 : (this.m2(), 2) : 0 === E ? (this.m2(), 2) : 0
    };
    ...
    this.cG = function() {
        if (this.lw) {
            ...
            cH.fillStyle = lz;
            cH.fillRect(0, 0, B, l);
            0 === x ? (cH.fillStyle = m0, cH.fillRect(0, 0, 4 * l, l)) : 1 === x && (cH.fillStyle = m0, cH.fillRect(4 * l, 0, Math.floor(1.5 * l), l));
            cH.fillStyle = cK;
            cH.fillRect(0, 0, B, 1);
            cH.fillRect(0, 0, 1, l);
            cH.fillRect(4 * l, 0, 1, l);
...
function k1() {
    ...
    function A(I, O, R, N, T, U, Z, Y) {
        ...
        if (W + H > r && !qa && 50 !== R && 20 < O.length) {
            ...
            qa && (qa = M / a5.c1, V.imageSmoothingEnabled = !0, V.setTransform(qa, 0, 0, qa, W - M, 0), V.drawImage(a5.l7[ca], 0, 0));
            F.unshift({
                gf: I,
                l: O,
                id: R,
    ...
    function G(I, O) {
        return dx || I >= cq || O || gI.gJ.nQ ? gM[I] : nR[I]
    }
    var F, M, H, D, K, J, L, P;
    this.bp = function() {
        L = 0;
        ...
        this.lx();
        fc && this.fl(0, 18);
        var I = "Map: " + jp.nF() + "   Pixels: " + eP.gL(jT.nG) + "   Land: " + eP.gL(jT.nH) + " (" + eB.nI(100 *
                jT.nH / jT.nG, 1) + ")",
            O = "";
        0 < jT.nK && (O += "Water: " + eP.gL(jT.nK) + " (" + eB.nI(100 * jT.nK / jT.nG, 1) + ")");
        0 < jT.nL && (O += 0 < jT.nK ? "   " : "", O += "Mountains: " + eP.gL(jT.nL) + " (" + eB.nI(100 * jT.nL / jT.nG, 1) + ")");
    ...
    this.mR = function() {
        ...
        if (dr.ds) {
            ...
            for (I = 0; I < O; I++) A(400, dr.dt.mS[I], 6, 0, C(255, 255, 255), i1, -1, !1)
        }
    };
    this.lx = function() {
        var I;
        ...
        if (0 < F.length) {
            var O = F;
            F = [];
            for (I = O.length - 1; 0 <= I; I--) A(O[I].gf, O[I].l, O[I].id, O[I].player, O[I].mW, O[I].mX, O[I].mY, O[I].mZ)
        }
        this.ma()
    };
    this.ma = function() {
    ...
    this.c7 = function(I, O) {
        for (var R = x(), N, T = F.length - 1; 0 <= T; T--)
            if (N = R - (T + 1) * M, O >= N && O < N + M) {
                ...
                if (I >= gE - F[T].c1 - H) return F[T].mZ && (eV.gj(F[T].player, 800, !1, 0), 0 <= F[T].mY && (R = F[T].mY,
                    F[T].mY = F[T].player, F[T].player = R)), !0;
                break
            } return !1
    };
    this.j6 = function(I) {
    ...
    this.fl = function(I, O) {
        0 === O ? (b0.b1[I < cq ? 4 : 3]++, c2.cQ(I, 0), A(q ? 100 : 160, "You conquered " + gM[I] + ".", 0, I, "rgb(10,220,10)", i1, -1, !1)) : 1 === O ? (E(50, b8), c2.cQ(I, 1), A(360, "You were conquered by " + gM[I] + ".", 0, I, "rgb(255,40,40)", i1, -1, !0), eV.gj(I, 2700, !0, 0)) : 2 === O ? (c2.cQ(I, 2), A(0, "Congratulations! You won the game.", 0, I, "rgb(10,255,255)", i1, -1, !0), eV.gj(I, 2700, !0, 0)) : 3 === O ? (c2.cQ(I,
            2), A(0, gM[I] + " won the game.", 0, I, cK, i1, -1, !0), eV.gj(I, 2700, !0, 0)) : 4 === O ? (j0--, iz--, this.ml(1, I, I)) : 5 === O ? 2 !== fU[I] && hx.lG(aw) && (B(1, 5), eA.mn(I) ? A(180, gM[I] + " has broken the non-aggression pact and invades you!", 1, I, C(255, 200, 180), i1, -1, !0) : A(180, gM[I] + " is attacking you!", 1, I, "rgb(255,70,10)", i1, -1, !0)) : 18 === O ? A(255, "Choose your start position!", 18, 0, cK, i1, -1, !1) : 21 === O ? A(220, "You surrendered!", O, 0, "rgb(255,40,40)", i1, -1, !1) : 22 === O && this.ml(2, I, I)
    };
    this.mo = function(I) {
        A(200, "Error [" + I + "]", 94, 0,
            cK, mq, -1, !1)
    ...
    this.it = function(I) {
        c2.cQ(I, 2);
        100 > cq ? A(0, gM[I] + " won the game.", 3, I, cK, i1, -1, !0) : A(0, gM[I] + " has been immortalized!", 3, I, cK, i1, -1, !0);
        eV.gj(I, 2700, !0, 0)
    };
    this.mr = function(I, O, R) {
        I === aw ? A(175, " Message to " + gM[O] + ": ", 1E3 + R, O, C(200, 255, 210), i1, -1, !0) : this.mu(I, R)
    };
    this.mu = function(I, O) {
        var R, N = 0;
    ...
    this.is = function(I) {
        var O = dW.iq[eT.my()];
        I ? (9 ===
            dv ? (I = "The Resistance defeated the virus.", c2.mz("The Resistance", 2, 1, 12)) : I = "Congratulations! Team " + dW.bo[O] + " has won the game!", A(0, I, 40, 0, "rgb(10,220,10)", i1, -1, !1)) : (9 === dv ? (I = "Mankind lost the war against the virus.", c2.mz("The Virus", 2, 0, 16)) : I = "Our alliance has been defeated!", A(0, I, 41, 0, "rgb(200,80,80)", i1, -1, !1));
        9 !== dv && c2.mz("Team " + dW.bo[O], 2, 1, 12);
        eV.gs(2700)
    };
    this.iC = function(I) {
        A(300, I[0].name + " [" + im.iI(I[0].iF) + "] vs " + I[1].name + " [" + im.iI(I[1].iF) + "]", 65, 0, gH, "rgba(100,255,255,0.75)",
            -1, !1)
    };
    this.n0 = function(I) {
    ...
    this.iK = function(I, O, R, N) {
        1 === eD.n2() && (A(0, I[0].name + ": " + im.iI(I[0].iF) + " -> " + O, 66, 0, cK, N[0], -1, !1), A(0, I[1].name + ": " + im.iI(I[1].iF) + " -> " + R, 66, 1, cK, N[1], -1, !1))
    };
    this.ir = function(I) {
        1 === eD.n2() && A(0, "[" + I + "] has won " + cq + (jH ? " x 2" : "") + " points!", 45, 0, "rgb(225,240,255)", i1, -1, !1)
    };
    this.la = function(I, O) {
        0 === O ? E(50, I) ? (A(128, "You signed a non-aggression pact with " + gM[I] + ".", 52, I, C(180, 255, 180), i1, -1, !0), eA.n4(I,
            2, 255)) : A(384, "You asked " + gM[I] + " to sign a non-aggression pact.", 51, I, C(210, 210, 255), i1, -1, !0) : E(51, I) ? (A(128, gM[I] + " accepted the non-aggression pact.", 52, I, cK, "rgba(60,120,10,0.9)", -1, !0), eA.n4(I, 2, 255)) : (A(384, gM[I] + " requests a non-aggression pact.", 50, I, cK, "rgba(90,90,90,0.9)", -1, !0), eA.n4(I, 2, 96))
    };
    this.lR = function(I, O) {
        ...
        N ? (R += "ordered ", N = C(255, 235, 210)) : (R += "asked ", N = C(210, 255, 210));
        1 < I.length ? A(230, R + I.length +
            " players to attack " + gM[O] + ".", 66, O, N, i1, -1, !0) : A(230, R + gM[I[0]] + " to attack " + gM[O] + ".", 66, I[0], N, i1, O, !0)
    };
    this.n7 = function(I, O) {
        bU[I] > 2 * bU[aw] ? A(230, gM[I] + " orders you to attack " + gM[O] + "!", 66, I, cK, "rgba(90,50,5,0.9)", O, !0) : A(230, gM[I] + " asks you to attack " + gM[O] + ".", 66, I, cK, "rgba(75,65,5,0.9)", O, !0)
    };
    ...
    this.lT = function() {
        A(80, "Boosting is disallowed in the first minute!", 9, 0, cK, i1, -1,
            !1)
    };
    this.nA = function(I, O) {
        2 !== fU[aw] && A(200, "You exported " + eP.gL(I) + " resource" + (1 === I ? "" : "s") + " to " + gM[O] + ".", 30, O, "rgb(190,255,190)", i1, -1, !0)
    };
    this.nC = function(I, O) {
        if (2 !== fU[aw]) {
            var R = 2 === fU[O] || O >= cq;
            var N = 200 - 20 * F.length;
            A(80 > N ? 80 : N, (R ? "A bot" : gM[O]) + " supported you with " + eP.gL(I) + " resource" + (1 === I ? "" : "s") + ".", 31, O, gH, R ? "rgba(205,205,205,0.9)" : "rgba(205,255,205,0.9)", -1, !0);
            B(31, q ? 4 : 6)
        }
    };
    this.j1 = function(I) {
        var O, R = c4.dU();
        for (O = 2; 0 <= O; O--) 0 < l[O] && (I || y[O] < R - 220) && this.nN(O)
    };
    this.nN =
        function(I) {
            var O = l[I];
    ...
    this.dF = function() {
        var I, O = F.length - J;
        O = 1 >= O ? 1 : O * O;
        for (I = F.length - 1; 0 <= I; I--) 0 < F[I].gf && (F[I].gf -= O, 0 >= F[I].gf && F.splice(I,
            1));
        if (128 !== L && (L++, !(128 > L)))
            for (I = 5, O = dY - 1; 0 <= O; O--) 1 === fU[dZ[O]] && 0 < I-- && A(240, gM[dZ[O]] + " joined the game.", 1, dZ[O], gH, "rgba(255,255,255,0.75)", -1, !0);
        this.j1(!1)
    };
    this.cG = function() {
        for (var I = x(), O, R = F.length - 1; 0 <= R; R--) O = I - (R + 1) * M, 50 === F[R].id ? (cH.drawImage(F[R].ls, gE - F[R].c1 - K - H, O), cH.drawImage(P, gE - K - H, O)) : cH.drawImage(F[R].ls, gE - F[R].c1 - H, O)
    }
}
...
function nU() {
    ...
    this.c7 = function(g, k) {
        ...
        var t = this.nY(g, k);
        if (-1 === t) return !1;
        0 === t ? (f.nZ(2), this.lE = !1) : 1 === t ? na.bp(nb, !0) : 2 === t && (f.nZ(1), this.lE = !1);
        return c4.c5 = !0
    };
    ...
    this.nY = function(g, k) {
        ...
        return 0 >
            t ? 0 : t >= this.lt.length ? this.lt.length - 1 : t
    };
    this.cG = function() {
        this.lE && this.nc()
    };
    this.nc = function() {
        ...
        for (var t = this.lt.length - 1; 0 <= t; t--) cH.setTransform(1, 0, 0, 1, g + this.i7, k + this.nV + t * (this.nV + this.nW)), cH.fillStyle = this.colors[t], cH.fillRect(0, 0, this.i8, this.nW), this.bs === t && (cH.fillStyle =
            nd, cH.fillRect(0, 0, this.i8, this.nW)), cH.fillStyle = cK, cH.fillText(this.lt[t], this.i8 / 2, .54 * this.nW), cH.strokeRect(0, 0, this.i8, this.nW);
        cH.setTransform(1, 0, 0, 1, 0, 0)
    }
}
...
function nm() {
    ...
    this.bp = function() {
        ...
        var k = bw.lB("emojis");
        this.o1();
        for (g = this.lf = 0; g < this.no; g++) this.o2(g, g, k);
        k = bw.lB("flags");
        for (g = 0; g < this.np; g++) this.o2(g,
            this.no + g, k);
        this.o4();
    ...
    this.o9 = function() {
        for (var g = this.lf = 0; g < this.a6; g++) this.a7[g] && (this.ny[this.lf++] = g)
    };
    this.lK = function() {
    ...
    this.oA = function() {
        this.lf = this.nq;
        for (var g = 0; g < this.nq; g++) this.ny[g] = this.nr + g
    };
    this.o1 = function() {
        this.ns = Math.floor((q ? .075 :
            .0468) * bq);
    ...
    this.show = function(g, k) {
        ...
        this.fA = n + y;
        this.fB = z + l;
        for (y = 0; y < this.lf; y++) this.nv[y] = Math.floor(n + y % t * this.nt), this.nw[y] = Math.floor(z + as(y, t) * this.nt);
        return !0
    };
    this.lI = function(g, k) {
        return !(g < this.nv[0] || k < this.nw[0] || g >= this.fA || k >= this.fB)
    };
    this.lJ = function(g, k, t) {
        if (t === aw && this.nz + 190 > c4.gf) return !1;
        for (var l = this.lf - 1; 0 <= l; l--)
            if (g >= this.nv[l] && k >= this.nw[l]) {
                if (39 === this.ny[l]) return this.oA(), this.show(g, k), !0;
                dx ? eA.n4(aw, 0, this.ny[l]) : t === aw ? iu.oE(this.ny[l]) : iu.oF(this.ny[l], t);
                this.o9();
                break
            } return !1
    };
    ...
    this.cG = function() {
        cH.imageSmoothingEnabled = !0;
        for (var g = this.nx * this.ns / 2, k = this.lf - 1; 0 <= k; k--) cH.setTransform(this.zoom, 0, 0, this.zoom, this.nv[k] + g, this.nw[k] + g), cH.drawImage(this.l7[this.ny[k]], 0, 0);
        cH.imageSmoothingEnabled = !1;
        cH.setTransform(1, 0, 0, 1, 0, 0)
    };
...
var gH = "rgb(0,0,0)",
    ...
    oS = "rgba(0,255,0,0.5)",
    oT = "rgba(0,200,0,0.5)",
    mb = "rgba(0,100,0,0.75)",
    oU = "rgba(0,40,0,0.8)",
    oV = "rgb(128,255,128)",
    oW = "rgba(255,255,150,0.2)",
    oX = "rgba(0,255,0,0.3)",
    m0 = "rgba(255,255,255,0.3)",
    oY = "rgba(0,40,90,0.75)",
    oZ = "rgba(220,0,0,0.6)",
    oa = "rgba(255,100,100,0.8)",
    mq = "rgba(100,0,0,0.85)",
    ob = "rgba(60,0,0,0.85)",
    oc = "rgb(255,120,120)",
    od = "rgb(255,160,160)",
    oe = "rgb(255,70,70)",
    of = "rgb(230,0,0)",
    og = "rgba(0,60,60,0.85)",
    oh = "rgb(160,160,255)",
    cK = "rgb(255,255,255)",
    oi = "rgba(255,255,255,0.6)",
    oj = "rgba(255,255,255,0.4)",
    nd = "rgba(255,255,255,0.25)",
    ok = "rgba(255,255,255,0.85)",
    ol = "rgba(255,255,255,0.75)",
    om = "rgb(255,120,100)",
    on = "rgba(255,255,0,0.5)",
    cI = "middle",
    oo = "bottom",
    cJ = "center",
    mj = "left",
    ...
    bu = "px Arial",
    os = [bt, oq + bt, bt],
    ot = "https://play.google.com/store/apps/details?id=territorial.io",
    ou = "https://apps.apple.com/app/id1581110913",
    ov = "https://www.youtube.com/watch?v=toZTQ8aRdFc",
    ow = "https://discord.gg/pthqvpTXmh",
    ox = "https://www.instagram.com/davidtschacher/",
    nb = "https://territorial.io/cookie_policy",
    oy = "https://territorial.io/privacy_policy",
    oz = "https://territorial.io/tutorial",
    p0 = ["https://territorial.io/players", "https://territorial.io/clans"],
    m7, p1, cA, p2, p3, p4, p5, cC, p6 = ["wss://",
        "/s50/", "/s51/", "/s52/"
    ];
...
function pA() {
    pB.addEventListener("mousedown", pC);
    pB.addEventListener("mousemove", pD);
    pB.addEventListener("mouseup", pE);
    pB.addEventListener("click", pF);
...
function pC(g) {
    g.preventDefault();
    p3 || (eD.pQ(eD.jf), pR(Math.floor(pS * g.clientX), Math.floor(pS * g.clientY)))
}
...
function pI(g) {
    ...
    eD.pQ(eD.jf);
    p3 = !0;
    0 < g.touches.length && (p4 = Math.floor(pS * g.touches[0].clientX), p5 = Math.floor(pS * g.touches[0].clientY), jr.pT(g) || pR(p4, p5))
}
...
function pR(g, k) {
    if (0 === ec) aJ.c7(g, k);
        ...
        var t = fq.c7(g, k);
        2 === t || eM.c7(g, k) || (gm.c7(g, k) ? c4.c5 = !0 : eR.pV(g, k) ? (gm.gn = !1, eR.pW(g, k) && (c4.c5 = !0)) : e9.c7(g, k) || eS.c7(g, k) || 0 === t && hx.lF(g, k))
    }
}
...
function pJ(g) {
    g.preventDefault();
    0 < g.touches.length && (p4 = Math.floor(pS * g.touches[0].clientX), p5 = Math.floor(pS * g.touches[0].clientY), jr.pY(g) || pX(p4, p5))
}

function pX(g, k) {
    0 === ec ? aJ.lo(g, k) : hy.lo(g, k) || (hx.lE() ? hx.lo(g, k) : fq.lo(g, k) || (eR.pZ ? eR.lo(g, k) && (c4.c5 = !0) : (eM.lo(g, k), gm.gn && gm.lo(g, k) && (c4.c5 = !0))))
}

function pG(g) {
    g.preventDefault();
    0 === ec ? (aJ.click(-1024, -1024), jj.pa()) : (eM.pb(-1024, -1024), fq.lo(-1024, -1024), eR.pc(), gm.gn && (gm.gn = !1))
}
...
function pK(g) {
    g.preventDefault();
    g && g.touches && 0 < g.touches.length && 0 !== ec ? gm.gn = !1 : pd(p4, p5)
}
...
function pd(g, k) {
    0 === ec ? aJ.click(g, k) : (eM.pb(g, k), hy.pb(), eR.pc(), gm.gn = !1, hx.click(g, k) && (c4.c5 = !0))
}
...
function pH(g) {
    ...
    var k = Math.floor(pS * g.clientX),
        ...
        l = g.deltaY;
    1 === g.deltaMode && (l *= 20);
    0 === ec ? aJ.ph(k, t, l) : eM.ph(k, t, l) || (eR.pV(k, t) ? eR.ph(l) && (c4.c5 = !0) : gm.ph(k, t, 2 * l) && (c4.c5 = !0))
}
...
function k3() {
    ...
    function t(C) {
        ...
        pp.font = x;
        var E = z;
        C.cM < b8 && 0 === C.id && (E += Math.floor(pp.measureText(gM[C.cM] +
            "000").width));
        E += A;
        0 === C.id && (E += A);
        C.ls.width = E;
    ...
    this.eb = function() {
        for (var C = n.length - 1; 0 <= C; C--) n[C].ps && (n[C].ps = !1, g(C))
    };
    this.gL = function(C) {
    ...
    this.c7 = function(C, E) {
        ...
        for (G = n.length -
            ...
            var K = n[G].ls.width;
            if (E >= D - M && E <= D + A + M) {
                if (C >= H - F && C <= H + A + F) return n[G].py || (n[G].ps = !0, n[G].py = !0, 0 === n[G].id ? dx ? eG.fO(aw, n[G].cM) : iu.qC(n[G].cM === b8 ? aw : n[G].cM) : dx ? eG.fQ(aw, n[G].id) : iu.qD(n[G].id)), !0;
    ...
    this.dF = function() {
        if (2 !== ec && 0 !== fG[aw] && !jB && hx.lG(aw)) {
            ...
            for (--C; 0 <= C; C--) E = ae.am(aw, C), n[C].cN !== E && (n[C].cN = E, n[C].px = E > n[C].px ? E : n[C].px, n[C].ps = !0)
        }
    };
    this.cG = function() {
        if (0 !== fG[aw] && hx.lG(aw) && !jB)
            for (var C = n.length - 1; 0 <= C; C--) cH.drawImage(n[C].ls, l(C), y(C))
    }
}
...
function k4() {
    ...
    function k() {
        ...
        D.font = A[0];
        D.fillText(E[l[0].qU], Math.floor(l[0].width / 2), Math.floor(.72 * C[0] * x));
        D.font = A[1];
        D.fillText(l[0].l,
    ...
    this.dF = function() {
        if (0 !== y)
            if (4 === y) c4.gf > J && (y = 0, 1 === ec && c2.mz(jp.nF(), 3, 1, 9));
            else {
...
function ki() {
    function g() {
        ...
        1 === x ? (n.fillStyle = oR, n.fillRect(K, 0, K, l)) : -1 === x && (n.fillStyle = oZ, n.fillRect(0, 0, K, l));
        i2(n, D, l, 2);
        K = Math.floor(.25 * l);
        K = 2 > K ? 2 : K;
        n.fillStyle = ol;
    ...
    this.c7 = function(D, K) {
        ...
        J = D > r - m7 - this.c1 /
            2;
        dx ? this.fY(0, J) : hx.lG(aw) && 0 !== fG[aw] && iu.qm(J);
        return !0
    };
    this.dF = function() {
        if (0 < H) H--, 0 === H && k();
            ...
            if (D) {
                ...
                B[0] = me(as(3 * K, 5), 1);
                dA && 9 !== dv && (B[0] =
                    qr(me(as(K * (100 - as(100 * eT.qs(), jC)), 100), 1), B[0]));
                B[1] = me(K - B[0], 1);
                M++
            }
        }
...
function k5() {
    ...
    this.lx = function() {
        q && r < .8 * s ? (this.cw = Math.floor(.0536 * bq), y = r - 4 * m7 - this.cw) : (y = Math.floor((q ? .65 : .389) * bq), y += 12 - y % 12, this.cw = Math.floor(y / 12));
...
function k6() {
    ...
    this.lx = function() {
        ...
        this.qy();
        x = Math.floor(1 + t / 20);
        for (var A = 1; 0 <= A; A--) k[A].clearRect(0, 0, t, t), k[A].fillStyle = oJ, k[A].beginPath(), k[A].arc(t / 2, t / 2, t / 2 - x, 0, 2 * Math.PI), k[A].fill(), k[A].lineWidth = x, k[A].fillStyle = oN, k[A].strokeStyle =
            oN, k[A].beginPath(), k[A].arc(t / 2, t / 2, t / 2 - x, 0, 2 * Math.PI), k[A].stroke(), i4(k[A], 0, 0, t, x, .3, 0 === A)
    };
    this.gF = function() {
        return -gC / g7
    };
    ...
    this.c7 = function(x, A) {
        if ((Math.pow(x - (l + t / 2), 2) + Math.pow(A - (y + t / 2), 2) < t * t / 4 || Math.pow(x - (l + t / 2), 2) + Math.pow(A - (y + 2 * t), 2) < t * t / 4) && !gI.gJ.rM) return A < y + 1.25 * t ? this.ph(Math.floor(gE / 2), Math.floor(cB / 2), -200) : this.ph(Math.floor(gE / 2), Math.floor(cB / 2), 200);
        eV.h3() && (this.gn = !0,
            n = x, z = A);
        return !1
    };
    ...
    this.cG = function() {
        gI.gJ.rM || (cH.drawImage(g[0], l, y), cH.drawImage(g[1], l, Math.floor(y + 3 * t / 2)))
    }
}
...
function k7() {
    ...
    this.lo = function(N, T) {
        T > cB - .6 * x ? this.rn ? N !== K && (z += N - K, K = N, k(), t(N), this.rn = -1 !== F, c4.c5 = !0) : t(N) && (c4.c5 = !0) : this.pa()
    };
    this.pa = function() {
        -1 !== F && (this.rn = !1, F = -1, c4.c5 = !0)
    };
    this.ph = function(N, T) {
        -1 !== F && (z += Math.floor(T), k(), t(N), c4.c5 = !0)
    };
    this.c7 = function(N, T) {
        this.lo(N, T); - 1 !== F && (K = N, this.rn = !0)
    };
    this.pb = function() {
        -1 !== F && (this.rn = !1)
    };
    this.cG = function() {
        ...
        J && 0 === E && (cH.fillStyle = oZ, l(0)); - 1 !== F && (cH.fillStyle = oi, l(F));
        if (-1 !== F) {
            cH.font = H;
            cH.textBaseline = oo;
            N = new Date;
            ...
            Y = -1;
            qa = n.length - F - 1;
            for (W = R.length - 1; 0 <= W; W--) qa >= R[W].b3 && qa <= R[W].pP && (-1 === Y || R[W].pP -
                R[W].b3 < R[Y].pP - R[Y].b3) && (Y = W); - 1 !== Y && (qa = Math.floor(cH.measureText(R[Y].mv).width), cH.fillStyle = i1, cH.fillRect(gE - qa - M, Z, qa + M, la), cH.fillStyle = cK, cH.fillText(R[Y].mv, Math.floor(gE - .5 * M), Z + la));
            cH.textAlign = cJ;
            cH.fillText(N, T, cB);
            cH.strokeStyle = nd;
            cH.lineWidth = 1;
...
function k8() {
    ...
    this.sI = function() {
        ...
        this.sK();
        this.sL();
        z.fillStyle = ax[aw] >= ay.dJ(aw) ? od : cK;
    ...
    this.dF = function() {
        0 !== fG[aw] && 2 !== fU[aw] && A !== ax[aw] && (y = me(ax[aw], y), B = ax[aw] > A && 10 <= ax[aw], A = ax[aw], x = !0)
    };
    this.cG = function() {
        0 === fG[aw] || fc || 2 === fU[aw] || cH.drawImage(n, this.fK, t)
    }
}
var sN, qY, sO, sP, sQ, en, sR;
...
function k9() {
    function g() {
        ...
        sR[aw] >= Y && t(sR[aw] - Y, oX);
        0 !== sR[aw] && 0 === Y && t(0, oW); - 1 !== Z && t(Z, m0);
        B.fillStyle = oN;
        B.fillRect(0, M, sN, 1);
        ...
        2 === V && (k(aw), B.textAlign = mj, l(x - 1, sR[aw], aw), B.textAlign = op, y(x - 1, aw));
        0 === Y && (S = .7 * H / bw.bz(4).height, B.setTransform(S, 0, 0, S, Math.floor(D + .58 * H + .5 * S * bw.bz(4).width), Math.floor(G + sQ + .4 * H)), B.imageSmoothingEnabled = !0, B.drawImage(bw.bz(4), -Math.floor(bw.bz(4).width / 2), -Math.floor(bw.bz(4).height / 2)), B.setTransform(1, 0, 0, 1, 0, 0))
    }
    ...
    function l(S, V, ba) {
        ...
        B.fillText(P[ba] === ba ? gM[ba] : L[P[ba] % b8], K, Math.floor(G + sQ + (S + .5) * H));
        0 !== fU[ba] && (B.font = sP)
    }

    function y(S, V) {
        B.fillText(bU[V], J, Math.floor(G + sQ + (S + .5) * H))
    }
    ...
    this.bp = function() {
        ...
        sR = new Uint16Array(E);
        for (S = E - 1; 0 <= S; S--) en[S] = S, sR[S] = S;
        this.lx(!0);
        L = [];
    ...
    this.st = function(S) {
        ...
        var ta = gM[S];
        for (V = gM[S].length - 2; 1 <= V && !(ta = ta.substring(0, V), I[S] = Math.floor(B.measureText(ta + "...]").width),
                I[S] <= ba); V--);
        ta += "...]";
        P[S] === S ? (P[S] = b8 + L.length, L.push(ta)) : L[P[S] % b8] = ta;
        return ta
    };
    this.lx = function(S) {
        q ? (sN = Math.floor(.335 * bq), qY = Math.floor(x * sN / 8)) : (sN = Math.floor(.27 * bq), qY = Math.floor(x * sN / 10));
        sN = Math.floor(.97 * sN);
    ...
    this.eb = function(S) {
        U && (S || 0 === c4.dU() % gI.su[gI.gJ.sv]) && (U = !1, g())
    };
    this.dF = function() {
        for (var S = E - 1; 0 <= S; S--)
            if (0 === fG[en[S]]) {
                var V = S,
                    ba = en[V];
                for (E--; V < E; V++) en[V] = en[V + 1], sR[en[V]] = V;
                en[E] = ba;
                sR[en[E]] = E
            } ba = E - 1;
        for (V = 0; V < ba; V++) bU[en[V]] < bU[en[V + 1]] && (S = en[V], en[V] = en[V + 1], en[V + 1] = S, sR[en[V]] =
            V, sR[en[V + 1]] = V + 1);
        a: {
            S = U;U = !0;
            for (V = ba = sR[aw] >= x - 1 ? x - 2 : x - 1; 0 <= V; V--)
                if (N[V] !== en[V] || T[V] !== bU[en[V]]) break a;
            if (ba !== x - 2 || N[x] === sR[aw] && T[x] === bU[aw]) U = S
        }
    ...
    this.lo = function(S, V) {
        ...
        if (W) {
            ...
            Y += la - ba;
            Y = tE(0, Y, b8 - x);
            Y !== ta && (la = ba, ba = tE(-1, ba, x), Z = ba = ba !== x && z(S, V) ? ba : -1,
                g(), c4.c5 = !0);
            return !0
        }
        ba = tE(-1, ba, x);
    ...
    this.pb = function(S, V) {
        ...
        W = !1;
        var ba = n(V);
        p3 && -1 !== Z && (Z = -1, g(), c4.c5 = !0);
        if (350 > c4.gf - qa && ca === ba && (ba = tE(-1, ba, x), ba = ba !== x && z(S, V) ? ba : -1, -1 !== ba)) {
            var ta = en[ba + Y];
            ba === x - 1 && sR[aw] >= Y + x - 1 && (ta = aw);
            0 !== fG[ta] && eV.gj(ta, 800, !1, 0)
        }
        return !0
    };
    this.ph = function(S, V, ba) {
        return W ? !1 : z(S, V) ? (S = n(V), S = tE(-1, S, x), S = S === x || p3 ? -1 : S, 0 < ba ? Y < b8 - x && (Y++, Z = S, g(), c4.c5 = !0) : 0 < Y && (Y--, Z = S, g(), c4.c5 = !0),
            !0) : !1
    };
    this.cG = function() {
...
function kA() {
    function g() {
        ...
        for (var N = 0, T = 0; T < D.length; T++)
            if (J[T]) {
                ...
                z.textAlign = op;
                5 === T && 0 !== fG[aw] &&
                    ax[aw] >= ay.dJ(aw) ? (z.fillStyle = om, z.fillText(k(T), eB.c1 - E, U), z.fillStyle = cK) : z.fillText(k(T), eB.c1 - E, U)
            } else N++
    }
    ...
    this.j5 = function() {
        A = m7 + (eO.qJ() && 0 !== fG[aw] && !fc ? eO.cw +
            m7 : 0)
    };
    this.eb = function(N) {
        0 < H && (N || 12 > tS && 100 <= H || 12 <= tS) && (H = 0, g())
    };
    this.lX = function() {
        return K[7]
    };
...
function kB() {
    ...
    this.show = function(C, E) {
        g || (k = C ? 1 : 2, g = !0, this.lx(), hx.lp(), eR.qn(), B = c4.gf, -1 === this.tl &&
            (this.tl = c4.dU()), x = E ? 1 : 0)
    };
    this.dF = function() {
    ...
    this.cG = function() {
        !g || 0 >= x || (cH.globalAlpha = x, cH.drawImage(A, Math.floor((gE - t) / 2), cB - l - 2 * m7), cH.globalAlpha = 1)
    }
}
...
function kf() {
    ...
    this.bp = function() {
        ...
        if (fc)
            if (y = 0, l = 63, k = !0, dA)
                for (n = 0; n <= jG; n++) t.push(this.ts(dW.tt[dW.iq[n]], l));
            else t.push(this.ts(dW.tt[0], l)), t.push(this.ts(dW.tt[4], l))
    };
    this.dF = function() {
        k && 349 === ++y && (t = [], k = !1)
    };
...
function da(g, k, t) {
    if (!(!dA || 0 === fG[g] || 0 === fG[k] || 0 > t || t > ax[g] || g === k || ch(g, k) || g < cq && k < cq && 7 > dv && 1071 > c4.dU())) {
        ...
        t -= t >= as(ax[g], 2) ? l : 0;
        var y = bU[k] * jA - ax[k];
        0 >= y || (t = t > y ? y : t, g === aw && (e9.nA(t, k), b0.b1[12] += l, b0.b1[16] += t), k === aw && (e9.nC(t, g), b0.b1[10] += t), ax[g] -= t + l, ax[k] += t)
    }
}

function u2() {
    this.j8 = this.hC = this.u3 = !1;
    this.u4 = [0, 0, 0, 0];
    this.u5 = function() {
    ...
    this.j9 = function() {
        this.j8 && this.u4[2] >= this.u4[0] && this.u4[3] >=
            this.u4[1] && jZ.putImageData(ja, 0, 0, this.u4[0], this.u4[1], this.u4[2] - this.u4[0] + 1, this.u4[3] - this.u4[1] + 1);
        this.j8 = !1
    };
    this.j2 = function() {
...
function u8() {
    ...
    this.bv = function() {
        c4.gf -
            12E4 >= t[this.u9] && (t[this.u9] = c4.gf, this.uO = [0, 0], eD.rp(0, 1 + this.u9) && iu.uP(0, this.u9))
    };
    this.lx = function() {
        var l;
            ...
            if (0 === l) {
                ...
                for (x = 0; x < this.mE[l][0].length; x++)
                    if (y === this.mE[l][0][x].name) {
                        ...
                        A = !0;
                        break
                    } for (x = 0; x < this.mE[l][0].length; x++) this.mE[l][0][x].value *= B;
                A || this.mE[l][0].push({
                    name: y,
                    value: .25
                })
    ...
    this.c7 = function(l, y) {
        ...
        l -= (gE - this.c1) / 2;
        y -= (cB - this.cw) / 2;
        if (0 > l || l > this.c1 || 0 > y || y > this.cw) return this.lE = !1, 0 === aJ.pe() && jn.cE(0, !0), c4.c5 = !0;
        if (y < .3 * this.cw) var n = 1;
        else y < .85 * this.cw ? (n = (0 === this.u9 ? 14.1 : 3) * (y - .3 * this.cw) / (.55 * this.cw), n = Math.floor(1 + n * n)) : n = 0 === this.u9 ? 200 : 10;
        this.uO[this.u9] = l < this.c1 / 2 ? -n : n;
        if (t[this.u9] + 50 > c4.gf) return !0;
        t[this.u9] = c4.gf;
    ...
    this.cG = function() {
        if (this.lE) {
            ...
            cH.textBaseline = cI;
            cH.textAlign = cJ;
            cH.fillText(g[this.u9], Math.floor(this.c1 / 2), Math.floor(.135 * this.cw));
            cH.font = bt + Math.floor(.025 * this.cw) + bu;
            cH.fillText(g[this.u9 + 2], Math.floor(this.c1 / 2), Math.floor(.2125 * this.cw));
            cH.beginPath();
    ...
    this.uf = function(l) {
        ...
        for (var y, n = this.mE[this.u9][1] - 1; 0 <= n; n--) cH.textAlign = op, y = Math.floor(this.uJ * this.cw + l + n * ((1 - 2 * this.uJ) * this.cw - l) / 9), cH.fillText(this.mE[this.u9][0][n].value.toFixed(this.mE[this.u9][3]), Math.floor(this.uI * this.c1), y), cH.fillText(n + 1 + this.mE[this.u9][6] + ".", Math.floor(this.uG * this.c1), y), cH.textAlign = mj, cH.fillText(this.mE[this.u9][0][n].name,
            Math.floor(this.uH * this.c1), y)
    }
}
...
function uh() {
    ...
    this.cG = function() {
        this.lE && (cH.imageSmoothingEnabled = !0, cH.setTransform(1, 0, 0, 1, g, k), cH.fillStyle = i1, cH.fillRect(0, 0, C, l), cH.lineWidth = p2, cH.strokeStyle = cK, cH.strokeRect(0, 0, C, l), cH.setTransform(t, 0, 0, t, g + (C - A) / 2, k + z), cH.drawImage(bw.bz(17), 0, 0), cH.setTransform(1, 0, 0, 1, 0, 0))
    }
}
...
function us() {
    ...
    this.c7 = function(x, A, B) {
        ...
        for (C = y.length - 1; 0 <= C; C--)
            if (y[C] && this.ut[C] && x > k[C] && A > t[C] && x < k[C] + l[C] * n[C].width && A < t[C] + l[C] * n[C].height) return na.bp(z[C], B), !0;
        return !1
    };
    this.cG = function() {
        if (n && this.lE()) {
            ...
            var x;
            for (x = 0; 5 > x; x++) y[x] &&
                this.ut[x] && (cH.setTransform(l[x], 0, 0, l[x], k[x], t[x]), cH.drawImage(n[x], 0, 0));
            cH.setTransform(1, 0, 0, 1, 0, 0)
        }
    }
}
...
function kC() {
    ...
    this.rx = function() {
        ...
        this.uy[4].fL = Math.floor((cB -
            this.uy[4].cw - this.uy[5].cw - this.f7) / 2);
    ...
    this.lo = function(y, n, z) {
        ...
        k !== x && (k = x, z && (c4.c5 = !0));
        return -1 !== x ? (jj.pa(), !0) : !1
    };
    this.pV = function(y, n, z, x) {
        for (var A = z; A < z + x; A++)
            if (y >= this.uy[A].fK && n >= this.uy[A].fL && y <= this.uy[A].fK + this.uy[A].c1 &&
                n <= this.uy[A].fL + this.uy[A].cw) return A;
        return -1
    }
}
...
function v8() {
    ...
    this.c7 = function(k, t) {
        ...
        k -= (gE - this.c1) / 2;
        t -= l;
        if (0 > k || 0 > t || k >= this.c1 - 1 || t >= this.cw - 1) return this.lE = !1, 0 === aJ.pe() && jn.cE(0, !0), c4.c5 = !0, !1;
        if (k < this.f7 || t < this.f7 || k >= this.c1 - this.f7 || t >= this.cw - this.f7) return !0;
        if (k < this.f7 + this.vA) return t < this.f7 + this.vA && 0 !== this.ny && (this.ny = 0, c4.c5 = !0), !0;
        if (k < 2 * this.f7 + this.vA) return !0;
        k -= 2 * this.f7 + this.vA;
        if (t < this.f7 + this.vC) return this.v9 = 1, this.colors[this.ny][0] = g(256 * k / this.vB), c4.c5 = !0;
        if (t < 2 * this.f7 + this.vC) return !0;
        if (t < 2 * this.f7 + 2 * this.vC) return this.v9 = 2, this.colors[this.ny][1] = g(256 * k / this.vB), c4.c5 = !0;
        t >= 3 * this.f7 + 2 * this.vC && (this.v9 = 3, this.colors[this.ny][2] = g(256 * k / this.vB), c4.c5 = !0);
        return !0
    };
    this.vF = function() {
    ...
    this.lo = function(k) {
        0 !== this.v9 && (k -= 2 * this.f7 + this.vA + (gE - this.c1) / 2, this.colors[this.ny][this.v9 - 1] = g(256 * k / this.vB), c4.c5 = !0)
    };
    this.vI = function() {
        0 < this.v9 && (this.v9 = 0, this.vF(), gI.vJ(), c4.c5 = !0)
    };
    this.cG = function() {
        cH.setTransform(1, 0, 0, 1, (gE - this.c1) / 2, (cB - this.cw) / 2);
        cH.fillStyle = i1;
...
function kD() {
    ...
    function k() {
        D++;
        H = c4.gf;
        eD.rp(g(), 4) && (J = !0, iu.vY(g()))
    }

    function t() {
        0 === D ? jm.vd(3249) : (D === eD.vX - 1 && (D = -1), k())
    }
    ...
    this.rr = function(L) {
        6 !== aJ.pe() || J || (H = c4.gf, J = !0, iu.vY(L))
    };
    this.c7 = function(L, P) {
        var I = Math.floor((gE - A) / 2),
            O = Math.floor(.5 * (cB - cA - z - B)) + z + cA;
        return L > I && L < I + A && P > O && P < O + B ? (this.ve(), jk.lo(L, P, !1), !0) : !1
    };
    this.ve = function() {
        eD.vf(3260);
        jh.bp();
    ...
    this.dF = function() {
        6 === aJ.pe() &&
            (J ? c4.gf > H + 2E4 && jm.vd(3250) : c4.gf > H + 2E4 && t(), y += .07 * n * (16 > y ? 5 + y : 84 < y ? 105 - y : 17), 100 < y ? (y = 100, n = -1) : 0 > y && (y = 0, n = 1), E = "rgba(0," + Math.floor(190 - 1.9 * y) + "," + Math.floor(120 - 1.2 * y) + "," + (.4 + .004 * y) + ")", G = "rgba(0," + Math.floor(1.9 * y) + "," + Math.floor(1.2 * y) + "," + (.8 - .004 * y) + ")", c4.c5 = !0)
    };
    this.cG = function() {
...
function kE() {
    ...
    this.ur = function(k) {
        ...
        if (!(400 > c4.gf)) {
            if ("Enter" === k.key || "Escape" === k.key) {
                if (this.vr()) return 0 === g && jn.cE(0, !0), !0;
                if ("Enter" === k.key) {
                    if (0 === g) return jh.vs(), !0;
                    if (7 === g) return !0
                }
            }
            return !1
    ...
    this.vr = function() {
        return na.lH() || cC.ur() ? !0 : cD.lE ? (cD.lE = !1, !0) : !1
    };
    this.aK =
        function() {
            c4.c5 = !0;
            8 === g ? gl ? gl = !gl : hy.lE ? hy.m2() : fq.m2() : 7 === g ? ju.vt() : 6 === g ? jl.ve() : 3 === g ? jm.vu(0, 0) : 2 === g ? dy.vu() : 0 === g && (this.vr() || a9(11))
        };
    this.c7 = function(k, t) {
        if (!vn.c7(k, t) && vq && !(na.c7(k, t) || 6 === g && jl.c7(k, t) || 2 === g && dy.c7(k, t) || gI.c7(k, t) || cD.c7(k, t) || vv.c7(k, t, !0) || cC.c7(k, t, !0))) {
            jj.c7(k, t);
            if (0 === g) jh.c7(k, t);
    ...
    this.lo = function(k, t) {
        ...
        if (!jj.rn) {
            ...
            if (jk.lo(k, t, !0)) return
        }
        jj.lo(k, t)
    };
    this.click = function(k, t) {
        jj.pb();
        cC.vI() || vv.c7(k, t, !1) || cC.c7(k, t, !1)
    };
...
function w1() {
    ...
    this.c7 = function(g, k, t) {
        ...
        g -= (gE - this.c1) / 2;
        k -= l;
        if (0 > g || 0 > k || g >= this.c1 - 1 || k >= this.cw - 1) return 0 === t && (this.lE = !1, 0 === aJ.pe() && jn.cE(0, !0), c4.c5 = !0), !1;
        l = Math.floor(this.c1 / this.nn);
        g = as(g, l) + this.nn * as(k, l);
        g = 0 > g ? 0 : g >= a5.nr ? a5.nr - 1 : g;
        if (0 ===
            t || 1 === t && !a5.a7[g] || 2 === t && a5.a7[g]) this.w2 = !a5.a7[g], this.w3 = this.v9 = !0, a5.a7[g] = !a5.a7[g], a5.o9(), c4.c5 = !0;
        return !0
    };
    this.lo = function(g, k) {
        this.v9 && this.c7(g, k, this.w2 ? 1 : 2)
    };
    this.vI = function() {
    ...
    this.cG = function() {
        ...
        for (var t = Math.floor(this.c1 /
                this.nn), l = (t - 2 * this.bB * t) / a5.c1, y = a5.nr - 1; 0 <= y; y--) cH.setTransform(1, 0, 0, 1, Math.floor(g + y % this.nn * t), Math.floor(k + as(y, this.nn) * t)), a5.a7[y] && (cH.fillStyle = oS, cH.fillRect(0, 0, t, t)), cH.setTransform(l, 0, 0, l, Math.floor(g + y % this.nn * t + this.bB * t), Math.floor(k + as(y, this.nn) * t + this.bB * t)), cH.drawImage(a5.l7[y], 0, 0);
        cH.setTransform(1, 0, 0, 1, 0, 0);
        cH.imageSmoothingEnabled = !1
    }
}
...
function kF() {
    function g() {
        var n = aJ.pe();
        0 === n ? jh.tr() : 6 === n ? eD.vf(t) : 7 === n ? (ju.tr(), eD.close(eD.w6, 3240)) : 8 === n && (je(), jh.tr());
        aJ.setState(3);
        jk.rx();
        jk.uy[2].ne = k(t);
        c4.c5 = !0
...
function kj() {
    ...
    this.eZ = function() {
        0 < l && c4.gf > t && (l--, t += 4500, 0 === c4.wO && 0 === c4.wP && (0 === l && eD.jf < eD.wQ && (eD.jf += eD.wR), eD.rp(eD.jf, 5)))
    };
    this.wS = function() {
        10 === aJ.pe() &&
            (k++, 2 <= k && (js.wT(g), g = null))
    }
}
...
function kg() {
    ...
    function l(N, T) {
        for (var U = G.length - 1; 0 <= U; U--)
            if (null !== G[U].ls && G[U].xA === N && G[U].xB === T) return G[U].ls;
        return null
    }
    ...
    function y(N, T) {
        ...
        for (Z = 0; Z < x[1]; Z++) {
            var W = A;
            for (U = 0; U < x[0]; U++) {
                if (N > W && N < W + n && T > qa && T < qa + n) return iu.xN(G[Y].x8), M = G[Y].x8 !== M ? G[Y].x8 : -1, c4.c5 = !0;
                Y++;
    ...
    this.lx = function() {
        ...
        x = [0, 0];
        F = [0, 0, 0, 0];
        q ? (H = Math.floor(.8 * .4 * bq), D = Math.floor(.56 * H), F[0] = cA, r < s ? (F[1] = D + 2 * cA, F[2] = r - 3 * F[0], F[3] = uY.cF() - 3 * cA - D, P = Math.floor(.95 * D), I = Math.floor((r - H - cA) / 2), O = Math.floor(cA + D / 2)) : (F[1] = cA, F[2] = r - 3 * cA - H, F[3] = uY.cF() - 2 * cA, P = Math.floor(.8 * H), F[3] - D < H && (P = Math.floor(.8 * (F[3] - D)), P = me(D, P)), I = Math.floor(r - H / 2 - cA), O = Math.floor(cA + D + (F[3] - D) / 2), O = me(O, Math.floor(D + 2 * cA + P / 2)))) : (H = Math.floor(.2016 * bq), D = Math.floor(.56 *
        ...
        if (-1 !== M)
            for (Y = M, M = -1, U = G.length - 1; 0 <= U; U--)
                if (G[U].x8 === Y) {
                    M = Y;
                    break
                } if (G.length > R || G.length < R) R = G.length, this.lx();
        this.xE();
        c4.c5 = !0
    };
    this.xE = function() {
        for (var N = G.length - 1; 0 <= N; N--) null === G[N].ls && setTimeout(t, 0)
    };
    this.c7 = function(N, T) {
        return 4 * ((N - I) * (N - I) + (T - O) * (T - O)) <= P * P ? (this.vt(), jk.lo(N,
            T, !1), !0) : y(N, T)
    };
    this.cG = function() {
        var N = 0,
        ...
        0 <= M ? (cH.fillStyle = oS, cH.fillRect(r - H -
            cA, cA, H, Math.floor(.25 * D))) : (cH.fillStyle = on, cH.fillRect(r - H - cA, cA + Math.floor(.25 * D), H, Math.floor(.25 * D)));
        cH.strokeStyle = cK;
        ...
        if (0 !== G.length)
            for (Z = 0; Z < x[1]; Z++) {
                ...
                for (U = 0; U < x[0]; U++) {
                    ...
                    var W = Math.floor(qa),
                        la = Math.floor(T);
                    if (null === G[Y].ls) cH.fillStyle = oK, cH.fillRect(W, la, z, z);
                    else {
                        var ca = z / 128;
                    ...
                    256 >= G[Y].xD && (cH.textAlign = cJ, cH.fillStyle = oQ, cH.fillText(G[Y].xD.toString(), Math.floor(W + .5 * n), Math.floor(la + .9 * n)));
                    cH.textAlign = op;
                    cH.fillStyle = oc;
                    cH.fillText(G[Y].nj.toString(), Math.floor(W + .93 * n), Math.floor(la +
                        .9 * n));
                    cH.strokeStyle = oi;
...
function kH() {
    ...
    this.c7 = function(g, k) {
        var t = jk.pV(g, k, 5, 2);
        5 === t ? aC() : 6 === t && (jh.bp(), jk.lo(g, k, !1), c4.c5 = !0)
    }
}
...
function kI() {
    ...
    this.vu = function() {
        c4.c5 = !0;
        jv.lE ? jv.lE = !1 : (this.tr(), jh.bp())
    };
    this.jP = function() {
        var t;
        if (dr.ds) return dr.dt.xY;
        var l = 0;
        for (t = this.dz.length - 1; 0 <= t; t--) l += this.dz[t].mv;
        return l
    };
    this.lo = function(t, l) {
        return jv.lE && jv.lo(t,
            l) ? !0 : -1 === this.pV(t, l) ? !1 : !0
    };
    this.xZ = function() {
        eD.jf = 0;
        eD.rp(0, 3) && iu.xa(0);
    ...
    this.c7 = function(t, l) {
        if (cD.lE || cC.mE[1].ik.lE || cC.mE[2].ik.lE) return !1;
        if (jv.lE && !dr.ds) return jv.c7(t, l);
        var y = this.pV(t, l);
        if (-1 === y) return !1;
        if (0 === y) return this.vu(), !0;
        if (1 === y) return dr.ds ? (dr.pa(), c4.c5 = !0) : jv.show(), !0;
        if (2 === y) return this.tr(),
            this.xZ(), !0;
        if (dr.ds) return !1;
        ...
        if (0 === y % 3) return 1 < this.dz.length && (this.dz.splice(n, 1), this.lx(), c4.c5 = !0), !0;
        var z = (k[2] - k[2] / 10 - 2 * cA) / 2;
        if (1 === y % 3) {
            if (0 === n && 1 === this.dz[n].mv) return !0;
        ...
        x = 0 === x ? 1 : x;
        z = b8;
        for (y = this.dz.length - 1; 0 <= y; y--) n !== y && (z -= this.dz[y].mv);
        if (0 > x) {
            if (1 === this.dz[n].mv) return this.dz[n].mv = z, !0
        } else if (this.dz[n].mv === z) return this.dz[n].mv = 1, !0;
        this.dz[n].mv += x;
        1 > this.dz[n].mv ? this.dz[n].mv = 1 : this.dz[n].mv > z && (this.dz[n].mv = z);
        return !0
    };
    this.xX = function() {
        for (var t = Math.floor(b8 / this.dz.length), l = b8 % this.dz.length, y = this.dz.length - 1; 0 <= y; y--) this.dz[y].mv = t;
        this.dz[0].mv += l
    };
...
function p9() {
    ...
    this.rx = function() {
        ...
        for (var g = 1; g < this.b3; g++) this.mE[g].fK = this.mE[g - 1].fK + Math.floor(q ? 1.5 * cA : 3.7 * cA) + this.c1, this.mE[g].fL = this.mE[0].fL
    };
    this.pV =
        function(g, k) {
            if (!bw.bx()) return -1;
            for (var t = this.b3 - 1; 0 <= t; t--)
                if (g >= this.mE[t].fK && k >= this.mE[t].fL && g < this.mE[t].fK + this.c1 && k < this.mE[t].fL + this.c1) return t;
            return -1
        };
    this.xk = function() {
        for (var g = 2; 1 <= g; g--)
            if (this.mE[g].ik.lE) return !0;
        return !1
    };
    this.ur = function() {
        return this.mE[1].ik.lE ? (this.mE[1].ik.c7(-5E3, -5E3, 0), !0) : this.mE[2].ik.lE ? (this.mE[2].ik.c7(-5E3, -5E3), !0) : !1
    };
    this.c7 = function(g, k, t) {
        if (t) {
            if (this.mE[1].ik.lE) return this.mE[1].ik.c7(g, k, 0), !0;
            if (this.mE[2].ik.lE) return this.mE[2].ik.c7(g,
                k), !0
        }
        g = this.pV(g, k);
        if (t) {
            if (0 === g) return this.mE[g].m3 = !this.mE[g].m3, q = this.mE[g].m3, jt.xl(), a1(this.mE[0].m3, !1), !0;
            if (1 <= g && 3 > g) return this.mE[g].ik.bp(), jh.tr(), c4.c5 = !0
        }
        return !1
    };
    this.lo = function(g, k) {
        return this.mE[1].ik.lE ? (this.mE[1].ik.lo(g, k), !0) : this.mE[2].ik.lE ? (this.mE[2].ik.lo(g), !0) : !1
    };
    this.vI = function() {
        for (var g = 2; 1 <= g; g--)
            if (this.mE[g].ik.lE) return this.mE[g].ik.vI(), !0;
        return !1
    };
    this.cG = function() {
        if (bw.bx()) {
            ...
            for (var g = this.b3 - 1; 0 <= g; g--) cH.fillStyle =
                this.mE[g].m3 ? mb : i1, cH.fillRect(this.mE[g].fK, this.mE[g].fL, this.c1, this.c1), 0 === g ? this.xm(g, bw.bz(15)) : 1 === g ? this.xn() : 2 === g && this.xo(), cH.setTransform(1, 0, 0, 1, 0, 0), cH.lineWidth = p2, cH.strokeStyle = cK, cH.strokeRect(this.mE[g].fK, this.mE[g].fL, this.c1, this.c1);
            cH.imageSmoothingEnabled = !1
        }
    };
...
function kJ() {
    ...
    function t() {
        ...
        var n = y.split(" ");
        if (2 !== n.length) return k(), jm.vd(3266), !0;
        var z = Math.floor(Math.pow(2, 48));
        n = parseInt(m.n(n[1]));
        if (0 >= n || n >= z) return k(), jm.vd(3266), !0;
        if (o(n)) return k(), jm.vd(3231), !0;
        k();
        5 <= d ? jm.vd(3232) : (jm.vd(3265), vn.lE = !0,
            vn.bs = -1);
        return !0
    }

    function l() {
        if (void 0 !== y && m.iQ(y)) return jn.wE(0, !0), !0;
        jn.wE(0, !1);
        return !1
    }
    var y;
    ...
    this.c7 = function(n, z) {
        c4.xt();
        1 === jk.pV(n, z, 1, 1) ? t() || g() || (a9(10), l() ? (this.tr(), w(y), dy.bp()) : jm.vd(4214)) : 0 === jk.pV(n, z, 0, 1) && this.vs()
    };
    this.vs = function() {
        t() || g() || (a9(10), void 0 !== y && m.iQ(y) && 40 === y.charCodeAt(0) && 41 === y.charCodeAt(2) ? jl.vV((Math.abs(y.charCodeAt(1)) + 5) % eD.vX) : jl.vV(gI.xy - 1), l() ? bw.bx() ? (this.tr(), w(y), dr.pa(), jl.bp()) : jm.vd(3228) : jm.vd(4214))
    };
    this.y2 = function() {
...
function kK() {
    function g(n, z, x, A) {
        ...
        t[n].onload = function() {
            ...
            k--;
            bw.bx() && (uY.bv(), hx.l3(), a5.bp(), vv.uu([t[8], t[16], t[7], t[9], t[10]], [!b, 0 === d, !0, !0, !0]), c4.c5 = !0, t[7] = y, t[8] = y, t[9] = y, t[10] = y)
        };
        t[n].src = A
    }
    var k, t, l, y;
...
function kL() {
    ...
    this.bp = function(D) {
        ...
        if (dA)
            ...
            for (D = dr.dt.ya, K = hP - 1; 0 <= K; K--) n[K] = 4 * D[K][0], z[K] = 4 * D[K][1], x[K] = 4 * D[K][2];
        else {
            for (K =
                b8 - 1; K >= cq; K--) n[K] = 4 * as(64 * ce.random(), ce.value(100)), z[K] = 4 * as(64 * ce.random(), ce.value(100)), x[K] = 4 * as(64 * ce.random(), ce.value(100));
            for (K = cq - 1; 0 <= K; K--) n[K] = 4 * D[K].xd[0], z[K] = 4 * D[K].xd[1], x[K] = 4 * D[K].xd[2]
        }
        for (D = b8 - 1; 0 <= D; D--) K = as(n[D] + z[D] + x[D], 3), n[D] += yj(K - n[D], 2), z[D] += yj(K - z[D], 2), x[D] += yj(K - x[D], 2), n[D] -= n[D] % 4, z[D] -= z[D] % 4, x[D] -= x[D] % 4;
    ...
    this.yg = function() {
        for (var D = b8 - 1; 0 <= D; D--) this.r1[D] = 280 > n[D] + z[D] + x[D] ? 0 : 1
    };
    this.gF = function(D) {
        return as(D, 4) % aZ
    };
    ...
    this.hi = function(D, K) {
        return this.yl(D + H[0],
            K) || this.yl(D + H[1], K) || this.yl(D + H[2], K) || this.yl(D + H[3], K)
    };
    this.bE = function(D) {
        return 208 <= u7[D + 3]
    };
    ...
    this.yn = function(D) {
        return 208 <= u7[D + 3] && 224 > u7[D + 3]
    };
    this.cU = function(D) {
        return 224 <= u7[D + 3] && 248 > u7[D + 3]
    };
    this.hj = function(D) {
        for (var K = 3; 0 <= K; K--)
            if (this.yo(D + H[K])) return !0;
        return !1
    };
    this.yp = function(D) {
        return 192 <= u7[D + 3] && 208 > u7[D + 3]
    };
    ...
    this.yo = function(D) {
        return 0 === u7[D + 3] && 2 === u7[D + 2] || this.yp(D)
    };
    this.bG = function(D) {
        return 0 === u7[D + 3] && 1 === u7[D + 2]
    };
    this.yk = function(D) {
        return 0 === u7[D + 3] && 3 === u7[D + 2]
    };
    this.yl = function(D, K) {
        return this.bG(D) || this.bE(D) && K !== this.bF(D)
    };
    this.bF = function(D) {
        return u7[D] % 4 * 128 + u7[D + 1] % 4 * 32 + u7[D + 2] % 4 * 8 + u7[D + 3] % 8
    };
    this.hq = function(D) {
        g(D, 1)
    };
...
function kl() {
    ...
    this.dF = function() {
        if (0 !== k)
            if (0 === fG[aw] || ae.zD(aw) === ae.af(aw)) k = 0;
            else {
                var l;
                for (l = k - 2; 0 <= l; l -= 2) {
                    var y = t[l];
                    if (y < b8 && 0 === fG[y]) g(l);
                        ...
                        var n = t[l + 1];
                        if (y >= b8 && lh(aw) || y < b8 && lm(aw, y)) dx ? fM(aw, y, n) : iu.lW(n, y === b8 ? aw : y), g(l)
                    }
                }
            }
    };
...
function zG(g) {
    hx.lG(g) && iz++;
    var k = ae.zL(g);
    0 === k.length ? g === aw && zM() : (zN(g, k), zO(g, k))
}

function zM() {
    b0.b1[17] += ax[aw] + ae.zP(aw);
    eW.show(!1, !1);
    eB.tR()
}
...
function zN(g, k) {
    var t;
    for (t = k.length - 1; 0 <= t; t--) ae.zQ(k[t], g)
}
...
function zO(g, k) {
    ...
    if (g === aw) e9.fl(l, 1), zM();
    else {
        for (t = k.length - 1; 0 <= t; t--)
            if (k[t] === aw) {
                e9.fl(g, 0);
                return
            } g < cq && 2 !== fU[g] && e9.ml(0, g, l)
    }
}
...
function kr() {
    ...
    function t(y) {
        ...
        y = n.width;
        var z = n.height;
        4096 < y || 4096 < z || 10 > y || 10 > z ? alert("Image w & h must be between 10 and 4096.") : (x6 = zg, x7 = 0, aZ = y, aa = z, hv.width = aZ, hv.height = aa, pp.drawImage(n, 0, 0), xI = pp.getImageData(0, 0, aZ, aa).data)
    }
    var l;
    this.bp = function() {
    ...
    this.zY = function(y) {
        ...
        if ("json" === z) dr.zc(y);
        else if ("gif" === z || "jpg" === z || "jpeg" === z || "png" === z) dr.zd = n[0], z = new FileReader, z.onload = k, z.readAsDataURL(y)
    };
    this.pf = function(y) {
        if (0 === aJ.pe() || 2 === aJ.pe()) y.stopPropagation(), y.preventDefault(), y.dataTransfer.dropEffect = "copy"
    };
    this.pg = function(y) {
        if (0 === aJ.pe() || 2 === aJ.pe()) y.stopPropagation(), y.preventDefault(), (y = y.dataTransfer.files) && 0 < y.length && jx.zY(y[0])
    }
}
...
function kp() {
    this.zj = null;
    this.bp = function() {
        this.zj = 10 !== dv ? null : new Uint32Array(b8)
    };
    this.dF = function() {
        10 === dv && this.zk()
    };
    ...
    this.u0 = function(g, k) {
        if (k > this.zj[g]) return k = this.zj[g], this.zj[g] = 0, k;
        this.zj[g] -= k;
        return k
    }
}
...
function ks() {
    ...
    function k(z) {
        ...
        A.onload = function() {
            aZ = A.width;
            aa = A.height;
            4096 < aZ || 4096 < aa || 10 > aZ || 10 > aa ? (xJ(0, 0), alert("Image w & h must be between 10 and 4096.")) : (x6 = zg, x7 = 0, hv.width = aZ, hv.height = aa, pp.drawImage(A, 0, 0), x = pp.getImageData(0, 0, aZ, aa), xI = x.data)
        };
        A.src = z;
        dr.dt.a01 = "";
        return !0
    ...
    this.xb = function() {
        this.dt.ya &&
            this.dt.zl && (this.dt.ya[0] = cC.mE[2].ik.vG());
        jJ(this.dt.zm, 0, this.zn(), this.dt.jM, !1)
    };
    this.zn = function() {
        return [{
    ...
    this.zq = function(z) {
        ...
        this.dt.zo = y(z.selectableName, !1);
        this.dt.zl =
...
function kN() {
    ...
    this.cQ = function(x, A, B) {
        ...
        z[E + l[x]] = 0;
        l[x]++;
        x < cq && (B === aw ? e9.fl(x, 5) : x === aw && eA.mn(B))
    };
...
function kO() {
    ...
    this.dF = function() {
        if (0 >= --t) {
            ...
            for (z = dY - 1; 0 <= z; z--) {
                var A = as(ay.te(dZ[z]) * ax[dZ[z]], 1E4);
                ax[dZ[z]] += 1 > A ? 1 : A;
                ay.az(dZ[z])
            }
            b0.b1[9] += ax[aw] - x;
...
function kP() {
    ...
    function t(Q) {
        return !gI.gJ.gK || 1E6 > ax[Q] ? 1 : 1E7 > ax[Q] ? ta[0] : ta[Math.min(Math.floor(Math.log10(ax[Q])) - 6, 3)]
    }
    ...
    function l() {
        ...
        W.clearRect(0,
            0, gE, cB);
        for (var Q = gC / g7, X = gD / g7, fa = (gE + gC) / g7, ra = (cB + gD) / g7, ha, ia, ma, sa, pa, ua = 0 !== fG[aw] && hx.lG(aw), ya = dY - 1; 0 <= ya; ya--)
            if (ma = dZ[ya], sa = Math.floor(N * g7 * t(ma) * K[ma] * H[ma]), !(sa < R || sa >= L) && F[ma] + H[ma] > Q && F[ma] < fa && M[ma] + D[ma] > X && M[ma] < ra) {
                ...
                if (0 < ca[ma]) {
                    ...
                    if (0 === sR[wa])
                        if (a5.oH(la[wa])) {
                            ...
                            W.globalAlpha = z(za);
                            Ba = t(Ba) * J[Ba];
                            for (var Fa = Math.floor(Ea - .5 * za / Ba - .4 * za - Aa * a5.c1), Ca = 0; 2 > Ca; Ca++) W.setTransform(Aa, 0, 0, Aa, Fa, Da), W.drawImage(a5.l7[wa], 0, 0), Fa = Math.floor(Ea + .5 * za / Ba + .4 * za);
                            W.globalAlpha = 1;
                            W.setTransform(1, 0, 0, 1, 0, 0);
                            y(pa, va, xa, 0, 0)
                        } else a5.oG(la[wa]) ? (n(pa, va, xa, la[wa], 0), y(pa, va, xa, 0, 1)) : (n(pa, va, xa, la[wa], 1), y(pa,
                            va, xa, 1, 0));
                    else n(pa, va, xa, la[wa], 0)
                } else 0 === sR[ma] && y(ha, ia, sa, 0, 0);
                if (ua && (0 < ca[ma + b8] || 0 < ca[ma + 2 * b8] || 0 < ca[ma + 3 * b8] || 0 < ca[ma + 4 * b8])) {
                    va = ha;
                    xa = ia;
                    Ea = sa;
                    za = ma;
                    wa = -1;
                    for (pa = 4; 1 <= pa; pa--) 0 < ca[za + pa * b8] && wa++;
                    for (pa = 1; 5 > pa; pa++) 0 < ca[za + pa * b8] && (Aa = Ea, Da = pa, Ba = za, Fa = ca[za + pa * b8], Ca = .8 * Aa / a5.c1, W.setTransform(Ca, 0, 0, Ca, Math.floor(va - .5 * Ca * a5.c1 - .534 * wa * Aa), Math.floor(xa + 1.4 * Ca * a5.c1)), W.globalAlpha = z(Aa), W.drawImage(1 === Da ? a5.l7[la[Ba + b8]] : 2 === Da && 255 > Fa ? hx.l5[2] : hx.l4[Da + 3], 0, 0), W.globalAlpha = 1, W.setTransform(1,
                        0, 0, 1, 0, 0), wa -= 2)
                }
                pa = Math.floor(I * sa);
                pa < R || (W.font = bt + pa + bu, W.fillText(gI.gJ.gK ? gM[ma] : eP.gL(ax[ma]), ha, ia + Math.floor(.78 * sa)))
            }
    }
    ...
    var E, G, F, M, H, D, K, J, L, P, I, O, R, N, T, U, Z, Y, qa, W, la, ca, S, V, ba = 0,
    ...
    this.n4 = function(Q, X, fa) {
        0 === fG[Q] || 4 !== X && 2 === fU[Q] || (Q += X * b8, 0 === X ? la[Q] === fa && 0 < ca[Q] ? ca[Q] = 0 : (la[Q] = fa, ca[Q] = a5.oH(fa) ? 255 : 64) : 1 ===
            X ? (ca[Q] = 64, la[Q] = fa) : ca[Q] = fa)
    };
    this.cG = function() {
        Y && (1 !== Z ? (cH.imageSmoothingEnabled = !0, cH.setTransform(Z, 0, 0, Z, 0, 0), cH.drawImage(qa, -T / Z, -U / Z), cH.setTransform(1, 0, 0, 1, 0, 0)) : (cH.imageSmoothingEnabled = !1, cH.drawImage(qa, -T, -U)))
    };
    ...
    this.eb = function(Q) {
        return (Q ? 0 === ++ba % gI.su[gI.gJ.a13] : 0 === c4.dU() % gI.su[gI.gJ.a13]) ? (ba = 0, l(), !0) : !1
    };
    this.gG = function(Q) {
        return t(Q) * K[Q]
    };
        ...
        function() {
            ...
            for (fa = E + Q - 1; fa >= E; fa--) {
                ...
                if (0 < H[X] && A(X, F[X], M[X], H[X], D[X])) {
                    for (var ha, ia, ma, sa, pa = X, ua = !1, ya = 0; 8 > ya; ya++) {
                        ia = H[pa] + 2;
                        ha = D[pa] + 2;
                        if (ia > cz[pa] - d0[pa] + 1 || ha > d2[pa] - d3[pa] + 1) break;
                        sa = F[pa] - 1;
                        ma = M[pa] - 1;
                        if (A(pa, sa, ma, ia, ha)) F[pa] = sa, M[pa] =
                            ma, H[pa] = ia, D[pa] = ha, ua = !0;
                        else break
                    }
                    if (ha = !ua) {
                        ha = X;
                    ...
                    a: {
                        ia = X;ma = ra;sa = F[ia] + 1;pa = M[ia] + 1;
                        for (ua = H[ia] - 2;;) {
                            if (1 > ua) {
                                H[ia] = 0;
                                break
                    ...
                    if (ha) x(X);
                        ...
                        for (ha = ra, ma = cz[X] - d0[X] + 1, ia = Math.floor(.02 * ma), ia = 1 > ia ? 1 : ia, ra = -6 * ia; ma >= ra; ma -= ia)
                            if (pa = 0 < ma ? ma : 1, sa = 1 + Math.floor(O * ha * pa), ya = d0[X] + Math.floor(Math.random() * (cz[X] - d0[X] + 2 - pa)), ua = d3[X] + Math.floor(Math.random() * (d2[X] - d3[X] + 2 - sa)), A(X, ya, ua, pa, sa)) {
                                F[X] = ya;
                                M[X] = ua;
                                H[X] = pa;
                                D[X] = sa;
    ...
    this.mn = function(Q) {
        var X = Q + 2 * b8,
            fa = ca[X];
        return 0 < fa ? (e9.n9(50, Q), ca[X] = 0, 255 ===
            fa) : !1
    };
    this.lk = function(Q) {
...
function kQ() {
    ...
    this.jW = function() {
        if (dr.ds && dr.dt.zp) {
            var t;
            for (t = cq; t < b8; t++) gM[t] = dr.dt.zp[t % hP]
        } else if (9 === dv) {
            var l = ce.random(),
                y = k.length,
                n = cq + e2.e3;
...
var gM, nR, fG, d0, d3, cz, d2, bU, hd, ax, b4, bM, bN, bQ, fU;
...
function jR(g) {
    ...
    for (k = g.length - 1; 0 <= k; k--) gM[k] = g[k].name, fU[k] = g[k].xe
}
...
function ko() {
    ...
    this.dF = function() {
        dx || (30 === this.nf && 2140 <= c4.dU() && this.a1m(), this.nf = (this.nf + 1) % 60)
    };
    this.a1m = function() {
        var g, k = this.iB;
...
function kk() {
    ...
    this.bp = function() {
        ...
        var y = ce.a1a(0);
        ce.jQ(0);
        for (l = 1; l < this.wQ; l++) this.a1p[l] = m.ic() + ".territorial.io";
        ce.jQ(y);
        k = Array(this.vX);
        t = Array(this.vX);
        for (l = this.vX - 1; 0 <= l; l--) t[l] = {
            a1t: !1,
            gf: 0,
            a1u: !1
        }
    ...
    this.dF = function() {
        for (var l =
                this.vX - 1; 0 <= l; l--) this.vT(l) && c4.gf > t[l].gf + 15E3 && iu.a1v(l, t[l].a1u)
    };
    this.rp = function(l, y) {
        if (!t[l].a1t) return this.a1x(l, y), !1;
        if (k[l].a1y()) return k[l].a1z(y), k[l].vT();
        k[l].lH();
        this.a1x(l, y);
        return !1
    };
    ...
    this.vf = function(l) {
        for (var y = this.vX - 1; 0 <= y; y--) this.close(y, l)
    };
    this.a27 = function(l, y) {
        for (var n = this.vX - 1; 0 <= n; n--) n !== l && this.close(n, y)
    };
...
function fn() {
    for (var g = dY - 1; 0 <= g; g--) 0 === fG[dZ[g]] && a2A(g)
}
...
var pB, cH, a2B, a2C, r, s, pO, bq, gE, cB, pS, a2D, b, c, e, d, q, a2E = !1,
    a2F, a2G, i, h1, tS, hB, a5, b0, hy, vn, c4, dW, eT, cD, fi, vv, na, uY, a2H, a2I, a2J = 0,
    a2K = "",
    a2L = !1;
...
function a2S(g) {
    a2E || (a2E = !0, g.message ? (a2J = g.lineno, a2K = g.message, eD.rp(0, 6) && iu.a24(0), g = "[A_ERROR " + a2J + "][" + a2K + "]", a2a(g)) : (g = "[B_ERROR " + g.type + "][" + (g.srcElement || g.target) + "]", console.log(g)))
}
...
function a2P(g) {
    400 > c4.gf || (8 !== aJ.pe() && aJ.ur(g) ? c4.c5 = !0 : "Escape" === g.key ? aJ.aK() : "ArrowLeft" === g.key ? gq.a2d(3) : "ArrowUp" === g.key ? gq.a2d(0) : "ArrowRight" === g.key ? gq.a2d(1) : "ArrowDown" === g.key ? gq.a2d(2) : "h" === g.key && 1 <= ec && (gl = !gl, c4.c5 = !0))
}
...
var aZ, aa, hv, pp, xH, xI, x6, x7, vq, zg = 16,
    xK;
...
function a2T() {
    ...
    this.bp = function() {
        7 === aJ.pe() || this.a35 || (this.a34 = !0, this.aA = 0, this.a2x = 1, this.a32 = [jp.bz(x6).a36[0], jp.bz(x6).a37[0]], this.r1 = [jp.bz(x6).a38[3], jp.bz(x6).a38[4], jp.bz(x6).a38[5], jp.bz(x6).a38[6]], this.a2y = jp.bz(x6).a38[7], this.a2z = jp.bz(x6).a38[8], this.a30 = jp.bz(x6).a38[9], this.a31 = jp.bz(x6).a38[10], this.a34 ? this.rk = setTimeout(g, 16) : this.dF())
    };
    this.dF = function() {
        if (8 === aJ.pe() && eV.gg()) this.rk = setTimeout(g, 16);
        else {
            if (0 === this.aA) {
                var l = ce.a1a();
            ...
            l = this.a34 ? 10 : 1E6;
            l =
                aa - this.a2x - 1 < l ? aa - this.a2x - 1 : l;
            l = this.a2x + l;
            for (var y, n, z = this.a2x; z < l; z++)
                for (var x = 1; x < aZ - 1; x++)
                    if (n = x + z * aZ, y = 4 * n, t(y)) this.a3C(y, n, 1);
                    else {
                        this.a3C(y, n, 0);
                        n = x;
                        var A = z;
            ...
            this.a2x >= aa - 1 ? (pp.putImageData(xH, 0, 0, 1, 1, aZ - 2, aa - 2), c4.c5 = !0, this.xL()) : this.a34 && (this.rk = setTimeout(g, 16))
        }
    };
    ...
    this.a3D = function(l, y) {
        ...
        for (var B = 1 > z ? 1 : z; B <= A; B++)
            for (var C = n; C <= x; C++)
                ...
                } else E = this.a30 + (this.a31 - this.a30) * this.a33[C + aZ * B] / 1E4, Math.abs(l - C) > E || Math.abs(y - B) > E || (G = Math.sqrt((l - C) *
                    (l - C) + (y - B) * (y - B)), G >= E || this.a3H(z, G, E, 0, this.r1[2]))
    }
}
...
function kS() {
    ...
    this.a2q = function() {
        ...
        jp.a3b() && bw.bx() && jp.a3b() && (t = bw.lB("arena"), pp.save(), pp.globalAlpha = 1 === x6 ? .1 : 1, pp.imageSmoothingEnabled = !0, k = 2.8, pp.scale(k, k), pp.drawImage(t, Math.floor((aZ / k - t.width) / 2), Math.floor(.5 * aa / k - t.height / 2)), pp.restore(), t = bw.lB("territorial.io"), pp.save(), pp.globalAlpha = 1 === x6 ? .1 : 1, pp.imageSmoothingEnabled = !0, k = .87, pp.scale(k, k), pp.drawImage(t, Math.floor(.745 *
            (aZ / k - t.width)), Math.floor(.422 * aa / k - t.height / 2)), pp.restore());
        vq = !0;
        c4.c5 = !0
    };
    this.jU = function() {
...
function a2o(g) {
    ...
    x6 === a2u() ? k = "" : x6 ===
        a2u() + 1 ? k = "" :
    ...
    for (var y = k.length, n = !0, z = 0, x = 4; x < y; x++)
        if (n) {
            for (; 0 < k[x]--;) xI[z] = l[0], xI[z + 1] = l[1], xI[z + 2] = l[2], xI[z + 3] = 255, z += 4;
            n = !1
        } else {
            for (; 0 < k[x]--;) xI[z] = t[0], xI[z + 1] = t[1], xI[z + 2] = t[2], xI[z + 3] = 255, z += 4;
            n = !0
...
function km() {
    function g(x, A, B, C) {
        if (0 === C) return x >= B.f8 && (0 === C || A >= B.f9) && A <= B.f9 + B.nV;
        A -= C * (B.nV - 2);
    ...
    this.a4V = function() {
        var x = v().split("");
        14 > x.length ? this.a4U() : (this.gJ.nQ = parseInt(x[6]), this.gJ.a4X = parseInt(x[7]), this.gJ.rM = parseInt(x[8]), this.gJ.gK = parseInt(x[9]), this.gJ.a4Y = parseInt(x[10]), this.gJ.a0s = parseInt(x[11]), this.gJ.sv = parseInt(x[12]), this.gJ.a13 = parseInt(x[13]))
    };
    this.vJ = function() {
        var x = cC.mE[2].ik.vH();
        x += ~~this.gJ.nQ;
    ...
    this.a4Z = function(x) {
        5 === x ? n[1][x].name = "Resolution: " + eB.nI(100 * jt.a4a(), 1) : 6 === x ? n[1][x].name = "Country Minimum Font Size: " + (4 > this.gJ.a0s ? 1 + this.gJ.a0s : 2 * (this.gJ.a0s - 1)) : 7 === x ? n[1][x].name = "Leaderboard Refresh Rate: " + eB.nI(100 / this.su[this.gJ.sv], 1) : 8 === x && (n[1][x].name = "Country Title Refresh Rate: " + eB.nI(100 / this.su[this.gJ.a13],
            1))
    };
    this.c7 = function(x, A) {
        var B;
        if (!(7 <= aJ.pe())) {
            ...
            if (y) {
                for (B = 1; B < n[z].length; B++)
                    if (g(x, A, C, B)) return B = n[z][B], 0 === z ? 1 === B.id ? (gI.xy = 1 === gI.xy ? 2 : 2 === gI.xy ? eD.wQ : 1, B.name = "Lobby " + (gI.xy === eD.wQ ? "1B" : gI.xy), c4.c5 = !0) : 2 === B.id ? (z = 1, c4.c5 = !0) : 3 === B.id && (z = 2, c4.c5 = !0) : 1 === z ? 1 === B.id ? (gI.gJ.nQ = !gI.gJ.nQ, B.n6 = gI.gJ.nQ ? 130 : 0, gI.vJ(), c4.c5 = !0) : 2 === B.id ? (gI.gJ.a4X = !gI.gJ.a4X, gI.a4W(), gI.vJ(), c4.c5 = !0) : 3 === B.id ? (gI.gJ.rM = !gI.gJ.rM, B.n6 = gI.gJ.rM ? 130 : 0, gI.vJ(), c4.c5 = !0) : 4 === B.id ? (gI.gJ.gK = !gI.gJ.gK,
                        B.n6 = gI.gJ.gK ? 130 : 0, gI.vJ(), c4.c5 = !0) : 5 === B.id ? (gI.gJ.a4Y++, gI.gJ.a4Y %= 8, gI.a4Z(B.id), gI.vJ(), jt.xl(), c4.c5 = !0) : 6 === B.id ? (gI.gJ.a0s++, gI.gJ.a0s %= 10, gI.a4Z(B.id), gI.vJ(), c4.c5 = !0) : 7 === B.id ? (gI.gJ.sv++, gI.gJ.sv %= 4, gI.a4Z(B.id), gI.vJ(), c4.c5 = !0) : 8 === B.id ? (gI.gJ.a13++, gI.gJ.a13 %= 4, gI.a4Z(B.id), gI.vJ(), c4.c5 = !0) : 9 === B.id ? (gI.a4U(), gI.a4W(), gI.vJ(), jt.xl(), c4.c5 = !0) : 10 === B.id && (z = 0, c4.c5 = !0) : 1 === B.id ? (na.bp(oz, !0), na.bp(oz, !1)) : 2 === B.id ? (na.bp(p0[0], !0), na.bp(p0[0], !1)) : 3 === B.id ? (na.bp(p0[1], !0), na.bp(p0[1],
                        !1)) : 4 === B.id ? (12 <= d && e.setState(7), na.bp(oy, !0), na.bp(oy, !1)) : 5 === B.id ? (na.bp(nb, !0), na.bp(nb, !1)) : 6 === B.id && (z = 0, c4.c5 = !0), !0;
                y = !1;
                c4.c5 = !0;
                return !1
            }
    ...
    this.cG = function() {
        ...
        if (!(7 <= aJ.pe())) {
            ...
            cH.textAlign = cJ;
            cH.textBaseline = cI;
            t(A.f8, A.f9, A.i7, A.nV, n[z][0].fC, n[z][0].n6, n[z][0].cm,
                0 === l, n[z][0].name, .6);
            if (y) {
                var B = n[z].length;
                for (x = 1; x < B; x++) {
...
function kV() {
    ...
    function k() {
        if (-1 !== l)
            if (0 !== ec && eV.h3()) {
                for (var x = !1, A = 3; 0 <= A; A--) y[A] && (x = !0, gC += n[A], gD += z[A], eA.lo(n[A], z[A]), gm.rP());
                x ? c4.c5 = !0 : gq.gr()
            } else gq.gr()
    }
    var t = !1,
    ...
    this.co = function(k, t) {
        ...
        for (l = 21; 0 <= l; l--) {
            ...
            a: {
                ...
                if (!(2 > A))
                    for (C = B, B = 0; B < A; B++)
                        if (C = Math.abs(n - b5.gF(C)) >= Math.abs(x - b5.cF(C)) ? C + aV[n > y ? 1 : 3] : C + aV[x > z ? 2 : 0], !b5.yo(C)) {
                            if (b5.b6(C)) {
                                if (0 === B || B + 20 < A) break;
                                y = !0;
                                break a
...
function a2Z() {
    ...
    this.lx = function() {
        dA && (y = Math.floor(.18 *
            pO), y += y % 2, n = Math.floor(7 * y / 8), z = z ? z : document.createElement("canvas"), z.width = y, z.height = y, x = z.getContext("2d", {
            alpha: !0
...
function ke() {
    ...
    function k() {
        n = 0;
        z += 700 > z ? 200 : 0;
        bw.bx() && (l() || y) && (y = !1, p8(), uY.bp(), jk.bp(), jn.lx(), vv.bp(), jl.lx(), jj.lx(), ji.lx(), vn.lx(), cD.lx(), a5.bp(), 1 <= ec ? (eM.lx(!1), eO.lx(), eB.lx(), gm.lx(), eR.lx(), e9.lx(), fq.lx(), eS.lx(), eP.lx(), c2.lx(), hx.l3(), hy.lx(), eA.lx(), eW.lx(), eT.lx(), gm.rP()) : (0 === aJ.pe() ? jn.cE(0, !0) : 2 === aJ.pe() ? dy.lx() : 3 === aJ.pe() && jm.lx(), aJ.vr(), aJ.vw()), c4.c5 = !0)
    }
    ...
    this.dF = function(F, M, H, D, K) {
        ...
        if (F && (k(), F = as(l, 128), F = 1 > F ? 1 : F, l -= F, t === aw && (b0.b1[15] += F), l <= at ? (t === aw && (b0.b1[15] += l), g(!1), F = !1) : (ae.bT(t, E, l), F = !0), F))
            if (F = b5.f2(z, x), y = Math.abs(A - z) >= Math.abs(B - x) ? F + aV[A > z ? 1 : 3] : F + aV[B > x ? 2 : 0], z = b5.gF(y), x = b5.cF(y),
                eK.g0(C, y), F = b5.b6(y) ? !1 : !0, F) b5.yo(y) && b5.yv(y, t);
            else a: {
                if (b5.bG(y)) F = b8;
                else {
                    F = b5.bF(y);
                    ...
                    if (!ch(t, F)) {
                        M = bU[F] * jA - ax[F];
                        0 >= M || (M = l > M ? M : l, l -= M, t === aw && (e9.nA(M, F), b0.b1[16] += M), F === aw && (e9.nC(M, t), b0.b1[10] += M), ax[F] += M);
                        g(!0);
                        break a
                    }
                }
...
function kZ() {
    ...
    this.hu = function() {
        var y = t ? 0 : -g;
        a4R(y, y, aZ - 2 * y, aa - 2 * y, h1.a5S, h1.a5T, h1.a5U, h1.a5V) || (cH.fillStyle = l, cH.fillRect(0, 0, gE, cB))
    };
    this.cG = function() {
        t || (a4Q(0, -g, aZ, g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) && cH.drawImage(k[0], h1.a5W, h1.a5X - g), a4Q(aZ, -g, g, aa + 2 * g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) && cH.drawImage(k[1], h1.a5W + aZ, h1.a5X - g), a4Q(0, aa, aZ, g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) && cH.drawImage(k[2], h1.a5W, h1.a5X + aa), a4Q(-g, -g, g,
            aa + 2 * g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) && cH.drawImage(k[3], h1.a5W - g, h1.a5X - g))
    }
}
...
function a2V() {
    ...
    this.a5n = function() {
        0 !== fG[aw] && (this.a5i[this.m6] = bU[aw], this.sD[this.m6] = ax[aw], this.td[this.m6] = ay.te(aw), this.a5o(this.m6), this.m6++, this.m6 === this.cV && this.a5p(), this.dV = this.a5j - 1, hy.bv())
    };
    this.a5p = function() {
        this.a5l();
        this.a5o(0);
        this.m6 = 1 + as(this.cV, 2);
        for (var g = 1; g < this.m6; g++) this.a5i[g] = this.a5i[2 * g], this.sD[g] = this.sD[2 * g], this.td[g] = this.td[2 * g], this.a5o(g);
        this.a5j *=
            2
    };
    this.a5l = function() {
...
function a2W() {
    ...
    this.c7 = function(g, k) {
        ...
        if (k < this.cw - this.nW) return this.a5t = !0, this.a5s = (g - 2 * this.i7 - this.uc) / this.ud, !0;
        t = Math.floor(g / (this.c1 / this.lt.length));
        t = 0 > t ? 0 : t >= this.lt.length ? this.lt.length - 1 : t;
        t !== this.bs && (this.bs = t, this.a5v(), c4.c5 = !0);
        return !0
    };
    this.a2b = function() {
    ...
    this.nc = function() {
        ...
        0 === this.bs ? this.a5x(b0.a5i, g, k) : 1 === this.bs ? this.a5x(b0.sD, g, k) : 2 === this.bs ? this.a5y(g, k) : 3 === this.bs && (this.a5z(g, k), this.a60(g, k));
        cH.setTransform(1, 0, 0, 1, 0, 0)
    };
    this.a5w = function() {
        ...
        cH.fillStyle = cK;
        for (var k = this.lt.length - 1; 0 <= k; k--) cH.strokeRect(k * g, this.cw - this.nW, g, this.nW), cH.fillText(this.lt[k], (k + .5) * g, this.cw - .46 * this.nW)
    };
    this.a5x = function(g, k, t) {
        ...
        for (t = b0.m6 - 2; 0 <= t; t--) cH.lineTo(t * this.ud / (b0.m6 -
            1), this.xU - k * Math.sqrt(g[t]));
        cH.stroke();
        g = this.mB(g, k, .5);
    ...
    this.a5y = function(g, k) {
        ...
        for (var l = b0.m6 - 2; 0 <= l; l--) cH.lineTo(l * this.ud / (b0.m6 - 1), this.xU - t * b0.td[l]);
        cH.stroke();
        t =
            this.mB(b0.td, t, 1);
    ...
    this.a5z = function(g, k) {
        ...
        for (t = 7; 0 <= t; t--) cH.fillText(b0.a5k[t], 0, t * l / 7);
        cH.setTransform(1, 0, 0, 1, g + .39 * this.c1, k + 2 * this.nV);
        cH.textAlign = mj;
        t = b0.b1[1];
        cH.fillText(eB.nI(b0.b1[0] / (10 * (1 > t ? 1 :
            t)), 1), 0, 0);
        for (t = 6; 1 <= t; t--) cH.fillText(b0.b1[t].toString(), 0, t * l / 7);
        cH.fillText(eB.nI(100 * (1 - bU[aw] / b0.b1[7]), 0), 0, l)
    };
    this.a60 = function(g, k) {
        ...
        var l = this.cw - 4 * this.nV - this.nW;
        cH.fillStyle = oP;
        for (t = 2; 0 <= t; t--) cH.fillText(b0.a5k[t + 8], 0, t * l / 9);
        cH.fillStyle = oO;
        cH.fillText(b0.a5k[11], 0, 3 * l / 9);
        cH.fillStyle = of;
        for (t = 8; 4 <= t; t--) cH.fillText(b0.a5k[t + 8], 0, t * l / 9);
        cH.fillStyle = oe;
        cH.fillText(b0.a5k[17], 0, 9 * l / 9);
        cH.fillStyle = oP;
        t = eP.gL(b0.b1[8] +
    ...
    this.mB = function(g, k, t) {
        if (0 > this.a5s || 1 < this.a5s) return .25;
        ...
        cH.fillStyle = oa;
        cH.beginPath();
        cH.arc(l * this.ud / (b0.m6 -
            1), this.xU - k * Math.pow(n, t), 4, 0, 2 * Math.PI);
        cH.fill();
        g = this.a5s * c4.tf();
        g = 0 === fG[aw] ? Math.floor(g * eW.tl) : Math.floor(g * c4.dU());
        cH.fillStyle = cK;
...
function a2Y() {
    ...
    this.yb = function() {
        var l, y = hP;
        this.iq = [0, 1, 2, 3, 4, 5, 6, 7, 8];
        for (l = 0; l < y; l++) this.dX[l] = dr.dt.zy[l]
    };
    this.a6E = function() {
    ...
    this.dF = function(l) {
        ...
        dx || this.a6K(x, y, n);
        this.a6L(y, n, x);
        dx ? this.a6M() : this.a6N()
    };
    this.a6J = function(l, y, n, z) {
        var x, A, B = this.iq.length - 1,
            C = new Uint16Array(B);
        for (x = cq - 1; 0 <= x; x--) {
            for (A = B; 1 <= A; A--) C[A - 1] = Math.abs(4 * l[x].xd[0] - g[A][0]) + Math.abs(4 * l[x].xd[1] - g[A][1]) + Math.abs(4 * l[x].xd[2] - g[A][2]);
            var E = 768;
            for (A = B - 1; 0 <= A; A--) {
                var G = (A + x) % B;
                C[G] < E && (E = C[G], y[x] = G)
    ...
    this.a6M = function() {
        ...
        y[jG - 1] = b8;
        for (l = jG - 2; 0 <= l; l--) y[l] = dy.dz[l].mv;
        y[0]--;
        var n = 0 === y[0] ? 1 : 0;
    ...
    this.ip = function(l) {
        ...
        for (n = k.length - 1; 0 <= n; n--)
            for (y = t[n].length - 1; 0 <= y && this.iq[this.dX[t[n][y]]] === l; y--)
                if (-1 === z || sR[t[n][y]] < sR[z]) z = t[n][y], x = n;
...
function bR() {
    for (var g, k, t = aQ - 1; 0 <= t; t--)
        for (g = 3; 0 <= g; g--) k = aS[t] + aV[g], b5.ym(aP, k) && b5.yn(k) && (bM[aP].push(k), b5.b7(k, aP))
}
...
function a2X() {
    ...
    this.a2c = function() {
        1 !== ec || !dx || fq.lw || fc || fq.m2(); - 1 === this.a6k && (this.a6k = setInterval(k, 2E3))
    };
    this.xt = function() {
        this.c5 = !0; - 1 !== this.a6k && (clearInterval(this.a6k), this.a6k = -1)
    };
    this.jg = function() {
        this.a6h =
            this.a6n;
    ...
    this.dU = function() {
        return dx ? this.a6i.wP : this.a6j.wP
    };
    this.tf = function() {
        return 56
    }
...
function a6o() {
    ...
    this.dF = function() {
        jt.dF();
        fc ? ed() : 0 === this.bs ? c4.gf >= this.gf && (this.gf += this.a5j * Math.floor(1 + (c4.gf - this.gf) / this.a5j), 2 === ec || fq.lw ? e8() : (eE(), this.wP++, hB.u5()), this.bs++) : (fq.lw ? ed() : (c4.c5 = !0, ea()), this.bs = 0);
        eU();
        c4.c5 && (c4.c5 = !1, hs())
    }
}
...
function a6q() {
    ...
    this.a6v = function(k) {
        if (fc) this.tg(k);
        else if (this.a6t.push(k), 2 === ec) {
            for (k = 0; k < this.a6t.length; k++) js.a6w(this.a6t[k], g), g = (g + 1) % 8;
            this.a6t = []
        }
    };
    this.tg = function(k) {
        ...
        g = (g + 1) % 8;
        eB.tg(this.wO);
        this.wO === jI ? (fd.dF(), this.wP = this.bs = this.wO = 0, this.gf = c4.gf) : (this.wO++, eA.j7(), eA.eb(!0), hB.u5())
    };
    this.dF = function() {
        jt.dF();
        fc ? (c4.c5 =
            eB.tg(-1) || c4.c5, ed()) : 0 === this.bs ? c4.gf >= this.gf && (this.gf += this.a5j * Math.floor(1 + (c4.gf - this.gf) / this.a5j), 2 === ec ? e8() : this.a6x(), this.bs++) : (c4.c5 = !0, ea(), this.bs = 0);
        eU();
        c4.c5 && (c4.c5 = !1, hs())
    };
    this.a6x = function() {
        if (this.wP !== 7 * this.wO) eE(), this.wP++, hB.u5();
        else {
            for (var k = !1; this.a6z();)
                if (k = !0, eE(), this.wP++, 0 < this.a6t.length)
                    for (var t = this.a6u - 2; 0 <= t; t--) eE(), this.wP++;
                else break;
            k ? hB.u5() : (e8(), hB.j9())
        }
    };
    this.a6z = function() {
        return 0 < this.a6t.length ? (this.wO++, js.a6w(this.a6t[0], g), g = (g +
            1) % 8, this.a6t.shift(), !0) : !1
    }
}

function kn() {
    function g(k, t) {
        8 !== aJ.pe() || 0 !== t && t !== dv || dx || e9.n0(k)
    }
    this.gZ = 0;
    this.a70 = !0;
    this.dF = function() {
        c4.gf > this.gZ && (this.gZ = c4.gf + 2500, this.a71())
    };
    this.a71 = function() {
        var k = new Date;
        var t = k.getUTCSeconds();
        this.a70 ? 55 > t || -1 !== c4.a6k || (this.a70 = !1, t = k.getUTCMinutes(), 4 === t % 5 ? (k = k.getUTCHours(), 59 === t && 15 <= k && 21 >= k ? g("Upcoming Game of the Day", 0) : 14 === t % 30 ? g("Upcoming Alliance Contest", 0) : 29 === t % 30 ? g("Upcoming Battle Royale Contest", 0) : g("Upcoming One-vs-One Game", 8)) : 2 === t % 5 && g("Upcoming Zombie Game",
            9)) : 55 > t && (this.a70 = !0)
    }
}
    ...
    this.a5h = function(y, n) {
        ...
        if (0 === t) eD.a26(y, 3205);
            ...
            if (0 === z)
                ...
                if (y !== eD.w6) eD.close(y, 3239);
                else if (6 === aJ.pe() && ju.bp(), 7 !== aJ.pe()) eD.close(y, 3251);
            else {
                x = [0, 0, 0, 0];
                A = k(n, 6);
            ...
            else 1 === z && (z = aJ.pe(), 8 !== z ? 10 === z && eD.a26(y, 3243) : y !== eD.jf ? eD.a26(y, 3244) : 0 === k(n, 1) ? c4.a6j.a6v(n) : (z = k(n, 2), 0 === z ? 3 !== t ? eD.a26(eD.jf, 3230) : (z = k(n, 9), x = k(n, 7), 0 !== fG[z] && 0 !== fG[aw] && (x %= a5.a6, e9.mr(z, aw, x), eA.n4(z, 1, x))) : 1 === z ? 2 !== t ? eD.a26(eD.jf, 3235) : (z = k(n, 9), 0 !== fG[z] && 0 !== fG[aw] && eQ.a1j(0, [z], !0) && e9.la(z, 1)) : 3 !== t ? eD.a26(eD.jf, 3236) : (z = k(n, 9), x = k(n, 9), 0 !== fG[z] && 0 !== fG[x] && 0 !== fG[aw] && eQ.a1j(1, [z], !0) && (eA.n4(z, 3, 96), eA.n4(x, 4, 96), e9.n7(z, x)))))
        }
    };
    this.wT = function(y) {
        l = 1;
        ...
        if (k(y, 3) !== n) eD.a26(eD.jf, 3248);
            ...
            for (; l + 8 <= z;) {
                ...
                if (0 === x) {
                    ...
                    var C = k(y, 11);
                    eG.fb(A, x, B, C)
                } else 2 === x ? (B = k(y, 9), B = B === A ? b8 : B, eG.fe(A, B)) : 3 === x ? eG.fh(A) : 4 === x ? (x = k(y, 7), eA.n4(A, 0, x)) : 5 ===
...
function kh() {
    function g(k, t, l, y, n) {
        k >= zg || (x6 === k && (cH.fillStyle = oM, cH.fillRect(t, l, y, n), cH.fillStyle = cK), cH.strokeRect(t, l, y, n), cH.fillText(jp.bz(k).name, Math.floor(t + .5 * y), Math.floor(l + .55 * n)))
    }
    this.lE = !1;
    this.xV = [0, 0, 0, 0];
    this.show = function() {
    ...
    this.lx = function() {
        ...
        this.xV[3] > k && (this.xV[3] = k, this.xV[2] = Math.floor(k / 1.2));
        this.xV[0] = Math.floor((r - this.xV[2]) /
            2);
        this.xV[1] = Math.floor((s - this.xV[3]) / 2)
    };
    this.lo = function(k, t) {
        return k < this.xV[0] || t < this.xV[1] || k > this.xV[0] + this.xV[2] || t > this.xV[1] + this.xV[3] ? !1 : !0
    };
    this.c7 = function(k, t) {
        var l = as(zg + zg % 2, 2);
        c4.c5 = !0;
        if (k < this.xV[0] || t < this.xV[1] || k > this.xV[0] + this.xV[2] || t > this.xV[1] + this.xV[3]) return this.lE = !1, !0;
        var y = Math.floor(.13 * this.xV[3]);
        if (t < this.xV[1] + y) return k > this.xV[0] + this.xV[2] - 1.2 * y && (this.lE = !1), !0;
        y = Math.floor(l * (t - this.xV[1] - y) / (this.xV[3] - y));
        y = 0 > y ? 0 : y > l - 1 ? l - 1 : y;
        k > this.xV[0] + this.xV[2] /
            2 && (y += l);
        if (y >= zg) return !0;
    ...
    this.cG = function() {
        var k, t = Math.floor(.13 * this.xV[3]),
            l = as(zg + zg % 2, 2),
            y = (this.xV[3] - t - (l + 1) * cA) / l,
            n = Math.floor((this.xV[2] - 3 * cA) / 2);
        cH.lineWidth = 2;
        cH.textAlign = cJ;
        cH.textBaseline = cI;
...
function kd() {
    ...
    this.y0 = function(n) {
        ...
        if (!(jh.xq + 7E3 > c4.gf)) {
            ...
            for (z = jh.xp.length - 1; z >= A; z--) l(x, 4, Math.abs(jh.xp.charCodeAt(z) - 48) % 10);
            eD.send(n, x)
        }
    };
