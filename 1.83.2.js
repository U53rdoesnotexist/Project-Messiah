...
function kI() {
    ...
    function n() {
        ...
        var t = x.split(" ");
        if (2 !== t.length) return k(), jj.vd(3266), !0;
    ...
    function l() {
        if (void 0 !== x && m.iN(x)) return jk.wE(0, !0), !0;
        jk.wE(0, !1);
        return !1
    }
    var x;
...
function kj() {
    ...
    this.init = function() {
        ...
        var x = ce.a1W(0);
        ce.jN(0);
        for (l = 1; l < this.wQ; l++) this.a1l[l] = m.iZ() + ".com";
        ce.jN(x);
...
function a2O(g) {
    a2A || (a2A = !0, g.message ? (a2F = g.lineno, a2G = g.message, eD.rk(0, 6) && multi.a20(0), g = "[A_ERROR " + a2F + "][" + a2G + "]", a2W(g)) : (g = "[B_ERROR " + g.type + "][" + (g.srcElement || g.target) + "]", console.log(g)))
}
...
function Multi() {
    ...
    this.vote = function(remote_id) {
        ...
        if (!(je.xq + 7E3 > c4.time)) {
            ...
            l(y, 3, 2);
            g(y);
            var A = me(je.xp.length - 20, 0);
            for (z = je.xp.length - 1; z >= A; z--) l(y, 4, Math.abs(je.xp.charCodeAt(z) - 48) % 10);
            eD.send(remote_id, y)
        }
    };
