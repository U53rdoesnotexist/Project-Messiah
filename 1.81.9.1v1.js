...
function game() {
    ...
    function systemgameinit(g, k, t, l, x) {
        it = gW = !1;
        gamemode = l;
        iz = x;
        ...
        this.bz = function (N, G) {
            ...
            if (2 === M) {
                if (x[7]) {
                    ...
                    0 < L.length && (eE.l6(1, L, !0) && (dx.l7(L, E), multi.l8(L, E)), L = []);
                    this.kx();
                    return 1
                }
                return 0
        ...
        this.kz = function (g, k, t) {
            ...
            for (var l = this.lM - 1; 0 <= l; l--)
                if (g >= this.nU[l] && k >= this.nV[l]) {
                    ...
                    singleplayer ? dy.mk(myid, 0, this.nX[l]) : t === myid ? multi.nn(this.nX[l]) : multi.no(this.nX[l], t);
                    this.ni();
                    break
                } return !1
        };
    ...
    function tX() {
        ...
        this.bn = function () {
            bw.gQ -
                12E4 >= t[this.tY] && (t[this.tY] = bw.gQ, this.tn = [0, 0], e1.rG(0, 1 + this.tY) && multi.to(0, this.tY))
        };
        this.le = function () {
            var l;
        ...
        this.bz = function (l, x) {
            ...
            t[this.tY] = bw.gQ;
            e1.rG(0, 1 + this.tY) && multi.to(0, this.tY);
            return !0
        };
        this.c8 = function () {
            if (this.ku) {
    ...
    function kO() {
        ...
        function x(P, U) {
            ...
            for (X = 0; X < y[1]; X++) {
                var ba = A;
                for (W = 0; W < y[0]; W++) {
                    if (P > ba && P < ba + n && U > pa && U < pa + n) return multi.wh(E[V].wS), K = E[V].wS !== K ? E[V].wS : -1, bw.bx = !0;
                    V++;
    ...
    function kS() {
        ...
        this.d7 = function () {
            for (var x = this.uw - 1; 0 <= x; x--) this.us(x) && bw.gQ > l[x].gQ + 15E3 && multi.a0W(x, l[x].a0V)
        };
        ...
        this.a0d = function (x, n) {
            0 === n ? jQ.rI() : 3 > n ? multi.to(x, n - 1) : 3 === n ? multi.wt(x) : 4 === n ? jS.rI(x) : 5 === n ? x === this.jM && multi.a0e() : 6 === n ? multi.a0f(x) : 7 === n && multi.xI(x)
        };
        this.us = function (x) {
    ...
    function a0w() {
        ...
        window.addEventListener("error", a12, !0);
        sL = 10;
        we = new a13;
        gm = new a14;
        gw = new tR;
    ...
    function oldmulti() {
        ...
        this.choosespawn = function (n, z, y) {
