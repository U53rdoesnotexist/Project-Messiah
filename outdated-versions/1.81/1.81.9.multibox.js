...
function tick(){
	...
	tick1 = 0;
	cycle = 0;
	tick2 = Math.floor(Math.random() * 60);
	for (let f = ci - 1; f >= 0; f--){
			if(g6[f] == nickname) donateID = f;
		}
	}
	this.opening = function(){
			if (cycle == 0) ia.lC(228, ao+512);
			if (cycle == 1) ia.lC(440, ao+512);
			if (cycle == 2) ia.lC(440, ao+512);
			if (cycle > 2) ia.lC(450, ao+512);
	}
	this.cycle = function(){
		if(cycle%2 == 0) return true
		return false
	}
	this.count = function(){
		if(100<= ++tick1){
		...
		else if (tick1 == 66  && (cycle == 5 || cycle == 6)){
				ia.lC(300, ao+512);
		}
		if (cycle >= 12 && tick1 == tick2 && this.cycle()){
			ia.lC(350, donateID);
		}
	}
}
    ...
    function g8() {
        ...
        this.gS = function() {
            g(1);
            this.gT(0, 0, aR - 1, aS - 1);
            fQ || this.gU(ao, 3E3, !0, .3)
        };
            ...
            for (D = K; D < K + 4; D++)
                for (L = J; L < J + 4; L++)
                    if (D > K && D < K + 3 || L > J && L < J + 3) {
                        var I = ax.ep(D, L);
                        ax.ay(I) && (cs[E] = D < cs[E] ? D : cs[E], cr[E] = D > cr[E] ? D : cr[E], cv[E] = L < cv[E] ? L : cv[E], cu[E] = L > cu[E] ? L : cu[E], H[bM[E]] = I, bM[E]++, ax.hN(I, E))
                    } hJ[E] = bM[E];
            for (I = bM[E] - 1; 0 <= I; I--) ax.hO(H[I], E) ? (ax.az(H[I],
                E), bE[E].push(H[I])) : ax.hP(H[I]) ? (ax.az(H[I], E), bF[E].push(H[I])) : ax.hQ(H[I]) && (ax.az(H[I], E), bI[E].push(H[I]))
        }
                    ...
                    for (I = D + L; I >= D - L; I--)
                        if ((K ===
                            ...
                            if (N) {
                                if (0 < bM[E]) {
                                    for (D = cr[E]; D >= cs[E]; D--)
                                        for (J = cu[E]; J >= cv[E]; J--) L = 4 * (J * aR + D), ax.hW(E, L) && (ax.hX(L), bM[E]--);
                                    t()
                                }
                                l(K - 1, I - 1);
                                return !0
        ...
        this.fX = function(g) {
            ...
            if (!k) {
                if (8 === di) {
                    ...
                    iT.hu(g)
                } else d2 ? (g = eH.iU(), k = dO.dP[ao] === g, 9 === di ? t = k ? ea[0] : 512 : (g = dO.iV(dO.iW[g]), t = g[0], 512 !== t && dx.iX(g[1])), dx.iY(k)) : (t = ea[0], k = t === ao, dx.iZ(t));
                dk || ia.ib(ic(), t);
                eK.show(k, !1);
                dx.ii(!0);
                eA.eP(!0);
    ...
    function ik() {
        this.cI = function(g, k, t) {
            0 !== f3[g] && il.hR(g, k, t) && (bw.bx = !0)
        };
        this.d7 = function() {
            fQ = !1;
            for (var g = 0; g < ci; g++) 0 !== f3[g] && 0 === bM[g] && il.hY(g);
            0 !== f3[ao] ? (as.at[7] = bM[ao], as.at[8] = ap[ao], eF.c6(), dz.im(), eJ.gT(cs[ao] - 5, cv[ao] - 5, cr[ao] + 5, cu[ao] + 5), eL.bh()) : eK.show(!1, !1);
            dx.io(18);
            dy.ip();
            dy.eP();
            fR = null;
    ...
    var ci, ih, dh, ig, b0 = 512,
        h8 = 512,
        is = 150,
        dk, it, fN = 0,
        iu, iv, iw, hK = 512,
        al = 2,
        ao, gW, fQ, ix, d2, iy, di, iz, fR, iT, j0;

    function j1(g, k, t, l, x) {
        it = gW = !1;
        di = l;
        iz = x;
        d2 = 7 > di || 9 === di;
        ...
        di = 8 === di && 2 !== ci ? 7 : di;
        iy = 9 === di ? 2 : di + 2;
        j0 = 2 >= ci ? 30 : 50 >= ci ? 40 : 50;
        fR = (ix = fQ = d2 || 100 > ci) ? new ik : null;
        hK = 512;
        h8 = b0;
        dk && (h8 = dl.j6());
        dh = h8 - ci;
        ...
        eE.bh();
        e5.bh();
        8 === di ? (iT = new hr, iT.bh(t)) : iT = null;
        jI();
        eL.bh();
        dk ? bw.jJ() : bw.jK();
        bw.bx = !0;
    ...
    var d8, am, d6, e7, e4, e8, eJ, il, m, he, fe, dx, jP, eD, bu, eF, gX, jQ, eC, eA, dz, eK, jR, jS, jT, jU, jV, jW, dl, jO, bo, ax, f, aW, aq, dy, jC, dq, jA, jX, jY, gb, en, cW, fp, ha, jZ, ja, eL, ia, jb, eB, jc, jd, eG, eM, e1, e5, je, jf, e6, e3, eE;
    ...
    function jh() {
        function g(N, G, M, Q) {
            for (var S, P = 0; P < N.length; P++) {
                ...
                W.fill();
                6 === N[P] ? S.drawImage(bo.br(19), 0, 0) : 7 === N[P] ? S.drawImage(bo.kr("emojis"), -4 * M, 0) : S.drawImage(bo.br(3), -N[P] * M, 0)
            }
        }
        ...
        this.bh = function() {
            ...
            B = C = z = y = F = 0;
            this.kj();
            for (var N = this.kk.length - 1; 0 <= N; N--) x.push(!1);
            x.push(!1)
        };
        this.kj = function() {
            this.kk = [];
            ...
            D = A / N;
            K = Math.floor(A / 3);
            g([0, 1, 2, 3, 7, 4, 5, 6], this.kk, N, "rgba(0,180,0,0.6)");
            g([0, 4, 5], J, N, "rgba(200,0,0,0.6)");
            g([0, 2, 4], this.kl, N, "rgba(0,0,0,0.6)");
            g([0, 5], this.ki, N, "rgba(200,200,0,0.6)");
            this.kk[6] = this.ki[1]
        };
        this.kt = function(N, G) {
            if (this.ku()) {
                var M = this.bz(N, G);
                bw.bx = 0 < M;
                return 2 > M
        ...
        this.kv = function(N, G) {
            this.ku() || (B = N, C = G, F = (new Date).getTime())
        };
        this.kw = function(N) {
            return N < ci && 2 !== fH[N]
        };
        this.bz = function(N, G) {
            C = B = -1E3;
            if (2 === fH[ao] || 0 === f3[ao] && !fQ) return this.kx(), 1;
            if (n) {
                this.kx();
            ...
            if (2 === M) {
                if (x[7]) {
                    ...
                    0 < L.length && (eE.l6(1, L, !0) && (dx.l7(L, E), ia.l8(L, E)), L = []);
                    this.kx();
                    return 1
                }
                return 0
            ...
            if (3 === M) {
                this.kx();
                if (this.kw(E) && 7 > di && 1071 > bw.dM()) return dx.l9(),
                    1;
                dx.lA();
                dk ? dS(ao, E, ak(eF.lB() * ap[ao], 1E3)) : ia.lC(eF.lB(), E === b0 ? ao : E);
                return 1
            }
            if (4 === M) return x[0] ? fQ ? (this.kx(), dk ? (fR.cI(0, ax.g3(H), ax.c7(H)), fR.d7()) : ia.lE(1E3, ax.g3(H), ax.c7(H))) : (this.kx(), dx.lA(), dk ? f9(ao, E, eF.lB()) : (!ix || 300 < dz.lD()) && ia.lC(eF.lB(), E === b0 ? ao : E)) : x[8] ? (this.kx(), e5.lF(E, eF.lB())) : this.kx(), 1;
            if (5 === M) return x[1] ? (this.kx(), dx.lA(), dk ? e4.fA(ao, eF.lB(), ax.g3(H), ax.c7(H)) : ia.lE(eF.lB(), ax.g3(H), ax.c7(H)), 1) : 0;
            if (7 === M && x[4]) return this.kx(), n = a5.show(N, G), 1;
            if (8 === M) return x[5] ?
                (eE.l6(0, [E], !0) && (dx.lG(E, 0), ia.lH(E)), this.kx(), 1) : 0;
            this.kx();
            return 2
        };
        this.lI = function(N, G) {
            if (this.ku() || 2 === fH[ao] || 0 === f3[ao] && !fQ) return !1;
            ...
            var S = Q * aR * 4 + 4 * M;
            if (!ax.ay(S)) return !1;
            if (2 === fN) return 1 <= a5.lM && (E = ax.b7(S), this.kw(E)) ? (E === ao && this.kx(), x[4] = !0, this.lN(N, G)) : !1;
            H = ax.ep(M, Q);
            if (fQ) return x[0] = !0, this.lN(N, G);
            x[1] = en.cg(ao, H);
            if (ax.b8(S)) return E = b0, lO(ao) ? x[0] = !0 : lP(ao, E) && (x[8] = !0), this.lN(N, G);
            E = ax.b7(S);
            if (E === ao) {
                this.kx();
                if (0 === a5.lM) return !1;
            ...
            if (cZ(E, ao)) {
                ...
                M[7] = Q;
                lT(ao,
                    E) ? x[0] = !0 : lP(ao, E) && (x[8] = !0);
                return this.lN(N, G)
            }
            x[2] = d2;
            return this.lN(N, G)
        };
        this.lN = function(N, G) {
            z = N - Math.floor(A / 2);
            y = G - Math.floor(A / 2);
            return this.ku()
        };
        this.lV = function(N, G) {
            if (!this.ku()) return !1;
            if (n) {
                if (a5.ky(N, G)) return !1;
                a5.l0();
                n = !1;
                return bw.bx = !0
            }
            return t(l(N, G)) ? !1 : (this.kx(), bw.bx = !0)
        };
        this.kx = function() {
            var N;
        ...
        this.lX = function() {
            if (n) a5.c8();
                ...
                x[5] && c9.drawImage(this.kk[5], N, N);
                x[6] && c9.drawImage(this.kk[6], 0, -N);
                x[7] && c9.drawImage(this.kk[7], N, -N);
                c9.imageSmoothingEnabled = !1;
                c9.setTransform(1,
                    0, 0, 1, 0, 0)
            }
    ...
    function ji() {
        function g() {
            ...
            B.fillStyle = lg;
            B.fillRect(0, 0, l, l);
            0 === y && (B.fillStyle = lh, B.fillRect(0, 0, l, l));
            B.fillStyle = cC;
            B.fillRect(0, 0, l, 1);
            B.fillRect(0, 0, 1, l);
        ...
        function k(B, C) {
            ...
            if (B <= 4 * l + lo) {
                if (C >= eF.f8) return 0;
                if (C >= eF.f8 - l - A * lo) return 2;
                if (C >= eF.f8 - 2 * (l + A * lo)) return 3
            } else if (B <= 7 * l + lo && C >= eF.f8 - l - A * lo) return 1;
            return -1
        }

        function t(B, C) {
            c9.setTransform(1, 0, 0, 1, lo, eF.f8 - B * A * lo - B * l);
            c9.fillStyle = lg;
            c9.fillRect(0, 0, 4 * l, l);
            y === B + 1 && C === cC && (c9.fillStyle = lh, c9.fillRect(0, 0, 4 * l, l));
            c9.fillStyle = C;
        ...
        this.lj = function() {
            (this.ld = !this.ld) ? (gW = !1, dk && 1 === fN && !fQ && (setTimeout(function() {
                gw.ij()
        ...
        this.bz = function(B, C) {
            var F = k(B, C);
            return this.ld ? 0 === F ? (jL(), aB(), 2) : 1 === F ? (this.lj(), 2) : 2 === F ? (this.ff(ao) && (dk ? e4.fd(ao) : ia.lm(), this.lj()), 2) : 3 === F && 2 <= as.ln ? (hf.lj(), bw.bx = !0, 2) :
                hf.ku || dk && !fQ ? 1 : (this.lj(), 2) : 0 === F ? (this.lj(), 2) : 0
        };
        ...
        this.c8 = function() {
            if (this.ld) {
                ...
                c9.setTransform(1, 0, 0, 1, lo, eF.f8);
                c9.fillStyle = lg;
                c9.fillRect(0, 0, B, l);
                0 === y ? (c9.fillStyle = lh, c9.fillRect(0, 0, 4 * l, l)) : 1 === y && (c9.fillStyle = lh, c9.fillRect(4 * l, 0, Math.floor(1.5 * l), l));
                c9.fillStyle = cC;
                c9.fillRect(0, 0, B, 1);
                c9.fillRect(0, 0, 1, l);
                c9.fillRect(4 * l, 0, 1, l);
    ...
    function jj() {
        ...
        function A(G, M, Q, S, P, U, W, X) {
            ...
            if (pa + K > r && !V && 50 !== Q && 20 < M.length) {
                ...
                V && (V = H / a5.bt, R.imageSmoothingEnabled = !0, R.setTransform(V, 0, 0, V, pa - H, 0), R.drawImage(a5.kn[da], 0, 0));
                E.unshift({
                    gQ: G,
                    l: M,
                    id: Q,
        ...
        this.bh = function() {
            ...
            0 < jA.mx && (G += "   Water: " + eD.g7(jA.mx) +
                " (" + dz.mw(100 * jA.mx / jA.mu, 1) + ")");
            0 < jA.my && (G += "   Mountains: " + eD.g7(jA.my) + " (" + dz.mw(100 * jA.my / jA.mu, 1) + ")");
            A(340, G, 6, 0, C(215, 245, 255), hi, -1, !1);
            10 === di && A(120, "Full sending against human players is disabled.", 6, 0, C(235, 255, 120), hi, -1, !1)
        };
        this.le = function() {
            var G;
            ...
            if (0 < E.length) {
                var M = E;
                E = [];
                for (G = M.length - 1; 0 <= G; G--) A(M[G].gQ, M[G].l, M[G].id, M[G].player, M[G].mA, M[G].mB, M[G].mC, M[G].mD)
            }
            this.mE()
        };
        this.mE = function() {
        ...
        this.mG = function() {
            if (eG.ku) return eG.bt;
            var G = E.length;
            return 0 === G ? 0 : 1 === G ? E[0].mH : mI(E[0].mH, E[1].mH)
        };
        this.bz = function(G, M) {
            for (var Q = y(), S, P = E.length - 1; 0 <= P; P--)
                if (S = Q - (P + 1) *
                    H, M >= S && M < S + H) {
                    if (50 === E[P].id) {
                        if (G >= g2 - D - K - E[P].bt) return G >= g2 - D - K ? (P = E[P].player, this.lG(P, 0), ia.lH(P)) : eJ.gU(E[P].player, 800, !1, 0), !0;
                        break
                    }
                    if (G >= g2 - E[P].bt - K) return E[P].mD && (eJ.gU(E[P].player, 800, !1, 0), 0 <= E[P].mC && (Q = E[P].mC, E[P].mC = E[P].player, E[P].player = Q)), !0;
                    break
                } return !1
        };
        this.io = function(G) {
        ...
        this.fZ = function(G, M) {
            0 === M ? (as.at[G < ci ? 4 : 3]++, bu.cI(G, 0), A(q ? 100 : 160, "You conquered " + g6[G] + ".", 0, G, "rgb(10,220,10)", hi, -1, !1)) : 1 === M ? (F(50,
                b0), bu.cI(G, 1), A(360, "You were conquered by " + g6[G] + ".", 0, G, "rgb(255,40,40)", hi, -1, !0), eJ.gU(G, 2700, !0, 0)) : 2 === M ? (bu.cI(G, 2), A(0, "Congratulations! You won the game.", 0, G, "rgb(10,255,255)", hi, -1, !0), eJ.gU(G, 2700, !0, 0)) : 3 === M ? (bu.cI(G, 2), A(0, g6[G] + " won the game.", 0, G, cC, hi, -1, !0), eJ.gU(G, 2700, !0, 0)) : 4 === M ? (ih--, ig--, this.mP(1, G, G)) : 5 === M ? 2 !== fH[G] && he.kw(ao) && (B(1, 5), dy.mR(G) ? A(180, g6[G] + " has broken the non-aggression pact and invades you!", 1, G, C(255, 200, 180), hi, -1, !0) : A(180, g6[G] + " is attacking you!",
                1, G, "rgb(255,70,10)", hi, -1, !0)) : 18 === M ? A(255, "Choose your start position!", 18, 0, cC, hi, -1, !1) : 21 === M ? A(220, "You surrendered!", M, 0, "rgb(255,40,40)", hi, -1, !1) : 22 === M && this.mP(2, G, G)
        };
        this.mT = function(G) {
            A(200, "Error [" + G + "]", 94, 0, cC, mV, -1, !1)
        };
        this.iZ = function(G) {
            bu.cI(G, 2);
            100 > ci ? A(0, g6[G] + " won the game.", 3, G, cC, hi, -1, !0) : A(0, g6[G] + " has been immortalized!", 3, G, cC, hi, -1, !0);
            eJ.gU(G, 2700, !0, 0)
        };
        this.mW = function(G, M, Q) {
            G === ao ? A(175, " Message to " + g6[M] + ": ", 1E3 + Q, M, C(200, 255, 210), hi, -1, !0) : this.mZ(G,
                Q)
        };
        ...
        this.iY = function(G) {
            var M = dO.iW[eH.md()];
            G ? (9 === di ? (G = "The Resistance defeated the virus.", bu.me("The Resistance", 2, 1, 12)) : G = "Congratulations! Team " + dO.bg[M] + " has won the game!", A(0, G, 40, 0, "rgb(10,220,10)", hi, -1, !1)) : (9 === di ? (G = "Mankind lost the war against the virus.", bu.me("The Virus", 2, 0, 16)) : G = "Our alliance has been defeated!",
                A(0, G, 41, 0, "rgb(200,80,80)", hi, -1, !1));
            9 !== di && bu.me("Team " + dO.bg[M], 2, 1, 12);
            eJ.gd(2700)
        };
        this.ht = function(G) {
        ...
        this.iX = function(G) {
            1 === e1.mi && A(0,
                "[" + G + "] has won " + ci + (iz ? " x 2" : "") + " points!", 45, 0, "rgb(225,240,255)", hi, -1, !1)
        };
        this.lG = function(G, M) {
            0 === M ? F(50, G) ? (A(128, "You signed a non-aggression pact with " + g6[G] + ".", 52, G, C(180, 255, 180), hi, -1, !0), dy.mk(G, 2, 255)) : A(384, "You asked " + g6[G] + " to sign a non-aggression pact.", 51, G, C(210, 210, 255), hi, -1, !0) : F(51, G) ? (A(128, g6[G] + " accepted the non-aggression pact.", 52, G, cC, "rgba(60,120,10,0.9)", -1, !0), dy.mk(G, 2, 255)) : (A(384, g6[G] + " requests a non-aggression pact.", 50, G, cC, "rgba(90,90,90,0.9)", -1,
                !0), dy.mk(G, 2, 96))
        };
        this.l7 = function(G, M) {
            var Q = "You ",
                S;
            a: {
            ...
            1 < G.length ? A(230, Q + G.length + " players to attack " + g6[M] + ".", 66, M, S, hi, -1, !0) : A(230, Q + g6[G[0]] + " to attack " + g6[M] + ".", 66, G[0], S, hi, M, !0)
        };
        this.mn = function(G, M) {
            bM[G] > 2 * bM[ao] ? A(230, g6[G] + " orders you to attack " + g6[M] + "!", 66, G, cC, "rgba(90,50,5,0.9)", M, !0) : A(230, g6[G] + " asks you to attack " + g6[M] + ".", 66, G, cC,
                "rgba(75,65,5,0.9)", M, !0)
        };
        this.mp = function(G, M) {
            F(G, M)
        };
        this.lA = function() {
            100 <= ap[ao] || A(80, "Your balance is too low!", 9, 0, cC, hi, -1, !1)
        };
        this.l9 = function() {
            A(80, "Boosting is disallowed in the first minute!", 9, 0, cC, hi, -1, !1)
        };
        this.mq = function(G, M) {
            2 !== fH[ao] && A(200, "You exported " + eD.g7(G) + " resource" + (1 === G ? "" : "s") + " to " + g6[M] + ".", 30, M, "rgb(190,255,190)", hi, -1, !0)
        };
        this.ms = function(G, M) {
            if (2 !== fH[ao]) {
                var Q = 200 - 20 * E.length;
                A(80 > Q ? 80 : Q, g6[M] + " supported you with " + eD.g7(G) + " resource" + (1 === G ? "" :
        ...
        this.ii = function(G) {
            var M, Q = bw.dM();
            for (M = 2; 0 <= M; M--) 0 < l[M] && (G || x[M] < Q - 220) && this.n0(M)
        };
        this.n0 = function(G) {
            var M = l[G];
            var Q = g[G];
            l[G] = 0;
            1 === M ? (M = g6[Q] + z[G], 0 === G && (M += g6[k[G]] + "."), A(t[G], M, 7, k[G], cC, hi, -1, !0)) : 2 <= M && (M = g6[Q] + " and " + (M - 1) + " other player" + (2 === M ? "" : "s") + n[G], A(t[G], M, 7, Q, cC, hi, -1, !1))
        };
        this.mP = function(G, M, Q) {
            var S = bw.dM(),
                P = l[G] + 1;
            l[G]++;
            g[G] = M;
        ...
        this.c8 = function() {
            for (var G = y(), M, Q = E.length - 1; 0 <= Q; Q--) M = G - (Q + 1) * H, 50 === E[Q].id ? (c9.drawImage(E[Q].lZ, g2 - E[Q].bt - D - K, M), c9.drawImage(N, g2 - D - K, M)) : c9.drawImage(E[Q].lZ, g2 - E[Q].bt - K, M)
        }
    }

    function n3() {
        this.bq = this.n5 = this.n4 = this.ho = this.co = this.bt = 0;
        this.bk = -1;
        this.la = ["Accept Cookies", "More Information", "Decline"];
        this.colors = ["rgba(0,255,0,0.4)", "rgba(0,0,255,0.4)", "rgba(255,0,0,0.4)"];
        this.ku = !1;
        this.bh = function() {
            this.le();
            this.ku = 5 > d && !b && 0 === f.a0()
        };
        this.le = function() {
            this.bt = Math.floor(2.8 * Math.floor((q ? .09 : .062) * bi));
            this.co = Math.floor(1 * this.bt);
            this.ho = Math.floor(.06 * this.bt);
            this.hp = this.bt - 2 * this.ho;
            this.n4 = this.ho;
            this.n5 = (this.co - (this.la.length + 1) * this.n4) / this.la.length;
            this.bq = Math.floor(.3 * this.n5)
        };
        this.bz = function(g, k) {
            if (!this.ku) return !1;
            var t = this.n7(g, k);
            if (-1 === t) return !1;
            0 === t ? (f.n8(2), this.ku = !1) : 1 === t ? n9.bh(nA, !0) : 2 === t && (f.n8(1), this.ku = !1);
            return bw.bx = !0
        };
        this.lV = function(g, k) {
            if (!this.ku) return !1;
            var t = this.bk;
            this.bk = this.n7(g, k);
            t !== this.bk && (bw.bx = !0);
        ...
        this.n7 = function(g, k) {
            ...
            var t = Math.floor((k - .5 * this.n4) / ((this.co - this.n4) / this.la.length));
            return 0 >
                t ? 0 : t >= this.la.length ? this.la.length - 1 : t
        };
        this.c8 = function() {
            this.ku && this.nB()
        };
        this.nB = function() {
            ...
            for (var t = this.la.length - 1; 0 <= t; t--) c9.setTransform(1, 0, 0, 1, g + this.ho, k + this.n4 + t * (this.n4 + this.n5)), c9.fillStyle = this.colors[t], c9.fillRect(0, 0, this.hp, this.n5), this.bk === t && (c9.fillStyle =
                nC, c9.fillRect(0, 0, this.hp, this.n5)), c9.fillStyle = cC, c9.fillText(this.la[t], this.hp / 2, .54 * this.n5), c9.strokeRect(0, 0, this.hp, this.n5);
            c9.setTransform(1, 0, 0, 1, 0, 0)
        }
    }
    ...
    function nL() {
        ...
        this.nO = this.nN = 50;
        this.nP = 8;
        this.nQ = this.nN + this.nO;
        this.a6 = this.nN + this.nO + this.nP;
        this.bt = 72;
        this.nS = this.nR = 0;
        this.kn = Array(this.a6);
        this.nT = 8;
        this.nU = Array(this.nN + this.nO);
        this.nV = Array(this.nN + this.nO);
        this.ey = this.ex = 0;
        this.zoom = 1;
        this.nW = .2;
        this.lM = 0;
        this.nX = this.a7 = null;
        this.nY = 0;
        this.bh = function() {
            var g;
            this.a7 = Array(this.a6);
            this.nX = Array(this.a6);
            var k = bo.kr("emojis");
            this.na();
            for (g = this.lM = 0; g < this.nN; g++) this.nb(g, g, k);
            k = bo.kr("flags");
            for (g = 0; g < this.nO; g++) this.nb(g,
                this.nN + g, k);
            this.nd();
            this.kn[26] = this.ne(25, 2);
            this.nf()
        };
        this.nb = function(g, k, t) {
            this.a7[k] = !1;
            this.nX[k] = 0;
        ...
        this.nd = function() {
            this.kn[this.a6 -
                5] = this.kn[26];
            this.kn[this.a6 - 4] = this.ne(this.a6 - 5, 2);
            this.kn[this.a6 - 1] = this.ne(this.a6 - 5, 1);
            this.kn[this.a6 - 8] = this.ne(this.a6 - 4, 1);
            this.kn[this.a6 - 3] = this.kn[39];
            this.kn[this.a6 - 2] = this.ne(this.a6 - 3, 1);
            this.kn[this.a6 - 7] = this.ne(this.a6 - 2, 1);
            this.kn[this.a6 - 6] = this.ne(this.a6 - 7, 1)
        };
        this.ne = function(g, k) {
            ...
            l.drawImage(this.kn[g], 1 === k ?
                0 : -this.bt, -this.bt);
            return t
        };
        this.nf = function() {
            var g = u().split("");
            if (2 * g.length !== this.a6) this.lM = 0;
            else {
        ...
        this.ni = function() {
            for (var g = this.lM = 0; g < this.a6; g++) this.a7[g] && (this.nX[this.lM++] = g)
        };
        this.l0 = function() {
            8 === this.lM && this.nX[0] === this.nQ && this.ni()
        };
        this.nj = function() {
            this.lM = this.nP;
            for (var g = 0; g < this.nP; g++) this.nX[g] = this.nQ + g
        };
        this.na = function() {
            this.nR = Math.floor((q ? .075 :
                .0468) * bi);
            this.zoom = this.nR / this.bt;
            this.nS = (1 + this.nW) * this.nR
        };
        this.show = function(g, k) {
            if (1 > this.lM) return !1;
            this.nY = bw.gQ;
            ...
            n = n + x > g2 ? g2 - x : n;
            n = 0 > n ? 0 : n;
            var z = Math.floor(k - this.nS / 2);
            l = Math.floor(l * this.nS);
            z = z + l > c3 ? c3 - l : z;
            z = 0 > z ? 0 : z;
            this.ex = n + x;
            this.ey = z + l;
        ...
        this.ky = function(g, k) {
            return !(g < this.nU[0] || k < this.nV[0] || g >= this.ex || k >= this.ey)
        };
        this.kz = function(g, k, t) {
            if (t === ao && this.nY + 190 > bw.gQ) return !1;
            for (var l = this.lM - 1; 0 <= l; l--)
                if (g >= this.nU[l] && k >= this.nV[l]) {
                    if (39 === this.nX[l]) return this.nj(), this.show(g, k), !0;
                    dk ? dy.mk(ao, 0, this.nX[l]) : t === ao ? ia.nn(this.nX[l]) : ia.no(this.nX[l], t);
                    this.ni();
                    break
                } return !1
        };
        ...
        this.nq = function(g) {
            return g >= this.nN && g < this.nN + this.nO
        };
        this.c8 = function() {
            c9.imageSmoothingEnabled = !0;
            for (var g = this.nW * this.nR / 2, k = this.lM - 1; 0 <= k; k--) c9.setTransform(this.zoom, 0, 0, this.zoom, this.nU[k] + g, this.nV[k] + g), c9.drawImage(this.kn[this.nX[k]], 0, 0);
            c9.imageSmoothingEnabled = !1;
            c9.setTransform(1, 0, 0, 1, 0, 0)
        };
        this.nr = function(g, k, t) {
            c9.imageSmoothingEnabled = !0;
            c9.setTransform(this.zoom, 0, 0, this.zoom, g, k);
            c9.drawImage(this.kn[t], 0, 0);
            c9.imageSmoothingEnabled = !1;
            c9.setTransform(1, 0, 0, 1, 0, 0)
        }
    }
    var g5 = "rgb(0,0,0)",
        ...
        o1 = "rgba(0,255,0,0.5)",
        o2 = "rgba(0,200,0,0.5)",
        mF = "rgba(0,100,0,0.75)",
        o3 = "rgba(0,40,0,0.8)",
        o4 = "rgb(128,255,128)",
        o5 = "rgba(255,255,150,0.2)",
        o6 = "rgba(0,255,0,0.3)",
        lh = "rgba(255,255,255,0.3)",
        o7 = "rgba(0,40,90,0.75)",
        o8 = "rgba(220,0,0,0.6)",
        o9 = "rgba(255,100,100,0.8)",
        ...
        oD = "rgb(255,70,70)",
        oE = "rgb(230,0,0)",
        oF = "rgba(0,60,60,0.85)",
        oG = "rgb(160,160,255)",
        cC = "rgb(255,255,255)",
        oH = "rgba(255,255,255,0.6)",
        oI = "rgba(255,255,255,0.4)",
        nC = "rgba(255,255,255,0.25)",
        oJ = "rgba(255,255,255,0.85)",
        oK = "rgba(255,255,255,0.75)",
        oL = "rgb(255,120,100)",
        oM = "rgba(255,255,0,0.5)",
        cA = "middle",
        oN = "bottom",
        cB = "center",
        mN = "left",
        ...
        nA = "https://territorial.io/cookie_policy",
        ...
        lo, oa, c2, ob, oc, od, oe, c4, of = ["wss://",
            "/s50/", "/s51/", "/s52/"
        ];
    ...
    function ol(g) {
        g.preventDefault();
        oc || (e1.ow(e1.jM), ox(Math.floor(g.clientX), Math.floor(g.clientY)))
    }
    ...
    function oq(g) {
        ...
        e1.ow(e1.jM);
        oc = !0;
        0 < g.touches.length && (od = Math.floor(g.touches[0].clientX), oe = Math.floor(g.touches[0].clientY), jZ.oy(g) || ox(od, oe))
    }
    ...
    function or(g) {
        g.preventDefault();
        0 < g.touches.length && (od = Math.floor(g.touches[0].clientX), oe = Math.floor(g.touches[0].clientY), jZ.p3(g) || p2(od, oe))
    }
    ...
    function jl() {
        function g(C) {
            var F = n[C].lZ.width;
            n[C].hh.clearRect(0, 0, F, A);
            n[C].hh.fillStyle = 0 !== n[C].id ? "rgba(33,33,120,0.83)" : n[C].cE === b0 ? "rgba(88,88,88,0.83)" : n[C].cE < ci ? "rgba(100,70,33,0.83)" : "rgba(33,100,80,0.83)";
            n[C].hh.fillRect(0, 0, F, A);
            pA(n[C].hh, F, A);
            F > z + 2 * A && (n[C].hh.fillRect(F - z - A, 0, 1, A), n[C].hh.fillText(g6[n[C].cE], Math.floor((F - z) / 2), Math.floor(.57 * A)));
            var E = 0 !== n[C].id ? 0 : A;
            n[C].hh.fillText(eD.g7(n[C].cF), Math.floor(F - z / 2 - E), Math.floor(.57 * A));
            n[C].hh.fillStyle = oH;
            n[C].hh.fillRect(Math.floor(F -
                z - E), A - B, Math.floor(z * n[C].cF / n[C].pP), B);
            0 === n[C].id ? (k(C, F), n[C].hh.strokeStyle = o4, n[C].hh.fillRect(A, 0, 1, A), F -= A, n[C].hh.beginPath(), n[C].hh.moveTo(Math.floor(.3 * A + F), Math.floor(A / 2)), n[C].hh.lineTo(Math.floor(A - .3 * A + F), Math.floor(A / 2)), n[C].hh.stroke(), n[C].hh.beginPath(), n[C].hh.moveTo(Math.floor(A / 2 + F), Math.floor(.3 * A)), n[C].hh.lineTo(Math.floor(A / 2 + F), Math.floor(A - .3 * A)), n[C].hh.stroke()) : k(C, 2 * A)
        }

        function k(C, F) {
            n[C].hh.strokeStyle = n[C].pQ ? lu : oC;
            n[C].hh.fillStyle = cC;
            n[C].hh.fillRect(F - A, 0,
                1, A);
            var E = Math.floor(A / 12);
            n[C].hh.lineWidth = 3 > E ? 3 : E;
            n[C].hh.lineCap = "round";
            F = A + 1;
            n[C].hh.beginPath();
            n[C].hh.moveTo(Math.floor(F - .35 * A), Math.floor(.35 * A));
            n[C].hh.lineTo(Math.floor(F - A + .35 * A), Math.floor(A - .35 * A));
            n[C].hh.stroke();
            n[C].hh.beginPath();
            n[C].hh.moveTo(Math.floor(F - A + .35 * A), Math.floor(.35 * A));
            n[C].hh.lineTo(Math.floor(F - .35 * A), Math.floor(A - .35 * A));
            n[C].hh.stroke()
        }
        ...
        function t(C) {
            ...
            C.hh.font = y;
            C.hh.textBaseline = cA;
            C.hh.textAlign = cB
        }

        function l(C) {
            return eC.pl() ? g2 - n[C].lZ.width - lo : eC.f7
        }

        function x(C) {
            return Math.floor(2 * lo + (eC.pl() ? dz.co + lo : 0) + eC.co + 1.3 * C * A)
        }
        var n, z, y, A, B;
        this.bh = function() {
            n = [];
        ...
        this.bz = function(C, F) {
            if (2 === fN || 0 === f3[ao] || it || !he.kw(ao)) return !1;
            var E, H = q ? A : 0,
            ...
            for (E = n.length -
                ...
                var L = n[E].lZ.width;
                if (F >= D - K && F <= D + A + K) {
                    if (C >= J - H && C <= J + A + H) return n[E].pQ || (n[E].pK = !0, n[E].pQ = !0, 0 === n[E].id ? dk ? e4.fB(ao, n[E].cE) : ia.pe(n[E].cE === b0 ? ao : n[E].cE) : dk ? e4.fD(ao, n[E].id) : ia.pf(n[E].id)), !0;
                    if (0 === n[E].id && C >= J + L - A - H && C <= J + L + H) return dk ? f9(ao, n[E].cE, eF.lB()) : ia.lC(eF.lB(), n[E].cE === b0 ? ao : n[E].cE), !0
                }
            }
            return !1
        };
        this.d7 = function() {
            if (2 !== fN && 0 !== f3[ao] && !it && he.kw(ao)) {
                var C = aW.aX(ao);
        ...
        this.c8 = function() {
            if (0 !== f3[ao] && he.kw(ao) && !it)
                for (var C = n.length - 1; 0 <= C; C--) c9.drawImage(n[C].lZ, l(C), x(C))
        }
    }

    function jm() {
        function g() {
            c9.drawImage(J, lo + (d2 ? lo + eH.pz() : 0), q0 + 2 * lo)
        }
        ...
        this.cI = function(N, G) {
            this.me(g6[N], G, 1, 0 === G ? 3 : 7)
        };
        this.me = function(N, G, M, Q) {
    ...
    function kQ() {
        function g() {
            ...
            1 === y ? (n.fillStyle = o0, n.fillRect(L, 0, L, l)) : -1 === y && (n.fillStyle = o8, n.fillRect(0, 0, L, l));
            hj(n, D, l, 2);
            L = Math.floor(.25 * l);
            L = 2 > L ? 2 : L;
            n.fillStyle = oK;
            ...
            L = Math.floor(l / 8);
            L = 2 > L ? 2 : L;
            hl(n, Math.floor(.4 * l), 0, l, L, .5, !1);
            hl(n, Math.floor(D - 1.4 * l), 0, l, L, .5, !0);
        ...
        this.bz = function(D, L) {
            if (D < r - this.bt - lo) return !1;
            var I = t();
            if (L < I || L > I + l) return !1;
            I = D > r - lo - this.bt /
                2;
            dk ? this.fL(0, I) : he.kw(ao) && 0 !== f3[ao] && ia.qE(I);
            return !0
        };
        this.d7 = function() {
            if (0 < J) J--, 0 === J && k();
                ...
                if (D) {
                    ...
                    E = 360;
                    var L = 0;
                    for (D = dQ - 1; 0 <= D; D--) he.kw(dR[D]) && (L += bM[dR[D]]);
                    B[0] = mI(ak(3 * L, 5), 1);
                    d2 && 9 !== di && (B[0] =
    ...
    function jn() {
        ...
        this.le = function() {
            q && r < .8 * s ? (this.co = Math.floor(.0536 * bi), x = r - 4 * lo - this.co) : (x = Math.floor((q ? .65 : .389) * bi), x += 12 - x % 12, this.co = Math.floor(x / 12));
        ...
        this.qQ = function() {
            n = q && r < .8 * s ? this.co + 3 * lo : Math.floor((g2 - x) / 2);
            this.f8 = c3 - this.co - (q ? 2 : 1) * lo
        };
        this.eP = function() {
            H && (H = !1, k())
        };
        this.ku = function() {
            return !(!B || fe.ld && n < Math.floor(lo + 5.5 * this.co))
        };
        this.mJ = function(J) {
            return this.ku() ? n + x > r - J - lo : !1
        };
        this.c6 = function() {
            B = !0
        };
        ...
        this.p0 = function(J, D) {
            return this.ku() && J > n && J < n + x && D > this.f8
        };
        ...
        this.d7 = function() {
            this.ku() && Math.floor(ap[ao] * C) !== F && (H = !0)
        };
        this.c8 = function() {
            this.ku() && c9.drawImage(y,
                n, this.f8)
        }
    }
    var fv, g0, g1;
    ...
    function jo() {
        ...
        this.le = function() {
            ...
            this.qQ();
            y = Math.floor(1 + t / 20);
            for (var A = 1; 0 <= A; A--) k[A].clearRect(0, 0, t, t), k[A].fillStyle = ns, k[A].beginPath(), k[A].arc(t / 2, t / 2, t / 2 - y, 0, 2 * Math.PI), k[A].fill(), k[A].lineWidth = y, k[A].fillStyle = nw, k[A].strokeStyle =
                nw, k[A].beginPath(), k[A].arc(t / 2, t / 2, t / 2 - y, 0, 2 * Math.PI), k[A].stroke(), hl(k[A], 0, 0, t, y, .3, 0 === A)
        };
        this.g3 = function() {
            return -g0 / fv
        };
        ...
        this.bz = function(y, A) {
            ...
            eJ.go() && (this.gY = !0, n = y, z = A);
            return !1
        };
        this.lV = function(y, A) {
            if (!eJ.go()) return !0;
            var B = g0,
                C = g1,
                F = n - y,
    ...
    function jp() {
        ...
        this.bh = function() {
            ...
            S.push({
                ma: "The iFrame Explosion",
                av: 98,
                ov: 99
            });
            S.push({
                ma: "The 155-Day Uptrend",
                av: 58,
                ov: 213
            });
            S.push({
        ...
        this.c8 = function() {
            ...
            I && 0 === F && (c9.fillStyle = o8, l(0)); - 1 !== H && (c9.fillStyle = oH, l(H));
            if (-1 !== H) {
                c9.font = J;
                c9.textBaseline = oN;
                P = new Date;
                ...
                var da = Math.floor(1.1 * K),
                    qa = W > c3 - da ? c3 - da : W;
                c9.fillStyle = hi;
                c9.fillRect(g2 - pa - K, qa - da, pa + K, da);
                c9.fillRect(U - ba, c3 - da, V + K, da);
                c9.fillStyle = cC;
                c9.textAlign = oO;
                c9.fillText(X, Math.floor(g2 - .5 * K), qa);
                X = qa - 2 * da;
                V = -1;
                pa = n.length - H - 1;
                for (ba = S.length - 1; 0 <= ba; ba--) pa >= S[ba].av && pa <= S[ba].ov && (-1 ===
                    V || S[ba].ov - S[ba].av < S[V].ov - S[V].av) && (V = ba); - 1 !== V && (pa = Math.floor(c9.measureText(S[V].ma).width), c9.fillStyle = hi, c9.fillRect(g2 - pa - K, X, pa + K, da), c9.fillStyle = cC, c9.fillText(S[V].ma, Math.floor(g2 - .5 * K), X + da));
                c9.textAlign = cB;
                c9.fillText(P, U, c3);
                c9.strokeStyle = nC;
                c9.lineWidth = 1;
    ...
    function jq() {
        ...
        this.qQ = function() {
            this.pl() ? this.f7 = g2 - k - lo : this.f7 = Math.floor(eA.rl() + (g2 - eA.rl() - dz.bt - k) / 2 - .5 * lo)
        };
        this.eP = function() {
            y && (y = !1, this.rk())
        };
        this.rk = function() {
            ...
            this.rm();
            this.rn();
            z.fillStyle = ap[ao] >= aq.dB(ao) ? oC : cC;
        ...
        this.d7 = function() {
            0 !== f3[ao] && 2 !== fH[ao] && A !== ap[ao] && (x = mI(ap[ao], x), B = ap[ao] > A && 10 <= ap[ao], A = ap[ao], y = !0)
        };
        this.c8 = function() {
    ...
    function jr() {
        function g() {
            ...
            rt[ao] >= V && t(rt[ao] - V, o6);
            0 !== rt[ao] && 0 === V && t(0, o5); - 1 !== X && t(X, lh);
            B.fillStyle = nw;
            B.fillRect(0, K, rp, 1);
            ...
            2 === O && (k(ao), B.textAlign = mN, l(y - 1, rt[ao], ao), B.textAlign = oO, x(y - 1, ao));
        ...
        function k(R) {
            d2 && (B.fillStyle = dO.sR[dO.iW[dO.dP[R]]])
        }
        ...
        function n(R) {
            ...
            if (R < (y - 1) * J) return Math.floor(R / J);
            if (R < q0 - K) return y -
                1;
            R -= q0 - K;
        ...
        function z(R, O) {
            return R >= lo && R < lo + rp && O >= lo && O < lo + q0
        }
        var y, A, B, C, F, E, H, K, J, D, L, I, N, G, M, Q, S, P, U, W, X, V, pa, ba, da, qa;
        this.bh = function() {
            var R, O;
            pa = 0;
            ba = !1;
            ...
            for (R = b0 - 1; 0 <= R; R--)
                if (S[R] =
                    R + 1 + ".", G[R] = R, M[R] = Math.floor(B.measureText(g6[R]).width), M[R] > T) {
                    var Z = g6[R];
        ...
        function g() {
            ...
            for (var P = 0, U = 0; U < D.length; U++)
                if (I[U]) {
                    ...
                    z.textAlign = oO;
                    5 === U && 0 !== f3[ao] &&
                        ap[ao] >= aq.dB(ao) ? (z.fillStyle = oL, z.fillText(k(U), dz.bt - F, W), z.fillStyle = cC) : z.fillText(k(U), dz.bt - F, W)
                } else P++
        }
    ...
    function jt() {
        ...
        this.le = function() {
            if (g) {
                ...
                t = qJ(t, mI(r - 2 * lo, 10));
                t = qJ(t, Math.floor(3.57 * mI(s - 2 * lo, 3)));
                l = Math.floor(.28 * t);
                A = document.createElement("canvas");
                A.width = t;
                A.height = l;
        ...
        this.show = function(C, F) {
            g || (k = C ? 1 : 2, g = !0, this.le(), he.lW(), eF.qF(), B = bw.gQ, -1 === this.tA &&
        ...
        this.c8 = function() {
            !g || 0 >= y || (c9.globalAlpha = y, c9.drawImage(A, Math.floor((g2 - t) / 2), c3 - l - 2 * lo), c9.globalAlpha = 1)
        }
    }
    ...
    function dS(g, k, t) {
        if (!(!d2 || 0 === f3[g] || 0 === f3[k] || 0 > t || t > ap[g] || g === k || cZ(g, k) || g < ci && k < ci && 7 > di && 1071 > bw.dM())) {
            ...
            t -= t >= ak(ap[g], 2) ? l : 0;
            var x = bM[k] * is - ap[k];
            0 >= x || (t = t > x ? x : t, g === ao && (dx.mq(t, k), as.at[12] += l, as.at[16] += t), k === ao && (dx.ms(t, g), as.at[10] += t), ap[g] -= t + l, ap[k] += t)
        }
    }
    ...
    function tR() {
        ...
        this.tT = [0, 0, 0, 0];
        this.tU = function() {
            this.iq = this.iq || this.gx;
            if (this.gx || this.tS && this.iq) {
                var g = gm.tV[0],
                    k = gm.tV[1],
                    t = gm.tV[2],
                    l = gm.tV[3];
                ...
                this.tS = this.gx = !1;
                g === this.tT[0] && k === this.tT[1] && t === this.tT[2] && l === this.tT[3] ? this.ir() : t >= g && l >= k && jG.putImageData(jH, 0, 0, g, k, t - g + 1, l - k + 1)
            }
        };
        this.ir = function() {
        ...
        this.ij = function() {
            this.tT[2] >= this.tT[0] && this.tT[3] >= this.tT[1] && jG.putImageData(jH, 0, 0, this.tT[0], this.tT[1], this.tT[2] - this.tT[0] + 1, this.tT[3] - this.tT[1] + 1);
            this.iq = !1
        };
        this.bh = function() {
            var g;
    ...
    function tX() {
        ...
        this.bn = function() {
            bw.gQ -
                12E4 >= t[this.tY] && (t[this.tY] = bw.gQ, this.tn = [0, 0], e1.rG(0, 1 + this.tY) && ia.to(0, this.tY))
        };
        this.le = function() {
            var l;
            this.bt = this.tp(q ? .85 : .66, .75, r, s);
            this.co = Math.floor(this.bt / .75);
            for (l = 1; 0 <= l; l--) this.lv[l] && (this.lv[l][4] = bl + Math.floor(this.lv[l][5] * this.co / 10) + bm);
        ...
        this.tw = function(l) {
            this.lv[l][0].sort(function(x, n) {
                return n.value - x.value
            })
        };
        this.ty = function(l, x, n, z) {
            if (this.lv && this.lv[l]) {
                var y, A = !1,
                    B = 383 / 384;
                if (0 === l) {
                    for (y = 0; y < this.lv[l][0].length; y++)
                        if (x === this.lv[l][0][y].mf && n > .99 * this.lv[l][0][y].value && n < 1.01 * this.lv[l][0][y].value) {
                            this.lv[l][0][y].value =
                                z;
                            A = !0;
                            break
                    ...
                    for (y = 0; y < this.lv[l][0].length; y++)
                        if (x === this.lv[l][0][y].mf) {
                            this.lv[l][0][y].value += 32 < this.lv[l][0][y].value ? (64 - this.lv[l][0][y].value) / 256 : .25;
                            this.lv[l][0][y].value *= 1 / B;
                            A = !0;
                            break
                        } for (y = 0; y < this.lv[l][0].length; y++) this.lv[l][0][y].value *= B;
                    A || this.lv[l][0].push({
                        mf: x,
                        value: .25
                    })
        ...
        this.tv = function(l, x, n) {
            for (var z = l.length - 1; 0 <= z; z--)
                for (; 3 < l[z].mf.length && bu.measureText(l[z].mf, x) > n;) l[z].mf = l[z].mf.substring(0, l[z].mf.length -
                    4) + "..."
        };
        this.bz = function(l, x) {
            ...
            l -= (g2 - this.bt) / 2;
            x -= (c3 - this.co) / 2;
            if (0 > l || l > this.bt || 0 > x || x > this.co) return this.ku = !1, 0 === jT.rc() && jV.c6(0, !0), bw.bx = !0;
            ...
            t[this.tY] = bw.gQ;
            e1.rG(0, 1 + this.tY) && ia.to(0, this.tY);
            return !0
        };
        this.c8 = function() {
            if (this.ku) {
                ...
                c9.lineTo(this.bt / 4, y);
                c9.fill();
                this.lv[this.tY] && this.u4(A);
                this.u5(A);
                c9.setTransform(1, 0, 0, 1, 0, 0)
            }
        };
        this.u5 = function(l) {
            var x = mI(2, Math.floor(.06 * this.bt));
            x -= x % 2;
            var n = mI(2, Math.floor(.01 * this.bt));
            n -= n % 2;
            l = Math.floor(.82 * l);
            c9.fillRect(x, l, x, n);
            c9.fillRect(this.bt -
        ...
        this.u4 = function(l) {
            c9.font = this.lv[this.tY][4];
            for (var x, n = this.lv[this.tY][1] - 1; 0 <= n; n--) c9.textAlign = oO, x = Math.floor(this.ti * this.co + l + n * ((1 - 2 * this.ti) * this.co - l) / 9), c9.fillText(this.lv[this.tY][0][n].value.toFixed(this.lv[this.tY][3]), Math.floor(this.th * this.bt), x), c9.fillText(n + 1 + this.lv[this.tY][6] + ".", Math.floor(this.tf * this.bt), x), c9.textAlign = mN, c9.fillText(this.lv[this.tY][0][n].mf, Math.floor(this.tg * this.bt),
                x)
        }
    }
    ...
    function u6() {
        ...
        this.bh = function(H, K) {
            if (13 <= d) K ? F = H : F === H && e.saveString(200, H);
                ...
                (c4.lv[1].iR.ku || c4.lv[2].iR.ku) && c4.uG();
                jO.tG();
                F = H;
        ...
        this.bz = function(H, K) {
            if (!this.ku) return !1;
            if (H < g || K < k || H > g + C || K > k + l) bw.bx = !0, this.ku = !1, document.body.removeChild(E), 0 === jT.rc() &&
                jV.c6(0, !0);
            return !0
        };
        this.c8 = function() {
            this.ku && (c9.imageSmoothingEnabled = !0, c9.setTransform(1, 0, 0, 1, g, k), c9.fillStyle = hi, c9.fillRect(0, 0, C, l), c9.lineWidth = ob, c9.strokeStyle = cC, c9.strokeRect(0, 0, C, l), c9.setTransform(t, 0, 0, t, g + (C - A) / 2, k + z), c9.drawImage(bo.br(17), 0, 0), c9.setTransform(1, 0, 0, 1, 0, 0))
        }
    }
    ...
    function uH() {
        ...
        this.bz = function(y, A, B) {
            if (!n || !this.ku()) return !1;
            var C;
            for (C = x.length - 1; 0 <= C; C--)
                if (x[C] && this.uI[C] && y > k[C] && A > t[C] && y < k[C] + l[C] * n[C].width && A < t[C] + l[C] * n[C].height) return n9.bh(z[C], B), !0;
            return !1
        };
        this.c8 = function() {
            if (n && this.ku()) {
    ...
    function ju() {
        function g(x) {
            ...
            c9.font = n.font;
            c9.fillStyle = t;
            c9.fillText(n.nD, Math.floor(x + y / 2), Math.floor(z + A / 2 + .1 * n.bq))
        }
        var k, t, l;
        ...
        this.lV = function(x, n, z) {
            var y = -1;
            0 === jT.rc() ? y = this.p0(x, n, 0, 2) : 3 === jT.rc() ? y = this.p0(x, n, 3, 1) : 5 === jT.rc() && (y = this.p0(x, n, 5, 2));
            k !== y && (k = y, z && (bw.bx = !0));
            return -1 !== y ? (jQ.p5(), !0) : !1
        };
    ...
    function uY() {
        ...
        this.co = this.bt = 0;
        this.ku = !1;
        this.uc = this.ub = this.ua = this.nX = this.eu = this.uZ = 0;
        this.colors = null;
        this.bh = function() {
        ...
        this.bz = function(k, t) {
            ...
            k -= (g2 - this.bt) / 2;
            t -= l;
            if (0 > k || 0 > t || k >= this.bt - 1 || t >= this.co - 1) return this.ku = !1, 0 === jT.rc() && jV.c6(0, !0), bw.bx = !0, !1;
            if (k < this.eu || t < this.eu || k >= this.bt - this.eu || t >= this.co - this.eu) return !0;
            if (k < this.eu + this.ua) return t < this.eu + this.ua && 0 !== this.nX && (this.nX = 0, bw.bx = !0), !0;
            if (k < 2 * this.eu + this.ua) return !0;
            k -= 2 * this.eu + this.ua;
            if (t < this.eu + this.uc) return this.uZ = 1, this.colors[this.nX][0] = g(256 * k / this.ub), bw.bx = !0;
            if (t < 2 * this.eu + this.uc) return !0;
            if (t < 2 * this.eu + 2 * this.uc) return this.uZ = 2, this.colors[this.nX][1] = g(256 * k / this.ub), bw.bx = !0;
            t >= 3 * this.eu + 2 * this.uc && (this.uZ = 3, this.colors[this.nX][2] = g(256 * k / this.ub), bw.bx = !0);
            return !0
        };
        this.uf = function() {
        ...
        this.lV = function(k) {
            0 !== this.uZ && (k -= 2 * this.eu + this.ua + (g2 - this.bt) / 2, this.colors[this.nX][this.uZ - 1] = g(256 * k / this.ub), bw.bx = !0)
        };
        this.ui = function() {
        ...
        this.uk = function(k) {
            ...
            c9.fillRect(2 * this.eu + this.ua, this.eu + k * (this.eu + this.uc), Math.floor(this.colors[this.nX][k] * this.ub / 255), this.uc);
            c9.strokeStyle = cC;
    ...
    function jv() {
        function g() {
            J++;
            K = bw.gQ;
            e1.rG((J + D) % e1.uw, 4) && (L = !0, ia.ux((J + D) % e1.uw))
        }
        ...
        this.bz = function(I, N) {
            ...
            return I > G && I < G + y && N > M && N < M + A ? (jO.bh(), jR.lV(I, N, !1), bw.bx = !0) : !1
        };
        this.rI = function(I) {
            6 !== jT.rc() || L || (K = bw.gQ, L = !0, ia.ux(I))
        };
        this.d7 = function() {
            6 === jT.rc() && (L ? bw.gQ > K + 2E4 && jU.v3(3250) : bw.gQ > K + 2E4 &&
    ...
    function jw() {
        ...
        this.vE = function() {
            return n9.kx() || c4.uG() ? !0 : c5.ku ? (c5.ku = !1, !0) : !1
        };
        this.bz =
            function(k, t) {
        ...
        this.lV = function(k, t) {
            ...
            if (!jQ.rE) {
                ...
                if (jR.lV(k, t, !0)) return
            }
            jQ.lV(k, t)
        };
        this.lI = function(k, t) {
            jQ.p6();
    ...
    function jx() {
        function g() {
            var n = jT.rc();
            0 === n ? jO.tG() : 6 === n ? e1.vU(t) : 7 === n ? (jc.tG(), e1.close(e1.mi, 3240)) : 8 === n && (jL(), jO.tG());
            jT.setState(3);
            jR.rO();
            jR.uO[2].nD = k(t);
            bw.bx = !0
    ...
    function jy() {
        ...
        this.le = function() {
            var x = Math.floor(.22 * jR.co);
            k[0].input.style.font = bl + x + bm;
            k[0].input.style.padding = Math.floor(.3 * x) + "px 5px";
            k[0].input.style.width = jR.bt - 13 + "px"
        };
        this.br = function(x) {
            return k[x]
        };
        this.rO = function(x) {
            k[x].input.style.left = Math.floor((g2 - (jR.bt - 3) - 7) / 2) + "px";
            0 === x && (k[x].input.style.bottom = Math.floor(c3 - jR.f8 + jR.eu) + "px")
        };
        this.c6 = function(x, n) {
            k[x].ku !== n && ((k[x].ku = n) ? document.body.appendChild(k[x].input) : document.body.removeChild(k[x].input))
        };
    ...
    function kR() {
        ...
        this.eN = function() {
            0 < l && bw.gQ > t && (l--, t += 4500, 0 === bw.vl && 0 === bw.vm && e1.rG(e1.jM, 5))
        };
        this.vn = function() {
            10 === jT.rc() && (k++, 2 <= k && (ja.vo(g), g = null))
        }
    }
    ...
    function kO() {
        ...
        function x(P, U) {
            ...
            for (X = 0; X < y[1]; X++) {
                var ba = A;
                for (W = 0; W < y[0]; W++) {
                    if (P > ba && P < ba + n && U > pa && U < pa + n) return ia.wh(E[V].wS), K = E[V].wS !== K ? E[V].wS : -1, bw.bx = !0;
                    V++;
        ...
        this.bh = function() {
            ...
            for (P = 0; 7 > P; P++) {
                ...
                W.clearRect(0, 0, 48, 48);
                for (var V = 0; V < U; V++) {
                    var pa = X + 2 * Math.PI / U;
                    var ba = X,
                        da = pa,
                        qa = W;
                    qa.fillStyle = dO.wJ[V + 1];
                    qa.beginPath();
                    qa.arc(24, 24, 23, ba, da);
                    qa.lineTo(24, 24);
                    qa.fill();
                    0 !== V && k(24, 23, X, W);
                    X = pa
        ...
        this.c8 =
            function() {
                ...
                0 <= K ? (c9.fillStyle = o1, c9.fillRect(r - J - c2, c2, J, Math.floor(.25 * D))) :
                    (c9.fillStyle = oM, c9.fillRect(r - J - c2, c2 + Math.floor(.25 * D), J, Math.floor(.25 * D)));
                c9.strokeStyle = cC;
                ...
                X = Math.floor(.08 * D);
                for (var V = 3; 0 <= V; V--) {
                    var pa = Math.floor(c2 + (V + 1) * (D + 2 * X) / 5 - X);
                    c9.textAlign = mN;
                        ...
                        for (W = 0; W < y[0]; W++) {
                            ...
                            if (K === E[V].wS) {
                                ...
                                var R = da,
                                    ...
                                    T = Math.floor(.3 * O);
                                c9.fillStyle = o3;
                                c9.fillRect(qa + z - O, R, O, O);
                                c9.fillStyle = g5;
                                c9.fillRect(qa + z - O, R, 2, O);
                                c9.fillRect(qa + z - O, R + O - 2, O, 2);
                                fe.ls(qa + z - O + T, R + T, O - 2 * T);
                                c9.setTransform(1, 0, 0, 1, 0, 0);
                                c9.lineWidth = 3;
                                c9.fillStyle = o3
                            } else c9.fillStyle = ns;
                            R = Math.floor(n / 4);
    ...
    function jz() {
        ...
        this.bz = function(g, k) {
            var t = jR.p0(g, k, 5, 2);
            5 === t ? aC() : 6 === t && (jO.bh(), jR.lV(g, k, !1), bw.bx = !0)
        }
    }
    ...
    function k0() {
        ...
        this.j6 = function() {
            for (var t = 0, l = this.dm.length - 1; 0 <= l; l--) t += this.dm[l].ma;
            return t
        };
        this.lV = function(t, l) {
            return jd.ku && jd.lV(t, l) ? !0 : -1 === this.p0(t, l) ? !1 : !0
        };
        this.ws = function() {
            e1.jM = 0;
            e1.rG(0, 3) && ia.wt(0);
            ...
            t = 0 > t ? 7 : t;
            j1(Math.floor(16384 * Math.random()), 0, [{
                mf: jO.wu(),
                id: 0,
                wv: c4.lv[2].iR.ug(),
                ww: 0
        ...
        this.bz = function(t, l) {
            if (c5.ku || c4.lv[1].iR.ku || c4.lv[2].iR.ku) return !1;
            if (jd.ku) return jd.bz(t, l);
            var x = this.p0(t, l);
            if (-1 === x) return !1;
            if (0 === x) return this.vV(), !0;
            if (1 === x) return jd.show(), !0;
            if (2 === x) return this.ws(), !0;
            if (27 === x) return 8 > this.dm.length && (this.dm.push({
                b5: 0,
                ma: b0
            }), this.wr(), this.le(), bw.bx = !0), !0;
            var n = Math.floor((x - 3) / 3);
            if (0 === x % 3) return 1 < this.dm.length &&
                (this.dm.splice(n, 1), this.le(), bw.bx = !0), !0;
            var z = (k[2] - k[2] / 10 - 2 * c2) / 2;
            if (1 === x % 3) {
                if (0 === n && 1 === this.dm[n].ma) return !0;
            ...
            y = 0 === y ? 1 : y;
            z = b0;
            for (x = this.dm.length - 1; 0 <= x; x--) n !== x && (z -= this.dm[x].ma);
            if (0 > y) {
                if (1 === this.dm[n].ma) return this.dm[n].ma = z, !0
            } else if (this.dm[n].ma === z) return this.dm[n].ma =
                1, !0;
            this.dm[n].ma += y;
            1 > this.dm[n].ma ? this.dm[n].ma = 1 : this.dm[n].ma > z && (this.dm[n].ma = z);
            return !0
        };
        this.wr = function() {
            for (var t = Math.floor(b0 / this.dm.length), l = b0 % this.dm.length, x = this.dm.length - 1; 0 <= x; x--) this.dm[x].ma = t;
            this.dm[0].ma += l
        };
        ...
        this.c8 = function() {
            ...
            for (t = 0; t < this.dm.length; t++) {
                ...
                g(k[0] + n + c2, z, l, n, hi, .4, this.wy(t), this.dm[t].b5, -1);
                g(k[0] + k[2] - l, z, l, n, hi, .4, this.wz(t), -1, this.dm[t].ma)
            }
            if (8 > this.dm.length) {
                ...
                t = k[0];
                c9.fillStyle = cC;
                l = mI(2, Math.floor(.5 * n));
                l -= l % 2;
                x = mI(2, Math.floor(.1 * n));
                x -= x % 2;
                n = Math.floor((n - l) / 2);
    ...
    function oi() {
        ...
        this.rO = function() {
            ...
            this.bt += 4 - this.bt % 4;
            this.lv[0].f7 = c2;
            this.lv[0].f8 = c3 - this.bt - c2;
            for (var g = 1; g < this.av; g++) this.lv[g].f7 = this.lv[g - 1].f7 + Math.floor(q ? 1.5 * c2 : 3.7 * c2) + this.bt, this.lv[g].f8 = this.lv[0].f8
        };
        this.p0 =
            function(g, k) {
                if (!bo.bp()) return -1;
                for (var t = this.av - 1; 0 <= t; t--)
                    if (g >= this.lv[t].f7 && k >= this.lv[t].f8 && g < this.lv[t].f7 + this.bt && k < this.lv[t].f8 + this.bt) return t;
                return -1
            };
        this.x2 = function() {
            for (var g = 2; 1 <= g; g--)
                if (this.lv[g].iR.ku) return !0;
            return !1
        };
        this.uG = function() {
            return this.lv[1].iR.ku ? (this.lv[1].iR.bz(-5E3, -5E3, 0), !0) : this.lv[2].iR.ku ? (this.lv[2].iR.bz(-5E3, -5E3), !0) : !1
        };
        this.bz = function(g, k, t) {
            if (t) {
                if (this.lv[1].iR.ku) return this.lv[1].iR.bz(g, k, 0), !0;
                if (this.lv[2].iR.ku) return this.lv[2].iR.bz(g,
                    k), !0
            }
            g = this.p0(g, k);
            if (t) {
                if (0 === g) return this.lv[g].lk = !this.lv[g].lk, q = this.lv[g].lk, jb.x3(), a1(this.lv[0].lk, !1), !0;
                if (1 <= g && 3 > g) return this.lv[g].iR.bh(), jO.tG(), bw.bx = !0
            }
            return !1
        };
        this.lV = function(g, k) {
            return this.lv[1].iR.ku ? (this.lv[1].iR.lV(g, k), !0) : this.lv[2].iR.ku ? (this.lv[2].iR.lV(g), !0) : !1
        };
        this.ui = function() {
            for (var g = 2; 1 <= g; g--)
                if (this.lv[g].iR.ku) return this.lv[g].iR.ui(), !0;
            return !1
        };
        this.c8 = function() {
            if (bo.bp()) {
                ...
                for (var g = this.av - 1; 0 <= g; g--) c9.fillStyle =
                    this.lv[g].lk ? mF : hi, c9.fillRect(this.lv[g].f7, this.lv[g].f8, this.bt, this.bt), 0 === g ? this.x4(g, bo.br(15)) : 1 === g ? this.x5() : 2 === g && this.x6(), c9.setTransform(1, 0, 0, 1, 0, 0), c9.lineWidth = ob, c9.strokeStyle = cC, c9.strokeRect(this.lv[g].f7, this.lv[g].f8, this.bt, this.bt);
                c9.imageSmoothingEnabled = !1
            }
        };
        this.x4 = function(g, k) {
            ...
            c9.setTransform(l, 0, 0, l, this.lv[g].f7 + t, this.lv[g].f8 + (this.bt - l * k.height) / 2);
            c9.drawImage(k, 0, 0)
        };
        this.x5 = function() {
            var g = .06 * this.bt,
                k = (this.bt - 2 *
                    g) / a5.bt;
            c9.setTransform(k, 0, 0, k, this.lv[1].f7 + g, this.lv[1].f8 + g);
            c9.drawImage(a5.kn[4], 0, 0)
        };
        this.x6 = function() {
            c9.setTransform(1, 0, 0, 1, this.lv[2].f7, this.lv[2].f8);
    ...
    function k1() {
        ...
        function t() {
            ...
            var n = x.split(" ");
            if (2 !== n.length) return k(), jU.v3(3266), !0;
        ...
        function l() {
            if (void 0 !== x && m.i7(x)) return jV.va(0, !0), !0;
            jV.va(0, !1);
            return !1
        }
        var x;
        ...
        this.xA = function(n) {
            return 0 === n ? jR.bt : 1 === n ? Math.floor(.3 * jR.co) : 2 === n ? jV.br(0).input.style.font : x
        };
        this.vZ = function() {
            x = jV.br(0).input.value.trim();
            l();
        ...
        this.c8 = function() {
            if (this.xK()) {
                c9.imageSmoothingEnabled = !0;
                var n = bo.kr("territorial.io"),
                    z = 1.1 * jR.bt / n.width;
                c9.setTransform(z, 0, 0, z, Math.floor((g2 - z * n.width) / 2), jR.f8 - z * n.height - .72 * jR.co);
                c9.drawImage(n, 0, 0);
                c9.setTransform(1, 0, 0, 1, 0, 0);
                jR.uS()
            }
    ...
    function k2() {
        function g(n, z, y, A) {
            ...
            t[n].onload = function() {
                ...
                k--;
                bo.bp() && (tx.bn(), he.kj(), a5.bh(), vG.uJ([t[8], t[16], t[7], t[9], t[10]], [!b, 0 === d, !0, !0, !0]), bw.bx = !0, t[7] = x, t[8] = x, t[9] = x, t[10] = x)
            };
            t[n].src = A
        }
        var k, t, l, x;
    ...
    function k3() {
        ...
        this.bh = function(D) {
            ...
            J[3] = -J[1];
            if (d2)
                for (var L, I = b0 - 1; 0 <= I; I--) L = dO.iW[dO.dP[I]], D = ak((x[L][3] + 1) * cW.random(), cW.value(100)), n[I] = l[L][0] + D * x[L][0], z[I] = l[L][1] + D * x[L][1], y[I] = l[L][2] + D * x[L][2];
            else {
    ...
    function k4() {
        ...
        function t() {
            z[0] = nickname + ' ' + (nickname.length <= 16 ? Math.floor(1E3 * Math.random()) : '');
                ...
                if (0 === f3[ao] || aW.yT(ao) === aW.aX(ao)) k = 0;
                    ...
                    for (l = k - 2; 0 <= l; l -= 2) {
                        ...
                        if (x < b0 && 0 === f3[x]) g(l);
                            ...
                            var n = t[l + 1];
                            if (x >= b0 && lO(ao) || x < b0 && lT(ao, x)) dk ? f9(ao, x, n) : ia.lC(n, x === b0 ? ao : x), g(l)
                        }
                    }
                }
        };
        this.lF = function(l, x) {
            var n;
            a: {
                for (n = 0; n < k; n += 2)
                    if (t[n] === l) {
    ...
    function k5() {
        ...
        this.cI = function(y, A, B) {
            ...
            z[F + l[y]] = 0;
            l[y]++;
            y < ci && (B === ao ? dx.fZ(y, 5) : y === ao && dy.mR(B))
        };
    ...
    function k7() {
        ...
        function k() {
            ...
            for (var O = g0 / fv, T = g1 / fv, Y = (g2 + g0) / fv, Z = (c3 + g1) / fv, ma, na, la, ka, ra, va = 0 !== f3[ao] && he.kw(ao), Aa = dQ - 1; 0 <= Aa; Aa--)
                if (la = dR[Aa], ka = Math.floor(Q * fv * J[la] * H[la]), !(ka < M || ka >= L) && F[la] + H[la] > O && F[la] < Y && E[la] + K[la] > T && E[la] < Z) {
                    ...
                    ra.fillStyle = sa;
                    V.fillText(8 === di ? eD.g7(ap[la]) : g6[la], ma, na);
                    W = !0;
                    if (0 < da[la]) {
                        ra = ma;
                        sa = na;
                        ...
                        if (0 === rt[ta])
                            if (a5.nq(ba[ta])) {
                                ...
                                ta = ba[ta];
                                var xa = .9 * ua / a5.bt,
                                    Da = Math.floor(sa - .5 * xa * a5.bt - .05 * ua);
                                V.globalAlpha = x(ua);
                                for (var Ca = Math.floor(Ba - .5 * ua / D[za] - .4 * ua - xa * a5.bt), ya = 0; 2 > ya; ya++) V.setTransform(xa, 0, 0, xa, Ca, Da), V.drawImage(a5.kn[ta], 0, 0), Ca = Math.floor(Ba +
                                    .5 * ua / D[za] + .4 * ua);
                                V.globalAlpha = 1;
                                V.setTransform(1, 0, 0, 1, 0, 0);
                                t(ra, sa, wa, 0, 0)
                            } else a5.np(ba[ta]) ? (l(ra, sa, wa, ba[ta], 0), t(ra, sa, wa, 0, 1)) : (l(ra, sa, wa, ba[ta], 1), t(ra, sa, wa, 1, 0));
                        else l(ra, sa, wa, ba[ta], 0)
                    } else 0 === rt[la] && t(ma, na, ka, 0, 0);
                    if (va && (0 < da[la + b0] || 0 < da[la + 2 * b0] || 0 < da[la + 3 * b0] || 0 < da[la + 4 * b0])) {
                        sa = ma;
                        wa = na;
                        Ba = ka;
                        ua = la;
                        za = -1;
                        for (ra = 4; 1 <= ra; ra--) 0 < da[ua + ra * b0] && za++;
                        for (ra = 1; 5 > ra; ra++) 0 < da[ua + ra * b0] && (ta = Ba, xa = ra, Da = ua, Ca = da[ua + ra * b0], ya = .8 * ta / a5.bt, V.setTransform(ya, 0, 0, ya, Math.floor(sa - .5 * ya *
                            a5.bt - .534 * za * ta), Math.floor(wa + 1.4 * ya * a5.bt)), V.globalAlpha = x(ta), V.drawImage(1 === xa ? a5.kn[ba[Da + b0]] : 2 === xa && 255 > Ca ? he.kl[2] : he.kk[xa + 3], 0, 0), V.globalAlpha = 1, V.setTransform(1, 0, 0, 1, 0, 0), za -= 2)
                    }
                    ra = Math.floor(N * ka);
                    ra < M || (V.font = bl + ra + bm, V.fillText(8 === di ? g6[la] : eD.g7(ap[la]), ma, na + Math.floor(.78 * ka)))
                }
        }

        function t(O, T, Y, Z, ma) {
            var na = .95 * Y / R;
            V.setTransform(na, 0, 0, na, Math.floor(O - .5 * na * qa + .8 * Z * Y), Math.floor(T - 1.76 * na * R - .82 * ma * Y));
            V.globalAlpha = x(Y);
        ...
        function l(O, T, Y, Z, ma) {
            var na = 1.2 * Y / a5.bt;
            V.setTransform(na, 0, 0, na, Math.floor(O - .5 * na * a5.bt - .8 * ma * Y), Math.floor(T - 1.5 * na * a5.bt));
            V.globalAlpha = x(Y);
            V.drawImage(a5.kn[Z], 0, 0);
            V.globalAlpha = 1;
            V.setTransform(1, 0, 0, 1, 0, 0)
        }
        ...
        function z(O, T, Y, Z, ma) {
            var na;
            for (na = T + Z - 1; na >= T; na--)
                if (!y(O, na, Y, ma)) return !1;
            var la = Math.floor(.25 * ma);
            la = 1 > la ? 1 : la;
            for (na = Y + ma - 1 - la; na >= Y + la; na--)
                if (!A(O, T, na, Z)) return !1;
            return !0
        }

        function y(O, T, Y, Z) {
            return ax.hW(O, 4 * (Y * aR + T)) && ax.hW(O, 4 * ((Y + Z - 1) * aR + T))
        }

        function A(O, T, Y, Z) {
            return ax.hW(O, 4 * (Y * aR + T)) && ax.hW(O, 4 * (Y *
                aR + T + Z - 1))
        }
        ...
        this.bh = function() {
            ...
            if (8 === di) {
                ...
                for (V.font = bl + Math.floor(100 * N) + bm, T = 80 / Math.floor(V.measureText(eD.g7(iv)).width), V.font = bl + 100 + bm, O = b0 - 1; 0 <= O; O--) D[O] = 100 / Math.floor(V.measureText(g6[O]).width), J[O] = T < D[O] ? T : D[O];
        ...
        this.ip = function() {
            for (var O = pa = 0; O < ci; O++) 3 !== cr[O] - cs[O] || 3 !== cu[O] - cv[O] ?
                (F[O] = cs[O] + (cr[O] !== cs[O] ? 1 : 0), E[O] = cv[O], H[O] = 1, K[O] = 1) : (F[O] = cs[O], E[O] = cv[O] + 1, H[O] = 4, K[O] = 2)
        };
        this.mk = function(O, T, Y) {
            0 === f3[O] || 4 !== T && 2 === fH[O] || (O += T * b0, 0 === T ? ba[O] === Y && 0 < da[O] ? da[O] = 0 : (ba[O] = Y, da[O] = a5.nq(Y) ? 255 : 64) : 1 === T ? (da[O] = 64, ba[O] = Y) : da[O] = Y)
        };
        this.c8 = function() {
        ...
        this.eP = function() {
            return 0 >= --pa ? (pa = 4 >= sL ? 10 : 12 > sL ? 5 : 2, k(), !0) : !1
        };
        this.g4 = function(O) {
            return J[O]
        };
        this.d7 = function() {
            ...
            for (Y = B + O - 1; Y >= B; Y--)
                if (T = Y % dQ, T = dR[T], 0 < H[T] && z(T, F[T], E[T], H[T], K[T])) {
                    ...
                    a: {
                        ma = T;na = F[ma] + 1;la = E[ma] + 1;
                        for (ka = H[ma] - 2;;) {
                            if (1 > ka) {
                                H[ma] = 0;
                                break
                            }
                            Z = 1 + Math.floor(G * J[ma] * ka);
                            if (z(ma, na, la, ka, Z)) {
                                F[ma] = na;
                                E[ma] = la;
                                H[ma] = ka;
    ...
    var g6, a0A, f3, cs, cv, cr, cu, bM, hJ, ap, aw, bE, bF, bI, fH;
    ...
    function j8(g) {
        ...
        for (var k = g.length - 1; 0 <= k; k--) g6[k] = g[k].mf, fH[k] = g[k].ww
    }
    ...
    function kW() {
        ...
        this.d7 = function() {
            dk || (80 === this.nE && this.a0N(), this.nE = (this.nE + 1) % 100)
        };
        this.a0N = function() {
            var g, k = this.hs;
    ...
    function kS() {
        ...
        this.bh = function() {
            ...
            var n = cW.a0B(0);
            cW.j7(0);
            for (x = 1; x < this.uw - 1; x++) t[x] = m.iK() + ".com";
            cW.j7(n);
            k = Array(this.uw);
            l = Array(this.uw);
        ...
        this.d7 = function() {
            for (var x = this.uw - 1; 0 <= x; x--) this.us(x) && bw.gQ > l[x].gQ + 15E3 && ia.a0W(x, l[x].a0V)
        };
        ...
        this.a0d = function(x, n) {
            0 === n ? jQ.rI() : 3 > n ? ia.to(x, n - 1) : 3 === n ? ia.wt(x) : 4 === n ? jS.rI(x) : 5 === n ? x === this.jM && ia.a0e() : 6 === n ? ia.a0f(x) : 7 === n && ia.xI(x)
        };
        this.us = function(x) {
    ...
    function a0k() {
        for (var g, k = dQ - 1; 0 <= k; k--) bM[dR[k]] <= ak(hJ[dR[k]], 4) ? 1E3 >= bM[dR[k]] && (2 !== f3[dR[k]] || 0 === bM[dR[k]]) && fa(dR[k]) : bM[dR[k]] >= hJ[dR[k]] ? hJ[dR[k]] = bM[dR[k]] : (g = ak(hJ[dR[k]] - bM[dR[k]], 1E3), hJ[dR[k]] -= 1 > g ? 1 : g)
    }
    ...
    function a12(g) {
        a0p || (a0p = !0, g.message ? (a0u = g.lineno, a0v = g.message, e1.rG(0, 6) && ia.a0f(0), g = "[A_ERROR " + a0u + "][" + a0v + "]", a1A(g)) : (g = "[B_ERROR " + g.type + "][" + (g.srcElement || g.target) + "]", console.log(g)))
    }
    ...
    function k9() {
        ...
        this.d7 = function() {
            if (9 ===
                di) {
                var k;
                for (k = g.length - 1; 0 <= k; k--) 0 >= --g[k].ma && (dy.mk(g[k].player, 0, 46), g.splice(k))
            }
        }
    }
    var aR, aS, hc, pH, wb, wc, mt, wR, vD, a1J = 14,
        we;
        ...
        this.d7 = function() {
            if (8 === jT.rc() && eJ.gR()) this.rB = setTimeout(g, 16);
                ...
                if (0 === this.aA) {
                    ...
                    jY.jD([aR, aS, jX.br(mt).a1i[0], jX.br(mt).a1i[1]]);
                    cW.j7(l);
                    this.a1d = jY.a1k();
                    this.aA++;
                    if (this.a1e) {
                        this.rB = setTimeout(g, 16);
                        return
                    }
                }
                l = this.a1e ? 10 : 1E6;
                l =
                    aS - this.a1X - 1 < l ? aS - this.a1X - 1 : l;
                l = this.a1X + l;
                ...
                this.a1X >= aS - 1 ? (pH.putImageData(wb, 0, 0, 1, 1, aR - 2, aS - 2), bw.bx = !0, this.wf()) : this.a1e && (this.rB = setTimeout(g, 16))
            }
        };
                ...
                for (var C = n; C <= y; C++)
                    if (z = 4 * (C + B * aR), t(z)) {
                        ...
                        if (!(Math.abs(l - C) > F || Math.abs(x - B) > F)) {
                            ...
                            E >= F || this.a1r(z, E, F, 1, this.qT[3])
                        }
                    } else F = this.a1a + (this.a1b - this.a1a) * this.a1d[C + aR * B] / 1E4, Math.abs(l - C) > F || Math.abs(x - B) > F || (E = Math.sqrt((l - C) *
                        (l - C) + (x - B) * (x - B)), E >= F || this.a1r(z, E, F, 0, this.qT[2]))
        }
    }
    ...
    function kA() {
        ...
        this.bh = function() {
            ...
            g[2] = {
                ...
                mm: [80, 80, 190, 90, 40, 40, 248, 180, 180, 90, 140],
        ...
        this.a1Q = function() {
            ...
            jX.a2B() && bo.bp() && jX.a2B() && (t = bo.kr("arena"), pH.save(), pH.globalAlpha = 1 === mt ? .1 : 1, pH.imageSmoothingEnabled = !0, k = 2.8, pH.scale(k, k), pH.drawImage(t, Math.floor((aR / k - t.width) / 2), Math.floor(.5 * aS / k - t.height / 2)), pH.restore(), t = bo.kr("territorial.io"), pH.save(), pH.globalAlpha = 1 === mt ? .1 : 1, pH.imageSmoothingEnabled = !0, k = .87, pH.scale(k, k), pH.drawImage(t, Math.floor(.745 *
    ...
    function kU() {
        function g() {
            vG.uI[2] = vG.uI[3] = vG.uI[4] = !je.a32;
            var y = je.a09 ? 1 : 0,
                A = je.a32 ? 1 : 0;
        ...
        function k(y, A, B, C) {
            if (0 === C) return y >= B.ev && (0 === C || A >= B.ew) && A <= B.ew + B.n4;
            A -= C * (B.n4 - 2);
            return y >= B.ex && (0 === C || A >= B.ew) && A <= B.ew + B.n4
        }
        ...
        this.bh = function() {
            ...
            z[2].mm = this.a09 ? 130 : 0;
            z[3].mm = this.a32 ? 130 : 0;
            ...
            if (!(7 <= jT.rc())) {
                ...
                if (n) {
                    for (B = 1; B < z.length; B++)
                        if (k(y, A, C, B)) return 1 === B ? (je.xG = 1 === je.xG ? 2 : 1, z[1].mf = "Lobby " + je.xG, bw.bx = !0) : 2 === B ? (je.a09 = !je.a09, z[B].mm = je.a09 ? 130 : 0, g(), bw.bx = !0) : 3 === B ? (je.a32 = !je.a32, z[B].mm = je.a32 ? 130 : 0, g(), bw.bx = !0) : 4 === B ? (n9.bh(oY, !0), n9.bh(oY, !1)) : 5 === B ? (n9.bh(oZ[0], !0), n9.bh(oZ[0],
                            !1)) : 6 === B ? (n9.bh(oZ[1], !0), n9.bh(oZ[1], !1)) : 7 === B ? (n9.bh(oX, !0), n9.bh(oX, !1)) : B === z.length - 2 && (n9.bh(nA, !0), n9.bh(nA, !1)), !0;
                    n = !1;
                    bw.bx = !0;
                    return !1
                }
        ...
        this.c8 = function() {
            ...
            if (!(7 <= jT.rc())) {
                ...
                c9.textAlign = cB;
                c9.textBaseline = cA;
                l(A.ev, A.ew, A.ho, A.n4, z[0].ez, z[0].mm, z[0].ce, 0 === x, z[0].mf, .6);
                if (n) {
                    var B =
                        z.length;
                    for (y = 1; y < B; y++) l(A.ex, A.ew + y * A.n4 - 2 * y, A.hp, A.n4, z[y].ez, z[y].mm, z[y].ce, x === y, z[y].mf, y === B - 1 ? .32 : .45)
                }
            }
        }
    }
            ...
            if (H && (k(), H = ak(l, 128), H = 1 > H ? 1 : H, l -= H, t === ao && (as.at[15] += H), l <= al ? (t === ao && (as.at[15] += l), g(!1), H = !1) : (aW.bL(t, F, l), H = !0), H))
                if (H = ax.ep(z, y), x = Math.abs(A - z) >= Math.abs(B - y) ? H + aN[A > z ? 1 : 3] : H + aN[B > y ? 2 : 0], z = ax.g3(x), y = ax.c7(x),
                    ...
                    if (ax.b8(x)) H = b0;
                        ...
                        if (!cZ(t, H)) {
                            K = bM[H] * is - ap[H];
                            0 >= K || (K = l > K ? K : l, l -= K, t === ao && (dx.mq(K, H), as.at[16] += K), H === ao && (dx.ms(K, t), as.at[10] += K), ap[H] += K);
                            g(!0);
                            break a
                        }
                    }
    ...
    function kH() {
        ...
        this.hb = function() {
            var x = t ? 0 : -g;
            a31(x, x, aR - 2 * x, aS - 2 * x, gm.a3u, gm.a3v, gm.a3w, gm.a3x) || (c9.fillStyle = l, c9.fillRect(0, 0, g2, c3))
        };
        this.c8 = function() {
            t || (a30(0, -g, aR, g, gm.a3u, gm.a3v, gm.a3w, gm.a3x) && c9.drawImage(k[0], gm.a3y, gm.a3z - g), a30(aR, -g, g, aS + 2 * g, gm.a3u, gm.a3v, gm.a3w, gm.a3x) && c9.drawImage(k[1], gm.a3y + aR, gm.a3z - g), a30(0, aS, aR, g, gm.a3u, gm.a3v, gm.a3w, gm.a3x) && c9.drawImage(k[2], gm.a3y, gm.a3z + aS), a30(-g, -g, g,
                aS + 2 * g, gm.a3u, gm.a3v, gm.a3w, gm.a3x) && c9.drawImage(k[3], gm.a3y - g, gm.a3z - g))
        }
    }
    ...
    function a0c() {
        ...
        function l() {
            A--;
            ja.a4B(z, new Uint8Array(C.result));
    ...
    function a15() {
        ...
        this.a4H = function() {
            0 !== f3[ao] && (this.a4C[this.ln] = bM[ao], this.rf[this.ln] = ap[ao], this.t2[this.ln] = aq.t3(ao), this.a4I(this.ln), this.ln++, this.ln === this.cN && this.a4J(), this.dN = this.a4D - 1, hf.bn())
        };
        this.a4J = function() {
            this.a4F();
            this.a4I(0);
    ...
    function a16() {
        this.bk = this.pq = this.a4L = this.a4K = this.wo = this.n5 = this.n4 = this.u2 = this.u1 = this.hp = this.ho = this.co = this.bt = 0;
        this.la = ["Territory", "Balance", "Interest", "Numbers"];
        this.ku = !1;
        this.a4M = -1;
        this.a4N = !1;
        this.bh = function() {
        ...
        this.le = function() {
            ...
            this.bt -= q && r < s ? 2 * lo + this.pq : 0;
            this.co = Math.floor(this.bt / 1.618);
            this.ho = Math.floor(1 + .02 *
                this.bt);
            this.n4 = this.hp = Math.floor(1 + .04 * this.bt);
            this.n5 = Math.floor(1 + .075 * this.bt);
            ...
            this.wo = this.co - 2 * this.n4 - this.n5;
            this.ku && this.a4O()
        };
        this.bz = function(g, k) {
            if (!this.ku) return !1;
            ...
            if (k < this.co - this.n5) return this.a4N = !0, this.a4M =
                (g - 2 * this.ho - this.u1) / this.u2, !0;
            t = Math.floor(g / (this.bt / this.la.length));
            t = 0 > t ? 0 : t >= this.la.length ? this.la.length - 1 : t;
        ...
        this.a4P = function() {
            ...
            var g = this.bt / this.la.length;
            c9.fillStyle = o2;
            c9.fillRect(this.bk * g, this.co - this.n5, g, this.n5);
            c9.fillStyle = cC;
            for (var k = this.la.length - 1; 0 <= k; k--) c9.strokeRect(k * g, this.co - this.n5, g,
        ...
        this.a4S = function(g, k) {
            ...
            c9.fillText(dz.mw(100 * (1 - bM[ao] / as.at[7]), 0), 0, l)
        };
    ...
    function a18() {
        ...
        this.zn = ["rgba(255,255,255,", "rgba(0,0,0,", "rgba(170,170,170,", "rgba(85,85,85,"];
        this.zo = ["rgb(255,255,255)", "rgb(0,0,0)", "rgb(170,170,170)", "rgb(85,85,85)"];
        ...
        this.a4h = function() {
            for (var l = this.iW.length - 1; 0 <= l; l--) this.iW[l] = l;
            k = [];
            t = []
        };
        this.a4i = function() {
        ...
        this.d7 = function(l) {
            var x = new Uint8Array(ci),
                n = new Uint8Array(ci),
                z = new Uint16Array(8),
                y = new Uint16Array(this.iW.length);
            this.a4m(l, x, n, z);
            this.xr(z);
            dk ||
                this.a4n(y, x, n);
        ...
        this.xr = function(l) {
            var x, n, z = this.iW.length - 1;
            for (x = z; 0 <= x; x--) this.iW[x] =
                x;
            for (x = z - 1; 0 <= x; x--) l[x]++;
            for (x = 1; x <= z; x++) {
                var y = 0;
        ...
        this.a4o = function(l, x, n) {
            ...
            for (y = 0; y < ci; y++) z = B[l[y] + 1], 0 === this.dP[y] && z <= iy && n[z] < A && (n[z]++, this.dP[y] = z);
            for (y = 0; y < ci; y++) z = B[x[y] + 1], 0 === this.dP[y] && z <= iy && n[z] < A && (n[z]++, this.dP[y] = z);
            for (z = iy; 1 <= z; z--)
        ...
        this.a4q = function() {
            for (var l = ci; l < b0; l++) this.dP[l] = 1 + l % iy
        };
        this.iV = function(l) {
            if (dk) return [512, ""];
            var x, n, z = -1,
            ...
            for (n = k.length - 1; 0 <= n; n--)
                for (x = t[n].length - 1; 0 <= x && this.iW[this.dP[t[n][x]]] === l; x--)
    ...
    function ac() {
        ...
        a: for (; 0 <= l; l--) {
            ...
            x ? bF[aE].push(bE[aE][l]) : t ? bI[aE].push(bE[aE][l]) : ax.hN(bE[aE][l], aE);
            bE[aE][l] = bE[aE][g - 1];
            bE[aE].pop();
            g--
        }
    ...
    function bK() {
        ...
        a: for (; cv[aH] < cu[aH];) {
            for (g = cr[aH]; g >= cs[aH]; g--)
                if (ax.hW(aH, 4 * (cv[aH] * aR + g))) break a;
            cv[aH]++
        }
        a: for (; cv[aH] < cu[aH];) {
            for (g = cr[aH]; g >= cs[aH]; g--)
                if (ax.hW(aH, 4 * (cu[aH] * aR + g))) break a;
            cu[aH]--
        }
        a: for (; cs[aH] < cr[aH];) {
            for (g = cu[aH]; g >= cv[aH]; g--)
                if (ax.hW(aH, 4 * (g * aR + cs[aH]))) break a;
            cs[aH]++
        }
        a: for (; cs[aH] < cr[aH];) {
            for (g = cu[aH]; g >= cv[aH]; g--)
                if (ax.hW(aH, 4 * (g * aR + cr[aH]))) break a;
            cr[aH]--
        }
    }
    ...
    function a17() {
        ...
        this.a1B = function() {
            1 !== fN || !dk || fe.ld || fQ || fe.lj(); - 1 === this.a5D && (this.a5D = setInterval(k, 2E3))
        };
        this.xB = function() {
    ...
    function a5H() {
        ...
        this.d7 = function() {
            jb.d7();
            fQ ? eQ() : 0 === this.bk ? bw.gQ >= this.gQ && (this.gQ += this.a4D * Math.floor(1 + (bw.gQ - this.gQ) / this.a4D), 2 === fN || fe.ld ? dw() : (e2(), this.vm++, gw.tU()), this.bk++) : (fe.ld ? eQ() : (bw.bx = !0, eO()), this.bk = 0);
            eI();
            bw.bx && (bw.bx = !1, hZ())
        }
    }
    ...
    function a5J() {
        ...
        this.a5P = function() {
            if (this.vm !== 7 * this.vl) e2(), this.vm++, gw.tU();
            else {
    ...
    function kV() {
        function g(k, t) {
            8 !== jT.rc() || 0 !== t && t !== di || dk && fQ || (dx.mg(k), k += " - Territorial.io");
    ...
    function kI() {
        ...
        this.p3 = function(z) {
            ...
            if (1 < z.touches.length) {
                ...
                k(z);
                z = g();
                gX.qr(Math.floor((t + x) / 2), Math.floor((l + n) / 2), z / y);
                return bw.bx = !0
            }
            return !1
        }
        ...
        this.a4B = function(x, n) {
            ...
            if (0 === t) e1.a0h(x, 3205);
                ...
                if (0 === z)
                    ...
                    if (x !== e1.mi) e1.close(x, 3239);
                    else if (6 === jT.rc() && jc.bh(), 7 !== jT.rc()) e1.close(x, 3251);
                else {
                    y = [0, 0, 0, 0];
                    A = k(n, 6);
                ...
                else 1 === z && (z = jT.rc(), 8 !== z ? 10 === z && e1.a0h(x, 3243) : x !== e1.jM ? e1.a0h(x, 3244) : 0 === k(n, 1) ? bw.a5C.a5N(n) : (z = k(n, 2), 0 === z ? 3 !== t ? e1.a0h(e1.jM, 3230) : (z = k(n, 9), y = k(n, 7), 0 !== f3[z] && 0 !== f3[ao] && (y %= a5.a6, dx.mW(z, ao, y), dy.mk(z, 1, y))) : 1 === z ? 2 !== t ? e1.a0h(e1.jM, 3235) : (z = k(n, 9), 0 !== f3[z] && 0 !== f3[ao] && eE.a0K(0, [z], !0) && dx.lG(z, 1)) : 3 !== t ? e1.a0h(e1.jM, 3236) : (z = k(n, 9), y = k(n, 9), 0 !== f3[z] && 0 !== f3[y] && 0 !== f3[ao] && eE.a0K(1, [z], !0) && (dy.mk(z, 3, 96), dy.mk(y, 4, 96), dx.mn(z, y)))))
            }
        };
        this.vo = function(x) {
            l = 1;
            ...
            if (k(x, 3) !== n) e1.a0h(e1.jM, 3248);
                ...
                for (; l + 8 <= z;) {
                    ...
                    if (0 === y) {
                        ...
                        var C = k(x, 11);
                        e4.fP(A, y, B, C)
                    } else 2 === y ? (B = k(x, 9), B = B === A ? b0 : B, e4.fS(A, B)) : 3 === y ? e4.fV(A) : 4 === y ? (y = k(x, 7), dy.mk(A, 0, y)) : 5 === y ? e4.fd(A) : 6 ===
    ...
    function kP() {
        ...
        this.bz = function(g, k) {
            bw.bx = !0;
            if (g < this.wp[0] || k < this.wp[1] || g > this.wp[0] + this.wp[2] || k > this.wp[1] + this.wp[3]) return this.ku = !1, !0;
            var t = Math.floor(.13 * this.wp[3]);
            if (k < this.wp[1] + t) return g > this.wp[0] + this.wp[2] - 1.2 * t && (this.ku = !1), !0;
        ...
        this.c8 = function() {
            ...
            for (g = 6; 0 <= g; g--) {
                ...
                c9.fillText(jX.br(g + 7).mf, Math.floor(this.wp[0] + this.wp[2] - c2 - l / 2), Math.floor(x + .5 * t))
            }
            fe.ls(Math.floor(this.wp[0] + this.wp[2] - .8 * k), Math.floor(this.wp[1] + .25 * k), Math.floor(.5 * k));
            c9.setTransform(1, 0, 0, 1, 0, 0)
        }
    }
    ...
    function kL() {
        ...
        this.xI = function(n) {
            ...
            if (!(jO.x8 + 7E3 > bw.gQ)) {
                ...
                l(y, 3, 2);
                g(y);
                var A = mI(jO.x7.length - 20, 0);
                for (z = jO.x7.length - 1; z >= A; z--) l(y, 4, Math.abs(jO.x7.charCodeAt(z) - 48) % 10);
                e1.send(n, y)
            }
        };
