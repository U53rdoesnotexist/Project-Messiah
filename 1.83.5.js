...
function DifficultyEngine() {
    ...
    this.init = function() {
        ...
        } else if (singleplayer || modHandler.customDiffiDist) {
            if (teamGame) {
                for (botIndex = botCount - 1; 0 <= botIndex; botIndex--) {
...
var blackRGB = "rgb(0,0,0)",
    ...
    redditLink = "https://www.reddit.com/r/territorial_io/",
...
function LinkButtons() {
    ...
    this.setupLinkVariables = function(param_spriteList, param_isVisible) {
        ...
        links = [googleplayLink, appstoreLink, youtubeLink, discordLink, redditLink];
        this.init()
    };
    this.init = function() {
        if (sprites.areAllSpritesLoaded()) {
    ...
    this.drawCanvasImage = function() {
        if (8 !== gameState && 10 !== gameState) {
            ...
            var k = Math.floor(.3 * prevClientHeight),
                n = sprites.getValueByName("teritorio"),
...
function NameInput() {
    ...
    this.drawCanvasImage = function() {
        if (this.isInMainMenu()) {
            mainCanvasCtx.imageSmoothingEnabled = true;
            var logo = sprites.getValueByName("teritorio"),
...
function Sprites() {
    ...
    this.init = function() {
        if (void 0 === spriteCanvases) {
            ...
            loadSprite(6, "teritorio", 6, "data:image/png;base64,");
            ...
            loadSprite(10, "reddit", 2, "data:image/jpeg;base64,");
    ...
    this.update = function() {
        for (var remoteIndex = this.terriWsCount - 1; 0 <= remoteIndex; remoteIndex--) {
            if (this.isOpen(remoteIndex) && mainHandler.time > websocketsInfo[remoteIndex].time + 15E3) {
                dataEncoder.heartBeat(remoteIndex, websocketsInfo[remoteIndex].humanLastAction);
            }
        }
    };
...
function setIsNotClientFlag() {
    ...
    isNotClient = 0 <= hostname.toLowerCase().indexOf("teritorio") || !modHandler.public
}
...
var currentMapWidth, currentMapHeight, mapBaseCanvas, mapBaseCanvasCtx, realMapBaseCanvasCtxImageData, mapBaseCanvasImageDataArray, currentMapID, currentMapSeed, mapLoaded, customMapID = 16, mapShading;
...
function checkGenerateOcean() {
    if (2 === currentMapID) generateOcean([currentMapWidth/2], [currentMapHeight/2], [0, 205, 256], [500, 500, 0], [0, 0, 0])
    else if (7 === currentMapID) generateOcean([currentMapWidth/2], [currentMapHeight/2], [0, 380, 512], [500, 500, 0], [0, 0, 0])
    else if (8 === currentMapID) generateOcean([currentMapWidth/2], [currentMapHeight/2], [0, 120, 210], [0, 80, 640], [0, 0, 0])
    else if (9 === currentMapID) generateOcean([currentMapWidth/2], [currentMapHeight/2], [0, 70, 180, 200, 290, 420, 512], [500, 500, 0, 0, 500, 500, 0], [0, 0, 0, 0, 0, 0, 0])
}
...
function ConfigFakeMap() {
    ...
    this.renderBaseMap = function() {
        ...
        if (mapInfo.hasWatermark() && sprites.areAllSpritesLoaded()) {
            ...
            widthValues = sprites.getValueByName("teritorio");
            mapBaseCanvasCtx.save();
            mapBaseCanvasCtx.globalAlpha = 1 === currentMapID ? .1 : 1;
            mapBaseCanvasCtx.imageSmoothingEnabled = true;
            fakeMapBaseCanvasImageData = .87;
            mapBaseCanvasCtx.scale(fakeMapBaseCanvasImageData, fakeMapBaseCanvasImageData);
            mapBaseCanvasCtx.drawImage(widthValues, Math.floor(.58 * (currentMapWidth / fakeMapBaseCanvasImageData - widthValues.width)), Math.floor(.422 * currentMapHeight / fakeMapBaseCanvasImageData - widthValues.height / 2));
            mapBaseCanvasCtx.restore();
        }             
        mapLoaded = true;
        mainHandler.canvasDirty = true
...
function configRealMap(delta1) {
    ...
    else if (currentMapID === getRealMapStartingIndex() + 5) mapData = "";
...
function MapInfo() {
    ...
    this.init = function() {
        ...
        mapInfoArray[0] = {
            name: "White Arena",
            width: modHandler.customMapSize ? modHandler.customMapSize : 230,
            height: modHandler.customMapSize ? modHandler.customMapSize : 230,
            maxDelta: 1E3,
            deltaChange: 2E3,
            mapStyleSeed: 173,
            per: 1
        ...
        mapInfoArray[1] = {
            name: "Black Arena",
            width: modHandler.customMapSize ? modHandler.customMapSize : 800,
            height: modHandler.customMapSize ? modHandler.customMapSize : 800,
            maxDelta: 100,
            deltaChange: 50,
            mapStyleSeed: 43,
            per: 1
        ...
        mapInfoArray[2] = {
            name: "Island",
            width: modHandler.customMapSize ? modHandler.customMapSize : 512,
            height: modHandler.customMapSize ? modHandler.customMapSize : 512,
            maxDelta: 128,
            deltaChange: 32,
            mapStyleSeed: 0,
            per: 1.5
        ...
        mapInfoArray[3] = {
            name: "Mountains",
            width: modHandler.customMapSize ? modHandler.customMapSize : 960,
            height: modHandler.customMapSize ? modHandler.customMapSize : 960,
            maxDelta: 60,
            deltaChange: 8,
            mapStyleSeed: 0,
            per: 1.2
        ...
        mapInfoArray[4] = {
            name: "Desert",
            width: modHandler.customMapSize ? modHandler.customMapSize : 900,
            height: modHandler.customMapSize ? modHandler.customMapSize : 900,
            maxDelta: 100,
            deltaChange: 5,
            mapStyleSeed: 0,
            per: 1.2
        ...
        mapInfoArray[5] = {
            name: "Swamp",
            width: modHandler.customMapSize ? modHandler.customMapSize : 1E3,
            height: modHandler.customMapSize ? modHandler.customMapSize : 1E3,
            maxDelta: 100,
            deltaChange: 40,
            mapStyleSeed: 0,
            per: 1.2
        ...
        mapInfoArray[7] = {
            name: "Cliffs",
            width: modHandler.customMapSize ? modHandler.customMapSize : 1024,
            height: modHandler.customMapSize ? modHandler.customMapSize : 1024,
            maxDelta: 128,
            deltaChange: 32,
            mapStyleSeed: 0,
            per: 1.5
        ...
        mapInfoArray[8] = {
            name: "Pond",
            width: modHandler.customMapSize ? modHandler.customMapSize : 820,
            height: modHandler.customMapSize ? modHandler.customMapSize : 820,
            maxDelta: 200,
            deltaChange: 100,
            mapStyleSeed: 0,
            per: 1.2
        ...
        mapInfoArray[15] = {
            ...
            neutralColor: [140, 130, 120],
            waterColor: [12, 12, 76],
            shadingValues: [240, 120, 1024, 30, 19, 30, 70, 8, 20, 3, 9],
            per: 1
        }
    };
...
function DataEncoder() {
    ...
    this.heartBeat = function(remote, humanLastAction) {
